...
try {
  if (testCode()) {
    console.log("compat-table/es2024/ArrayBuffer.prototype.transferToFixedLength.js: OK");
  } else {
    console.log("compat-table/es2024/ArrayBuffer.prototype.transferToFixedLength.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2024/ArrayBuffer.prototype.transferToFixedLength.js: exception: " + e);
}
