...
try {
  if (testCode()) {
    console.log("compat-table/es2024/Object.groupBy.js: OK");
  } else {
    console.log("compat-table/es2024/Object.groupBy.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2024/Object.groupBy.js: exception: " + e);
}
