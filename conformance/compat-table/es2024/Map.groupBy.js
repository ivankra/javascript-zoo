...
try {
  if (testCode()) {
    console.log("compat-table/es2024/Map.groupBy.js: OK");
  } else {
    console.log("compat-table/es2024/Map.groupBy.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2024/Map.groupBy.js: exception: " + e);
}
