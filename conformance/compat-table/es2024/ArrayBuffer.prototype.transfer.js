...
try {
  if (testCode()) {
    console.log("compat-table/es2024/ArrayBuffer.prototype.transfer.js: OK");
  } else {
    console.log("compat-table/es2024/ArrayBuffer.prototype.transfer.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2024/ArrayBuffer.prototype.transfer.js: exception: " + e);
}
