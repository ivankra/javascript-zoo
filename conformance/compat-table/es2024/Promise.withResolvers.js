...
try {
  if (testCode()) {
    console.log("compat-table/es2024/Promise.withResolvers.js: OK");
  } else {
    console.log("compat-table/es2024/Promise.withResolvers.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2024/Promise.withResolvers.js: exception: " + e);
}
