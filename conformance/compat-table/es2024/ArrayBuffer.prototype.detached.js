...
try {
  if (testCode()) {
    console.log("compat-table/es2024/ArrayBuffer.prototype.detached.js: OK");
  } else {
    console.log("compat-table/es2024/ArrayBuffer.prototype.detached.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2024/ArrayBuffer.prototype.detached.js: exception: " + e);
}
