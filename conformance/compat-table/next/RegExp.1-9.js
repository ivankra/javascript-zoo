...
try {
  if (testCode()) {
    console.log("compat-table/next/RegExp.1-9.js: OK");
  } else {
    console.log("compat-table/next/RegExp.1-9.js: failed");
  }
} catch (e) {
  console.log("compat-table/next/RegExp.1-9.js: exception: " + e);
}
