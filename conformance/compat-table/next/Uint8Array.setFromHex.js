...
try {
  if (testCode()) {
    console.log("compat-table/next/Uint8Array.setFromHex.js: OK");
  } else {
    console.log("compat-table/next/Uint8Array.setFromHex.js: failed");
  }
} catch (e) {
  console.log("compat-table/next/Uint8Array.setFromHex.js: exception: " + e);
}
