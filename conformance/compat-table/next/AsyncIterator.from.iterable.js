// compat-table: ES Next > Stage 2 > Async Iterator Helpers (large) > AsyncIterator.from, iterable
...
function asyncTestPassed() {
  console.log("compat-table/next/AsyncIterator.from.iterable.js: OK");
}
...
try {
  ...
  console.log("compat-table/next/AsyncIterator.from.iterable.js: exception: " + e);
}
