...
try {
  if (testCode()) {
    console.log("compat-table/next/ShadowRealm.js: OK");
  } else {
    console.log("compat-table/next/ShadowRealm.js: failed");
  }
} catch (e) {
  console.log("compat-table/next/ShadowRealm.js: exception: " + e);
}
