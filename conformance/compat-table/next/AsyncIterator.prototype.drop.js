// compat-table: ES Next > Stage 2 > Async Iterator Helpers (large) > AsyncIterator.prototype.drop
...
function asyncTestPassed() {
  console.log("compat-table/next/AsyncIterator.prototype.drop.js: OK");
}
...
try {
  ...
  console.log("compat-table/next/AsyncIterator.prototype.drop.js: exception: " + e);
}
