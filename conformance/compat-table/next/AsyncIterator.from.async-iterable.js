// compat-table: ES Next > Stage 2 > Async Iterator Helpers (large) > AsyncIterator.from, async iterable
...
function asyncTestPassed() {
  console.log("compat-table/next/AsyncIterator.from.async-iterable.js: OK");
}
...
try {
  ...
  console.log("compat-table/next/AsyncIterator.from.async-iterable.js: exception: " + e);
}
