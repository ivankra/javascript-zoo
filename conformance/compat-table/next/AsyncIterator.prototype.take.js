// compat-table: ES Next > Stage 2 > Async Iterator Helpers (large) > AsyncIterator.prototype.take
...
function asyncTestPassed() {
  console.log("compat-table/next/AsyncIterator.prototype.take.js: OK");
}
...
try {
  ...
  console.log("compat-table/next/AsyncIterator.prototype.take.js: exception: " + e);
}
