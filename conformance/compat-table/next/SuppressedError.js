...
try {
  if (testCode()) {
    console.log("compat-table/next/SuppressedError.js: OK");
  } else {
    console.log("compat-table/next/SuppressedError.js: failed");
  }
} catch (e) {
  console.log("compat-table/next/SuppressedError.js: exception: " + e);
}
