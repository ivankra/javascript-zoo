...
try {
  if (testCode()) {
    console.log("compat-table/next/RegExp.lastMatch.js: OK");
  } else {
    console.log("compat-table/next/RegExp.lastMatch.js: failed");
  }
} catch (e) {
  console.log("compat-table/next/RegExp.lastMatch.js: exception: " + e);
}
