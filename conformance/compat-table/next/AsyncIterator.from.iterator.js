// compat-table: ES Next > Stage 2 > Async Iterator Helpers (large) > AsyncIterator.from, iterator
...
function asyncTestPassed() {
  console.log("compat-table/next/AsyncIterator.from.iterator.js: OK");
}
...
try {
  ...
  console.log("compat-table/next/AsyncIterator.from.iterator.js: exception: " + e);
}
