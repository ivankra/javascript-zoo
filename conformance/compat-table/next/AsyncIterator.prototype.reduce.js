// compat-table: ES Next > Stage 2 > Async Iterator Helpers (large) > AsyncIterator.prototype.reduce
...
function asyncTestPassed() {
  console.log("compat-table/next/AsyncIterator.prototype.reduce.js: OK");
}
...
try {
  ...
  console.log("compat-table/next/AsyncIterator.prototype.reduce.js: exception: " + e);
}
