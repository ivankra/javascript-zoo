...
try {
  if (testCode()) {
    console.log("compat-table/next/DisposableStack.js: OK");
  } else {
    console.log("compat-table/next/DisposableStack.js: failed");
  }
} catch (e) {
  console.log("compat-table/next/DisposableStack.js: exception: " + e);
}
