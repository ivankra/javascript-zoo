// compat-table: ES Next > Stage 2 > Async Iterator Helpers (large) > AsyncIterator.prototype.every
...
function asyncTestPassed() {
  console.log("compat-table/next/AsyncIterator.prototype.every.js: OK");
}
...
try {
  ...
  console.log("compat-table/next/AsyncIterator.prototype.every.js: exception: " + e);
}
