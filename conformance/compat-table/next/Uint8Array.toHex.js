...
try {
  if (testCode()) {
    console.log("compat-table/next/Uint8Array.toHex.js: OK");
  } else {
    console.log("compat-table/next/Uint8Array.toHex.js: failed");
  }
} catch (e) {
  console.log("compat-table/next/Uint8Array.toHex.js: exception: " + e);
}
