// compat-table: ES Next > Stage 2 > Async Iterator Helpers (large) > AsyncIterator.prototype.some
...
function asyncTestPassed() {
  console.log("compat-table/next/AsyncIterator.prototype.some.js: OK");
}
...
try {
  ...
  console.log("compat-table/next/AsyncIterator.prototype.some.js: exception: " + e);
}
