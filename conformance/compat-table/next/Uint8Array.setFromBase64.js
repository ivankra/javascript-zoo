...
try {
  if (testCode()) {
    console.log("compat-table/next/Uint8Array.setFromBase64.js: OK");
  } else {
    console.log("compat-table/next/Uint8Array.setFromBase64.js: failed");
  }
} catch (e) {
  console.log("compat-table/next/Uint8Array.setFromBase64.js: exception: " + e);
}
