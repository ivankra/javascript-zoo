...
try {
  if (testCode()) {
    console.log("compat-table/next/Uint8Array.fromHex.js: OK");
  } else {
    console.log("compat-table/next/Uint8Array.fromHex.js: failed");
  }
} catch (e) {
  console.log("compat-table/next/Uint8Array.fromHex.js: exception: " + e);
}
