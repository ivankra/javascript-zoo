...
try {
  if (testCode()) {
    console.log("compat-table/next/using.for-of.js: OK");
  } else {
    console.log("compat-table/next/using.for-of.js: failed");
  }
} catch (e) {
  console.log("compat-table/next/using.for-of.js: exception: " + e);
}
