// compat-table: ES Next > Stage 2 > Async Iterator Helpers (large) > AsyncIterator.prototype.find
...
function asyncTestPassed() {
  console.log("compat-table/next/AsyncIterator.prototype.find.js: OK");
}
...
try {
  ...
  console.log("compat-table/next/AsyncIterator.prototype.find.js: exception: " + e);
}
