...
try {
  if (testCode()) {
    console.log("compat-table/next/AsyncIterator.extends.js: OK");
  } else {
    console.log("compat-table/next/AsyncIterator.extends.js: failed");
  }
} catch (e) {
  console.log("compat-table/next/AsyncIterator.extends.js: exception: " + e);
}
