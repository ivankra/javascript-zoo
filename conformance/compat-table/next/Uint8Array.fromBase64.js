...
try {
  if (testCode()) {
    console.log("compat-table/next/Uint8Array.fromBase64.js: OK");
  } else {
    console.log("compat-table/next/Uint8Array.fromBase64.js: failed");
  }
} catch (e) {
  console.log("compat-table/next/Uint8Array.fromBase64.js: exception: " + e);
}
