...
try {
  if (testCode()) {
    console.log("compat-table/next/Map.prototype.upsert.js: OK");
  } else {
    console.log("compat-table/next/Map.prototype.upsert.js: failed");
  }
} catch (e) {
  console.log("compat-table/next/Map.prototype.upsert.js: exception: " + e);
}
