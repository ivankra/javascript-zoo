// compat-table: ES Next > Stage 2 > Async Iterator Helpers (large) > AsyncIterator.prototype.filter
...
function asyncTestPassed() {
  console.log("compat-table/next/AsyncIterator.prototype.filter.js: OK");
}
...
try {
  ...
  console.log("compat-table/next/AsyncIterator.prototype.filter.js: exception: " + e);
}
