...
try {
  if (testCode()) {
    console.log("compat-table/es2021/String.prototype.replaceAll.js: OK");
  } else {
    console.log("compat-table/es2021/String.prototype.replaceAll.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2021/String.prototype.replaceAll.js: exception: " + e);
}
