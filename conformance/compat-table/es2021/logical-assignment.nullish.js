...
try {
  if (testCode()) {
    console.log("compat-table/es2021/logical-assignment.nullish.js: OK");
  } else {
    console.log("compat-table/es2021/logical-assignment.nullish.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2021/logical-assignment.nullish.js: exception: " + e);
}
