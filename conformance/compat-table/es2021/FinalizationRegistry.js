...
try {
  if (testCode()) {
    console.log("compat-table/es2021/FinalizationRegistry.js: OK");
  } else {
    console.log("compat-table/es2021/FinalizationRegistry.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2021/FinalizationRegistry.js: exception: " + e);
}
