...
try {
  if (testCode()) {
    console.log("compat-table/es2021/logical-assignment.or.js: OK");
  } else {
    console.log("compat-table/es2021/logical-assignment.or.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2021/logical-assignment.or.js: exception: " + e);
}
