...
try {
  if (testCode()) {
    console.log("compat-table/es2021/numeric-separators.js: OK");
  } else {
    console.log("compat-table/es2021/numeric-separators.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2021/numeric-separators.js: exception: " + e);
}
