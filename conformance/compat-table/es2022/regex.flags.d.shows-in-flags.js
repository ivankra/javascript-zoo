...
try {
  if (testCode()) {
    console.log("compat-table/es2022/regex.flags.d.shows-in-flags.js: OK");
  } else {
    console.log("compat-table/es2022/regex.flags.d.shows-in-flags.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2022/regex.flags.d.shows-in-flags.js: exception: " + e);
}
