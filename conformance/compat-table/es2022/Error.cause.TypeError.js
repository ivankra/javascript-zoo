...
try {
  if (testCode()) {
    console.log("compat-table/es2022/Error.cause.TypeError.js: OK");
  } else {
    console.log("compat-table/es2022/Error.cause.TypeError.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2022/Error.cause.TypeError.js: exception: " + e);
}
