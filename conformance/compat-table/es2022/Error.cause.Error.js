...
try {
  if (testCode()) {
    console.log("compat-table/es2022/Error.cause.Error.js: OK");
  } else {
    console.log("compat-table/es2022/Error.cause.Error.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2022/Error.cause.Error.js: exception: " + e);
}
