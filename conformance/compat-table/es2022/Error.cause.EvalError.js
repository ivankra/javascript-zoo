...
try {
  if (testCode()) {
    console.log("compat-table/es2022/Error.cause.EvalError.js: OK");
  } else {
    console.log("compat-table/es2022/Error.cause.EvalError.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2022/Error.cause.EvalError.js: exception: " + e);
}
