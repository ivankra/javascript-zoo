...
try {
  if (testCode()) {
    console.log("compat-table/es2022/class-fields.private-static.js: OK");
  } else {
    console.log("compat-table/es2022/class-fields.private-static.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2022/class-fields.private-static.js: exception: " + e);
}
