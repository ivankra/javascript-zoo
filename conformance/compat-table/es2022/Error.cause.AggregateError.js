...
try {
  if (testCode()) {
    console.log("compat-table/es2022/Error.cause.AggregateError.js: OK");
  } else {
    console.log("compat-table/es2022/Error.cause.AggregateError.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2022/Error.cause.AggregateError.js: exception: " + e);
}
