...
try {
  if (testCode()) {
    console.log("compat-table/es2022/class-fields.public-static.js: OK");
  } else {
    console.log("compat-table/es2022/class-fields.public-static.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2022/class-fields.public-static.js: exception: " + e);
}
