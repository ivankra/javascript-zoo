...
try {
  if (testCode()) {
    console.log("compat-table/es2022/Error.cause.SyntaxError.js: OK");
  } else {
    console.log("compat-table/es2022/Error.cause.SyntaxError.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2022/Error.cause.SyntaxError.js: exception: " + e);
}
