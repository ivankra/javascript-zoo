...
try {
  if (testCode()) {
    console.log("compat-table/es2022/Object.hasOwn.ToObject-first.js: OK");
  } else {
    console.log("compat-table/es2022/Object.hasOwn.ToObject-first.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2022/Object.hasOwn.ToObject-first.js: exception: " + e);
}
