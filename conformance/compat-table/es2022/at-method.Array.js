...
try {
  if (testCode()) {
    console.log("compat-table/es2022/at-method.Array.js: OK");
  } else {
    console.log("compat-table/es2022/at-method.Array.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2022/at-method.Array.js: exception: " + e);
}
