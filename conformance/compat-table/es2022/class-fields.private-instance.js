...
try {
  if (testCode()) {
    console.log("compat-table/es2022/class-fields.private-instance.js: OK");
  } else {
    console.log("compat-table/es2022/class-fields.private-instance.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2022/class-fields.private-instance.js: exception: " + e);
}
