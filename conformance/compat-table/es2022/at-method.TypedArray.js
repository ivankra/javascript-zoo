...
try {
  if (testCode()) {
    console.log("compat-table/es2022/at-method.TypedArray.js: OK");
  } else {
    console.log("compat-table/es2022/at-method.TypedArray.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2022/at-method.TypedArray.js: exception: " + e);
}
