...
try {
  if (testCode()) {
    console.log("compat-table/es2022/Object.hasOwn.js: OK");
  } else {
    console.log("compat-table/es2022/Object.hasOwn.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2022/Object.hasOwn.js: exception: " + e);
}
