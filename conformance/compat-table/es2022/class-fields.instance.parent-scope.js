...
try {
  if (testCode()) {
    console.log("compat-table/es2022/class-fields.instance.parent-scope.js: OK");
  } else {
    console.log("compat-table/es2022/class-fields.instance.parent-scope.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2022/class-fields.instance.parent-scope.js: exception: " + e);
}
