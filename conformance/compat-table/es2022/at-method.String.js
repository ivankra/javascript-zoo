...
try {
  if (testCode()) {
    console.log("compat-table/es2022/at-method.String.js: OK");
  } else {
    console.log("compat-table/es2022/at-method.String.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2022/at-method.String.js: exception: " + e);
}
