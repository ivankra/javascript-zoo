...
try {
  if (testCode()) {
    console.log("compat-table/es2022/class-static-init-blocks.js: OK");
  } else {
    console.log("compat-table/es2022/class-static-init-blocks.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2022/class-static-init-blocks.js: exception: " + e);
}
