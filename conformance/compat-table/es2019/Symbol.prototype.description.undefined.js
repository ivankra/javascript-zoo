...
try {
  if (testCode()) {
    console.log("compat-table/es2019/Symbol.prototype.description.undefined.js: OK");
  } else {
    console.log("compat-table/es2019/Symbol.prototype.description.undefined.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2019/Symbol.prototype.description.undefined.js: exception: " + e);
}
