...
try {
  if (testCode()) {
    console.log("compat-table/es2019/annex-b.String.prototype.trimRight.js: OK");
  } else {
    console.log("compat-table/es2019/annex-b.String.prototype.trimRight.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2019/annex-b.String.prototype.trimRight.js: exception: " + e);
}
