...
try {
  if (testCode()) {
    console.log("compat-table/es2019/misc.Function-toString.Function-constructor.js: OK");
  } else {
    console.log("compat-table/es2019/misc.Function-toString.Function-constructor.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2019/misc.Function-toString.Function-constructor.js: exception: " + e);
}
