...
try {
  if (testCode()) {
    console.log("compat-table/es2019/misc.Function-toString.computed-names.js: OK");
  } else {
    console.log("compat-table/es2019/misc.Function-toString.computed-names.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2019/misc.Function-toString.computed-names.js: exception: " + e);
}
