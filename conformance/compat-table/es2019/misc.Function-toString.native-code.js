...
try {
  if (testCode()) {
    console.log("compat-table/es2019/misc.Function-toString.native-code.js: OK");
  } else {
    console.log("compat-table/es2019/misc.Function-toString.native-code.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2019/misc.Function-toString.native-code.js: exception: " + e);
}
