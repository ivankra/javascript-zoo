...
try {
  if (testCode()) {
    console.log("compat-table/es2019/misc.Function-toString.arrows.js: OK");
  } else {
    console.log("compat-table/es2019/misc.Function-toString.arrows.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2019/misc.Function-toString.arrows.js: exception: " + e);
}
