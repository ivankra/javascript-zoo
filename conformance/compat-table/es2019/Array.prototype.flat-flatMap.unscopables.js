...
try {
  if (testCode()) {
    console.log("compat-table/es2019/Array.prototype.flat-flatMap.unscopables.js: OK");
  } else {
    console.log("compat-table/es2019/Array.prototype.flat-flatMap.unscopables.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2019/Array.prototype.flat-flatMap.unscopables.js: exception: " + e);
}
