...
try {
  if (testCode()) {
    console.log("compat-table/es2019/Symbol.prototype.description.empty.js: OK");
  } else {
    console.log("compat-table/es2019/Symbol.prototype.description.empty.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2019/Symbol.prototype.description.empty.js: exception: " + e);
}
