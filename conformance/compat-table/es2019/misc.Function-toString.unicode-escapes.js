...
try {
  if (testCode()) {
    console.log("compat-table/es2019/misc.Function-toString.unicode-escapes.js: OK");
  } else {
    console.log("compat-table/es2019/misc.Function-toString.unicode-escapes.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2019/misc.Function-toString.unicode-escapes.js: exception: " + e);
}
