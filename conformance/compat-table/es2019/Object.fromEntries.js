...
try {
  if (testCode()) {
    console.log("compat-table/es2019/Object.fromEntries.js: OK");
  } else {
    console.log("compat-table/es2019/Object.fromEntries.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2019/Object.fromEntries.js: exception: " + e);
}
