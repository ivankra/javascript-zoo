...
try {
  if (testCode()) {
    console.log("compat-table/es2019/Symbol.prototype.description.js: OK");
  } else {
    console.log("compat-table/es2019/Symbol.prototype.description.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2019/Symbol.prototype.description.js: exception: " + e);
}
