...
try {
  if (testCode()) {
    console.log("compat-table/es2019/misc.Function-toString.class-explicit-constructor.js: OK");
  } else {
    console.log("compat-table/es2019/misc.Function-toString.class-explicit-constructor.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2019/misc.Function-toString.class-explicit-constructor.js: exception: " + e);
}
