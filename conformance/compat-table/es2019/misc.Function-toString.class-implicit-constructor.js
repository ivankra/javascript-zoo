...
try {
  if (testCode()) {
    console.log("compat-table/es2019/misc.Function-toString.class-implicit-constructor.js: OK");
  } else {
    console.log("compat-table/es2019/misc.Function-toString.class-implicit-constructor.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2019/misc.Function-toString.class-implicit-constructor.js: exception: " + e);
}
