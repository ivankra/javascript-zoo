...
try {
  if (testCode()) {
    console.log("compat-table/es2019/Array.prototype.flatMap.js: OK");
  } else {
    console.log("compat-table/es2019/Array.prototype.flatMap.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2019/Array.prototype.flatMap.js: exception: " + e);
}
