...
try {
  if (testCode()) {
    console.log("compat-table/es2025/Iterator.from.iterable.js: OK");
  } else {
    console.log("compat-table/es2025/Iterator.from.iterable.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2025/Iterator.from.iterable.js: exception: " + e);
}
