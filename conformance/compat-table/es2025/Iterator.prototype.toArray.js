...
try {
  if (testCode()) {
    console.log("compat-table/es2025/Iterator.prototype.toArray.js: OK");
  } else {
    console.log("compat-table/es2025/Iterator.prototype.toArray.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2025/Iterator.prototype.toArray.js: exception: " + e);
}
