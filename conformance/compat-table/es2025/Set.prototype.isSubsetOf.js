...
try {
  if (testCode()) {
    console.log("compat-table/es2025/Set.prototype.isSubsetOf.js: OK");
  } else {
    console.log("compat-table/es2025/Set.prototype.isSubsetOf.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2025/Set.prototype.isSubsetOf.js: exception: " + e);
}
