...
try {
  if (testCode()) {
    console.log("compat-table/es2025/Iterator.prototype.Symbol.toStringTag.js: OK");
  } else {
    console.log("compat-table/es2025/Iterator.prototype.Symbol.toStringTag.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2025/Iterator.prototype.Symbol.toStringTag.js: exception: " + e);
}
