...
try {
  if (testCode()) {
    console.log("compat-table/es2025/Iterator.prototype.find.js: OK");
  } else {
    console.log("compat-table/es2025/Iterator.prototype.find.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2025/Iterator.prototype.find.js: exception: " + e);
}
