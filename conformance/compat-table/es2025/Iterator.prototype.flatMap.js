...
try {
  if (testCode()) {
    console.log("compat-table/es2025/Iterator.prototype.flatMap.js: OK");
  } else {
    console.log("compat-table/es2025/Iterator.prototype.flatMap.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2025/Iterator.prototype.flatMap.js: exception: " + e);
}
