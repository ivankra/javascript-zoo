...
try {
  if (testCode()) {
    console.log("compat-table/es2025/Iterator.prototype.drop.js: OK");
  } else {
    console.log("compat-table/es2025/Iterator.prototype.drop.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2025/Iterator.prototype.drop.js: exception: " + e);
}
