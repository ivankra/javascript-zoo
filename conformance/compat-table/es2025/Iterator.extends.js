...
try {
  if (testCode()) {
    console.log("compat-table/es2025/Iterator.extends.js: OK");
  } else {
    console.log("compat-table/es2025/Iterator.extends.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2025/Iterator.extends.js: exception: " + e);
}
