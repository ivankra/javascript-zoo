...
try {
  if (testCode()) {
    console.log("compat-table/es2025/Set.prototype.isDisjointFrom.js: OK");
  } else {
    console.log("compat-table/es2025/Set.prototype.isDisjointFrom.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2025/Set.prototype.isDisjointFrom.js: exception: " + e);
}
