...
try {
  if (testCode()) {
    console.log("compat-table/es2025/Set.prototype.difference.js: OK");
  } else {
    console.log("compat-table/es2025/Set.prototype.difference.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2025/Set.prototype.difference.js: exception: " + e);
}
