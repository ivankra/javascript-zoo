...
try {
  if (testCode()) {
    console.log("compat-table/es2025/Set.prototype.symmetricDifference.js: OK");
  } else {
    console.log("compat-table/es2025/Set.prototype.symmetricDifference.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2025/Set.prototype.symmetricDifference.js: exception: " + e);
}
