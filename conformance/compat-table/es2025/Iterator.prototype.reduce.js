...
try {
  if (testCode()) {
    console.log("compat-table/es2025/Iterator.prototype.reduce.js: OK");
  } else {
    console.log("compat-table/es2025/Iterator.prototype.reduce.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2025/Iterator.prototype.reduce.js: exception: " + e);
}
