...
try {
  if (testCode()) {
    console.log("compat-table/es2025/Iterator.instanceof.js: OK");
  } else {
    console.log("compat-table/es2025/Iterator.instanceof.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2025/Iterator.instanceof.js: exception: " + e);
}
