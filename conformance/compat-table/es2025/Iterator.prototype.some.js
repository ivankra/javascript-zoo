...
try {
  if (testCode()) {
    console.log("compat-table/es2025/Iterator.prototype.some.js: OK");
  } else {
    console.log("compat-table/es2025/Iterator.prototype.some.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2025/Iterator.prototype.some.js: exception: " + e);
}
