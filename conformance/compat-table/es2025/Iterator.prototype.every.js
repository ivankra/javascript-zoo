...
try {
  if (testCode()) {
    console.log("compat-table/es2025/Iterator.prototype.every.js: OK");
  } else {
    console.log("compat-table/es2025/Iterator.prototype.every.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2025/Iterator.prototype.every.js: exception: " + e);
}
