...
try {
  if (testCode()) {
    console.log("compat-table/es2025/Set.prototype.union.js: OK");
  } else {
    console.log("compat-table/es2025/Set.prototype.union.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2025/Set.prototype.union.js: exception: " + e);
}
