...
try {
  if (testCode()) {
    console.log("compat-table/es2025/Set.prototype.intersection.js: OK");
  } else {
    console.log("compat-table/es2025/Set.prototype.intersection.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2025/Set.prototype.intersection.js: exception: " + e);
}
