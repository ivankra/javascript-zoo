...
try {
  if (testCode()) {
    console.log("compat-table/es2025/Iterator.prototype.map.js: OK");
  } else {
    console.log("compat-table/es2025/Iterator.prototype.map.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2025/Iterator.prototype.map.js: exception: " + e);
}
