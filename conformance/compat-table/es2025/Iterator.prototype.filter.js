...
try {
  if (testCode()) {
    console.log("compat-table/es2025/Iterator.prototype.filter.js: OK");
  } else {
    console.log("compat-table/es2025/Iterator.prototype.filter.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2025/Iterator.prototype.filter.js: exception: " + e);
}
