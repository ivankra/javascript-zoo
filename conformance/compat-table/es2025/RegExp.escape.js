...
try {
  if (testCode()) {
    console.log("compat-table/es2025/RegExp.escape.js: OK");
  } else {
    console.log("compat-table/es2025/RegExp.escape.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2025/RegExp.escape.js: exception: " + e);
}
