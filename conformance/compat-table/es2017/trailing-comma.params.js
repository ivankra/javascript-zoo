...
try {
  if (testCode()) {
    console.log("compat-table/es2017/trailing-comma.params.js: OK");
  } else {
    console.log("compat-table/es2017/trailing-comma.params.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2017/trailing-comma.params.js: exception: " + e);
}
