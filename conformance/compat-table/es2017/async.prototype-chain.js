...
try {
  if (testCode()) {
    console.log("compat-table/es2017/async.prototype-chain.js: OK");
  } else {
    console.log("compat-table/es2017/async.prototype-chain.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2017/async.prototype-chain.js: exception: " + e);
}
