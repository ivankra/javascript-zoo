// compat-table: ES2016+ > 2017 features > async functions (large) > async methods, classes
...
function asyncTestPassed() {
  console.log("compat-table/es2017/async.methods-class.js: OK");
}
...
try {
  ...
  console.log("compat-table/es2017/async.methods-class.js: exception: " + e);
}
