...
try {
  if (testCode()) {
    console.log("compat-table/es2017/annex-b.Object.prototype.__lookupSetter__.symbols.js: OK");
  } else {
    console.log("compat-table/es2017/annex-b.Object.prototype.__lookupSetter__.symbols.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2017/annex-b.Object.prototype.__lookupSetter__.symbols.js: exception: " + e);
}
