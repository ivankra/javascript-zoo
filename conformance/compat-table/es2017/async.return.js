// compat-table: ES2016+ > 2017 features > async functions (large) > return
...
function asyncTestPassed() {
  console.log("compat-table/es2017/async.return.js: OK");
}
...
try {
  ...
  console.log("compat-table/es2017/async.return.js: exception: " + e);
}
