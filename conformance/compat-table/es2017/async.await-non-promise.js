// compat-table: ES2016+ > 2017 features > async functions (large) > can await non-Promise values
...
function asyncTestPassed() {
  console.log("compat-table/es2017/async.await-non-promise.js: OK");
}
...
try {
  ...
  console.log("compat-table/es2017/async.await-non-promise.js: exception: " + e);
}
