...
try {
  if (testCode()) {
    console.log("compat-table/es2017/misc.arguments-caller-removed.js: OK");
  } else {
    console.log("compat-table/es2017/misc.arguments-caller-removed.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2017/misc.arguments-caller-removed.js: exception: " + e);
}
