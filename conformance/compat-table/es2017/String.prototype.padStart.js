...
try {
  if (testCode()) {
    console.log("compat-table/es2017/String.prototype.padStart.js: OK");
  } else {
    console.log("compat-table/es2017/String.prototype.padStart.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2017/String.prototype.padStart.js: exception: " + e);
}
