...
try {
  if (testCode()) {
    console.log("compat-table/es2017/Atomics.add.js: OK");
  } else {
    console.log("compat-table/es2017/Atomics.add.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2017/Atomics.add.js: exception: " + e);
}
