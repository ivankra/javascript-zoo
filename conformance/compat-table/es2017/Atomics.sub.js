...
try {
  if (testCode()) {
    console.log("compat-table/es2017/Atomics.sub.js: OK");
  } else {
    console.log("compat-table/es2017/Atomics.sub.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2017/Atomics.sub.js: exception: " + e);
}
