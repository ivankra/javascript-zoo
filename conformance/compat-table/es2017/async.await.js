// compat-table: ES2016+ > 2017 features > async functions (large) > await
...
function asyncTestPassed() {
  console.log("compat-table/es2017/async.await.js: OK");
}
...
try {
  ...
  console.log("compat-table/es2017/async.await.js: exception: " + e);
}
