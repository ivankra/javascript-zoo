...
try {
  if (testCode()) {
    console.log("compat-table/es2017/SharedArrayBuffer.js: OK");
  } else {
    console.log("compat-table/es2017/SharedArrayBuffer.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2017/SharedArrayBuffer.js: exception: " + e);
}
