...
try {
  if (testCode()) {
    console.log("compat-table/es2017/Atomics.exchange.js: OK");
  } else {
    console.log("compat-table/es2017/Atomics.exchange.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2017/Atomics.exchange.js: exception: " + e);
}
