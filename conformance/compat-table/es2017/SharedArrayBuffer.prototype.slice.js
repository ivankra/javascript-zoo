...
try {
  if (testCode()) {
    console.log("compat-table/es2017/SharedArrayBuffer.prototype.slice.js: OK");
  } else {
    console.log("compat-table/es2017/SharedArrayBuffer.prototype.slice.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2017/SharedArrayBuffer.prototype.slice.js: exception: " + e);
}
