// compat-table: ES2016+ > 2017 features > async functions (large) > throw
...
function asyncTestPassed() {
  console.log("compat-table/es2017/async.throw.js: OK");
}
...
try {
  ...
  console.log("compat-table/es2017/async.throw.js: exception: " + e);
}
