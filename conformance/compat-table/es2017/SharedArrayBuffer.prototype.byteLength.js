...
try {
  if (testCode()) {
    console.log("compat-table/es2017/SharedArrayBuffer.prototype.byteLength.js: OK");
  } else {
    console.log("compat-table/es2017/SharedArrayBuffer.prototype.byteLength.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2017/SharedArrayBuffer.prototype.byteLength.js: exception: " + e);
}
