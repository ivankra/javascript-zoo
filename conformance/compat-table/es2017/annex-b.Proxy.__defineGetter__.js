...
try {
  if (testCode()) {
    console.log("compat-table/es2017/annex-b.Proxy.__defineGetter__.js: OK");
  } else {
    console.log("compat-table/es2017/annex-b.Proxy.__defineGetter__.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2017/annex-b.Proxy.__defineGetter__.js: exception: " + e);
}
