...
try {
  if (testCode()) {
    console.log("compat-table/es2017/Atomics.notify.js: OK");
  } else {
    console.log("compat-table/es2017/Atomics.notify.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2017/Atomics.notify.js: exception: " + e);
}
