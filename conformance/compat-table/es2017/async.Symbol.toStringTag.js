...
try {
  if (testCode()) {
    console.log("compat-table/es2017/async.Symbol.toStringTag.js: OK");
  } else {
    console.log("compat-table/es2017/async.Symbol.toStringTag.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2017/async.Symbol.toStringTag.js: exception: " + e);
}
