// compat-table: ES2016+ > 2017 annex b > Object.prototype getter/setter methods (tiny) > __lookupGetter__
...
try {
  if (testCode()) {
    console.log("compat-table/es2017/annex-b.Object.prototype.__lookupGetter__.js: OK");
  } else {
    console.log("compat-table/es2017/annex-b.Object.prototype.__lookupGetter__.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2017/annex-b.Object.prototype.__lookupGetter__.js: exception: " + e);
}
