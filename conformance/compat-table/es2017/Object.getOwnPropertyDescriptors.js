...
try {
  if (testCode()) {
    console.log("compat-table/es2017/Object.getOwnPropertyDescriptors.js: OK");
  } else {
    console.log("compat-table/es2017/Object.getOwnPropertyDescriptors.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2017/Object.getOwnPropertyDescriptors.js: exception: " + e);
}
