...
try {
  if (testCode()) {
    console.log("compat-table/es2017/Atomics.load.js: OK");
  } else {
    console.log("compat-table/es2017/Atomics.load.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2017/Atomics.load.js: exception: " + e);
}
