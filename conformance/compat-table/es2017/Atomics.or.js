...
try {
  if (testCode()) {
    console.log("compat-table/es2017/Atomics.or.js: OK");
  } else {
    console.log("compat-table/es2017/Atomics.or.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2017/Atomics.or.js: exception: " + e);
}
