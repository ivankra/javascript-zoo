// compat-table: ES2016+ > 2017 features > async functions (large) > async arrow functions
...
function asyncTestPassed() {
  console.log("compat-table/es2017/async.arrow.js: OK");
}
...
try {
  ...
  console.log("compat-table/es2017/async.arrow.js: exception: " + e);
}
