...
try {
  if (testCode()) {
    console.log("compat-table/es2017/annex-b.for-in-assignment-non-strict.js: OK");
  } else {
    console.log("compat-table/es2017/annex-b.for-in-assignment-non-strict.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2017/annex-b.for-in-assignment-non-strict.js: exception: " + e);
}
