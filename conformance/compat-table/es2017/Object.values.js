...
try {
  if (testCode()) {
    console.log("compat-table/es2017/Object.values.js: OK");
  } else {
    console.log("compat-table/es2017/Object.values.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2017/Object.values.js: exception: " + e);
}
