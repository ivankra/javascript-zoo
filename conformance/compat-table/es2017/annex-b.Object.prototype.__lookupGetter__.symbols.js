...
try {
  if (testCode()) {
    console.log("compat-table/es2017/annex-b.Object.prototype.__lookupGetter__.symbols.js: OK");
  } else {
    console.log("compat-table/es2017/annex-b.Object.prototype.__lookupGetter__.symbols.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2017/annex-b.Object.prototype.__lookupGetter__.symbols.js: exception: " + e);
}
