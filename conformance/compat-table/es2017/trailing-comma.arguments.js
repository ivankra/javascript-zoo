...
try {
  if (testCode()) {
    console.log("compat-table/es2017/trailing-comma.arguments.js: OK");
  } else {
    console.log("compat-table/es2017/trailing-comma.arguments.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2017/trailing-comma.arguments.js: exception: " + e);
}
