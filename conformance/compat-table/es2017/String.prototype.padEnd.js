...
try {
  if (testCode()) {
    console.log("compat-table/es2017/String.prototype.padEnd.js: OK");
  } else {
    console.log("compat-table/es2017/String.prototype.padEnd.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2017/String.prototype.padEnd.js: exception: " + e);
}
