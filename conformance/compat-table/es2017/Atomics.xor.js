...
try {
  if (testCode()) {
    console.log("compat-table/es2017/Atomics.xor.js: OK");
  } else {
    console.log("compat-table/es2017/Atomics.xor.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2017/Atomics.xor.js: exception: " + e);
}
