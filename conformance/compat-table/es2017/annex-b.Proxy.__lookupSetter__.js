...
try {
  if (testCode()) {
    console.log("compat-table/es2017/annex-b.Proxy.__lookupSetter__.js: OK");
  } else {
    console.log("compat-table/es2017/annex-b.Proxy.__lookupSetter__.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2017/annex-b.Proxy.__lookupSetter__.js: exception: " + e);
}
