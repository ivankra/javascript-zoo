...
try {
  if (testCode()) {
    console.log("compat-table/es2017/Atomics.wait.js: OK");
  } else {
    console.log("compat-table/es2017/Atomics.wait.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2017/Atomics.wait.js: exception: " + e);
}
