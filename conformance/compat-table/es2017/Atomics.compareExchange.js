...
try {
  if (testCode()) {
    console.log("compat-table/es2017/Atomics.compareExchange.js: OK");
  } else {
    console.log("compat-table/es2017/Atomics.compareExchange.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2017/Atomics.compareExchange.js: exception: " + e);
}
