...
try {
  if (testCode()) {
    console.log("compat-table/es2017/annex-b.Proxy.__lookupGetter__.js: OK");
  } else {
    console.log("compat-table/es2017/annex-b.Proxy.__lookupGetter__.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2017/annex-b.Proxy.__lookupGetter__.js: exception: " + e);
}
