...
try {
  if (testCode()) {
    console.log("compat-table/es2020/BigInt64Array.js: OK");
  } else {
    console.log("compat-table/es2020/BigInt64Array.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2020/BigInt64Array.js: exception: " + e);
}
