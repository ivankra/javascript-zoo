...
try {
  if (testCode()) {
    console.log("compat-table/es2020/globalThis.descriptor.js: OK");
  } else {
    console.log("compat-table/es2020/globalThis.descriptor.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2020/globalThis.descriptor.js: exception: " + e);
}
