...
try {
  if (testCode()) {
    console.log("compat-table/es2020/optional-chaining.function-call.js: OK");
  } else {
    console.log("compat-table/es2020/optional-chaining.function-call.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2020/optional-chaining.function-call.js: exception: " + e);
}
