...
try {
  if (testCode()) {
    console.log("compat-table/es2020/optional-chaining.spread-params.js: OK");
  } else {
    console.log("compat-table/es2020/optional-chaining.spread-params.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2020/optional-chaining.spread-params.js: exception: " + e);
}
