...
try {
  if (testCode()) {
    console.log("compat-table/es2020/String.prototype.matchAll.js: OK");
  } else {
    console.log("compat-table/es2020/String.prototype.matchAll.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2020/String.prototype.matchAll.js: exception: " + e);
}
