...
try {
  if (testCode()) {
    console.log("compat-table/es2020/String.prototype.matchAll.throws-non-global.js: OK");
  } else {
    console.log("compat-table/es2020/String.prototype.matchAll.throws-non-global.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2020/String.prototype.matchAll.throws-non-global.js: exception: " + e);
}
