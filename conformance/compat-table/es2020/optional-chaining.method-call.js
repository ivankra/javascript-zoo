...
try {
  if (testCode()) {
    console.log("compat-table/es2020/optional-chaining.method-call.js: OK");
  } else {
    console.log("compat-table/es2020/optional-chaining.method-call.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2020/optional-chaining.method-call.js: exception: " + e);
}
