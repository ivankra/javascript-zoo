...
try {
  if (testCode()) {
    console.log("compat-table/es2020/nullish-coalescing.js: OK");
  } else {
    console.log("compat-table/es2020/nullish-coalescing.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2020/nullish-coalescing.js: exception: " + e);
}
