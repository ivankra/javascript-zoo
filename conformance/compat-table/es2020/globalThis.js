...
try {
  if (testCode()) {
    console.log("compat-table/es2020/globalThis.js: OK");
  } else {
    console.log("compat-table/es2020/globalThis.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2020/globalThis.js: exception: " + e);
}
