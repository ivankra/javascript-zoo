// compat-table: ES Intl > DateTimeFormat > accepts valid language tags
...
try {
  if (testCode()) {
    console.log("compat-table/intl/Intl.DateTimeFormat.valid-tags.js: OK");
  } else {
    console.log("compat-table/intl/Intl.DateTimeFormat.valid-tags.js: failed");
  }
} catch (e) {
  console.log("compat-table/intl/Intl.DateTimeFormat.valid-tags.js: exception: " + e);
}
