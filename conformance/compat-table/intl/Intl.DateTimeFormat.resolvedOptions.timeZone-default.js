...
try {
  if (testCode()) {
    console.log("compat-table/intl/Intl.DateTimeFormat.resolvedOptions.timeZone-default.js: OK");
  } else {
    console.log("compat-table/intl/Intl.DateTimeFormat.resolvedOptions.timeZone-default.js: failed");
  }
} catch (e) {
  console.log("compat-table/intl/Intl.DateTimeFormat.resolvedOptions.timeZone-default.js: exception: " + e);
}
