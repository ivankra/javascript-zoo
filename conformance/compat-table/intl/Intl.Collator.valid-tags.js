// compat-table: ES Intl > Intl.Collator > accepts valid language tags
...
try {
  if (testCode()) {
    console.log("compat-table/intl/Intl.Collator.valid-tags.js: OK");
  } else {
    console.log("compat-table/intl/Intl.Collator.valid-tags.js: failed");
  }
} catch (e) {
  console.log("compat-table/intl/Intl.Collator.valid-tags.js: exception: " + e);
}
