...
try {
  if (testCode()) {
    console.log("compat-table/intl/Intl.DateTimeFormat.new-instances.js: OK");
  } else {
    console.log("compat-table/intl/Intl.DateTimeFormat.new-instances.js: failed");
  }
} catch (e) {
  console.log("compat-table/intl/Intl.DateTimeFormat.new-instances.js: exception: " + e);
}
