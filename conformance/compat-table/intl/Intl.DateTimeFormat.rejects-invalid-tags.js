...
try {
  if (testCode()) {
    console.log("compat-table/intl/Intl.DateTimeFormat.rejects-invalid-tags.js: OK");
  } else {
    console.log("compat-table/intl/Intl.DateTimeFormat.rejects-invalid-tags.js: failed");
  }
} catch (e) {
  console.log("compat-table/intl/Intl.DateTimeFormat.rejects-invalid-tags.js: exception: " + e);
}
