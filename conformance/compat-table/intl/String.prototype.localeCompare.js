...
try {
  if (testCode()) {
    console.log("compat-table/intl/String.prototype.localeCompare.js: OK");
  } else {
    console.log("compat-table/intl/String.prototype.localeCompare.js: failed");
  }
} catch (e) {
  console.log("compat-table/intl/String.prototype.localeCompare.js: exception: " + e);
}
