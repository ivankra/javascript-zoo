...
try {
  if (testCode()) {
    console.log("compat-table/intl/Intl.DateTimeFormat.without-new.js: OK");
  } else {
    console.log("compat-table/intl/Intl.DateTimeFormat.without-new.js: failed");
  }
} catch (e) {
  console.log("compat-table/intl/Intl.DateTimeFormat.without-new.js: exception: " + e);
}
