...
try {
  if (testCode()) {
    console.log("compat-table/intl/Intl.NumberFormat.new-instances.js: OK");
  } else {
    console.log("compat-table/intl/Intl.NumberFormat.new-instances.js: failed");
  }
} catch (e) {
  console.log("compat-table/intl/Intl.NumberFormat.new-instances.js: exception: " + e);
}
