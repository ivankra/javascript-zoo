...
try {
  if (testCode()) {
    console.log("compat-table/intl/Intl.NumberFormat.js: OK");
  } else {
    console.log("compat-table/intl/Intl.NumberFormat.js: failed");
  }
} catch (e) {
  console.log("compat-table/intl/Intl.NumberFormat.js: exception: " + e);
}
