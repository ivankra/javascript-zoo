...
try {
  if (testCode()) {
    console.log("compat-table/intl/Intl.Collator.prototype.resolvedOptions.js: OK");
  } else {
    console.log("compat-table/intl/Intl.Collator.prototype.resolvedOptions.js: failed");
  }
} catch (e) {
  console.log("compat-table/intl/Intl.Collator.prototype.resolvedOptions.js: exception: " + e);
}
