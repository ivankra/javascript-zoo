...
try {
  if (testCode()) {
    console.log("compat-table/intl/Object.prototype.toLocaleString.js: OK");
  } else {
    console.log("compat-table/intl/Object.prototype.toLocaleString.js: failed");
  }
} catch (e) {
  console.log("compat-table/intl/Object.prototype.toLocaleString.js: exception: " + e);
}
