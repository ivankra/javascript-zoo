...
try {
  if (testCode()) {
    console.log("compat-table/intl/Intl.DateTimeFormat.js: OK");
  } else {
    console.log("compat-table/intl/Intl.DateTimeFormat.js: failed");
  }
} catch (e) {
  console.log("compat-table/intl/Intl.DateTimeFormat.js: exception: " + e);
}
