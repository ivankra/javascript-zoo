...
try {
  if (testCode()) {
    console.log("compat-table/intl/Intl.Collator.js: OK");
  } else {
    console.log("compat-table/intl/Intl.Collator.js: failed");
  }
} catch (e) {
  console.log("compat-table/intl/Intl.Collator.js: exception: " + e);
}
