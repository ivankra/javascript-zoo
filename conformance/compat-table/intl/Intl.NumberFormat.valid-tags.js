...
try {
  if (testCode()) {
    console.log("compat-table/intl/Intl.NumberFormat.valid-tags.js: OK");
  } else {
    console.log("compat-table/intl/Intl.NumberFormat.valid-tags.js: failed");
  }
} catch (e) {
  console.log("compat-table/intl/Intl.NumberFormat.valid-tags.js: exception: " + e);
}
