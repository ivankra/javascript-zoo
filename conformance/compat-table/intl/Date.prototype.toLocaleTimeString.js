...
try {
  if (testCode()) {
    console.log("compat-table/intl/Date.prototype.toLocaleTimeString.js: OK");
  } else {
    console.log("compat-table/intl/Date.prototype.toLocaleTimeString.js: failed");
  }
} catch (e) {
  console.log("compat-table/intl/Date.prototype.toLocaleTimeString.js: exception: " + e);
}
