...
try {
  if (testCode()) {
    console.log("compat-table/intl/Number.prototype.toLocaleString.js: OK");
  } else {
    console.log("compat-table/intl/Number.prototype.toLocaleString.js: failed");
  }
} catch (e) {
  console.log("compat-table/intl/Number.prototype.toLocaleString.js: exception: " + e);
}
