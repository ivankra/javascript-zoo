...
try {
  if (testCode()) {
    console.log("compat-table/es5/Date.prototype.toJSON.js: OK");
  } else {
    console.log("compat-table/es5/Date.prototype.toJSON.js: failed");
  }
} catch (e) {
  console.log("compat-table/es5/Date.prototype.toJSON.js: exception: " + e);
}
