...
try {
  if (testCode()) {
    console.log("compat-table/es5/Object.preventExtensions.js: OK");
  } else {
    console.log("compat-table/es5/Object.preventExtensions.js: failed");
  }
} catch (e) {
  console.log("compat-table/es5/Object.preventExtensions.js: exception: " + e);
}
