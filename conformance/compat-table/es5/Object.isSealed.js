...
try {
  if (testCode()) {
    console.log("compat-table/es5/Object.isSealed.js: OK");
  } else {
    console.log("compat-table/es5/Object.isSealed.js: failed");
  }
} catch (e) {
  console.log("compat-table/es5/Object.isSealed.js: exception: " + e);
}
