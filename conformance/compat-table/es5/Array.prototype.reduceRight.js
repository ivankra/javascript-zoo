...
try {
  if (testCode()) {
    console.log("compat-table/es5/Array.prototype.reduceRight.js: OK");
  } else {
    console.log("compat-table/es5/Array.prototype.reduceRight.js: failed");
  }
} catch (e) {
  console.log("compat-table/es5/Array.prototype.reduceRight.js: exception: " + e);
}
