...
try {
  if (testCode()) {
    console.log("compat-table/es5/strict.eval-arguments-bindings-error.js: OK");
  } else {
    console.log("compat-table/es5/strict.eval-arguments-bindings-error.js: failed");
  }
} catch (e) {
  console.log("compat-table/es5/strict.eval-arguments-bindings-error.js: exception: " + e);
}
