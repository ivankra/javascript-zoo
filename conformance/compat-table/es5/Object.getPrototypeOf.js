...
try {
  if (testCode()) {
    console.log("compat-table/es5/Object.getPrototypeOf.js: OK");
  } else {
    console.log("compat-table/es5/Object.getPrototypeOf.js: failed");
  }
} catch (e) {
  console.log("compat-table/es5/Object.getPrototypeOf.js: exception: " + e);
}
