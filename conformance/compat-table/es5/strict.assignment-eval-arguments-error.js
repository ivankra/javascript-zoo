...
try {
  if (testCode()) {
    console.log("compat-table/es5/strict.assignment-eval-arguments-error.js: OK");
  } else {
    console.log("compat-table/es5/strict.assignment-eval-arguments-error.js: failed");
  }
} catch (e) {
  console.log("compat-table/es5/strict.assignment-eval-arguments-error.js: exception: " + e);
}
