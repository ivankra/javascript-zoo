...
try {
  if (testCode()) {
    console.log("compat-table/es5/strict.assignment-non-writable-error.js: OK");
  } else {
    console.log("compat-table/es5/strict.assignment-non-writable-error.js: failed");
  }
} catch (e) {
  console.log("compat-table/es5/strict.assignment-non-writable-error.js: exception: " + e);
}
