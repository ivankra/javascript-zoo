...
try {
  if (testCode()) {
    console.log("compat-table/es5/strict.this-not-coerced-methods.js: OK");
  } else {
    console.log("compat-table/es5/strict.this-not-coerced-methods.js: failed");
  }
} catch (e) {
  console.log("compat-table/es5/strict.this-not-coerced-methods.js: exception: " + e);
}
