...
try {
  if (testCode()) {
    console.log("compat-table/es5/Object.getOwnPropertyNames.js: OK");
  } else {
    console.log("compat-table/es5/Object.getOwnPropertyNames.js: failed");
  }
} catch (e) {
  console.log("compat-table/es5/Object.getOwnPropertyNames.js: exception: " + e);
}
