...
try {
  if (testCode()) {
    console.log("compat-table/es5/strict.this-not-coerced-accessors.js: OK");
  } else {
    console.log("compat-table/es5/strict.this-not-coerced-accessors.js: failed");
  }
} catch (e) {
  console.log("compat-table/es5/strict.this-not-coerced-accessors.js: exception: " + e);
}
