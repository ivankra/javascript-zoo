...
try {
  if (testCode()) {
    console.log("compat-table/es5/strict.reserved-words.js: OK");
  } else {
    console.log("compat-table/es5/strict.reserved-words.js: failed");
  }
} catch (e) {
  console.log("compat-table/es5/strict.reserved-words.js: exception: " + e);
}
