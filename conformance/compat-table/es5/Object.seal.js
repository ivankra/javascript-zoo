...
try {
  if (testCode()) {
    console.log("compat-table/es5/Object.seal.js: OK");
  } else {
    console.log("compat-table/es5/Object.seal.js: failed");
  }
} catch (e) {
  console.log("compat-table/es5/Object.seal.js: exception: " + e);
}
