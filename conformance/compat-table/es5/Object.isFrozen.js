...
try {
  if (testCode()) {
    console.log("compat-table/es5/Object.isFrozen.js: OK");
  } else {
    console.log("compat-table/es5/Object.isFrozen.js: failed");
  }
} catch (e) {
  console.log("compat-table/es5/Object.isFrozen.js: exception: " + e);
}
