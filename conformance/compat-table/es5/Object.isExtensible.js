...
try {
  if (testCode()) {
    console.log("compat-table/es5/Object.isExtensible.js: OK");
  } else {
    console.log("compat-table/es5/Object.isExtensible.js: failed");
  }
} catch (e) {
  console.log("compat-table/es5/Object.isExtensible.js: exception: " + e);
}
