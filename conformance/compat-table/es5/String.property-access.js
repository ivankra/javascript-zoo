...
try {
  if (testCode()) {
    console.log("compat-table/es5/String.property-access.js: OK");
  } else {
    console.log("compat-table/es5/String.property-access.js: failed");
  }
} catch (e) {
  console.log("compat-table/es5/String.property-access.js: exception: " + e);
}
