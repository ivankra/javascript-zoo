...
try {
  if (testCode()) {
    console.log("compat-table/es5/String.prototype.split.js: OK");
  } else {
    console.log("compat-table/es5/String.prototype.split.js: failed");
  }
} catch (e) {
  console.log("compat-table/es5/String.prototype.split.js: exception: " + e);
}
