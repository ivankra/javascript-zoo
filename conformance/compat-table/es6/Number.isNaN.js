...
try {
  if (testCode()) {
    console.log("compat-table/es6/Number.isNaN.js: OK");
  } else {
    console.log("compat-table/es6/Number.isNaN.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Number.isNaN.js: exception: " + e);
}
