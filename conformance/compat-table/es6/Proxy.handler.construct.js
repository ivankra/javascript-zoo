...
try {
  if (testCode()) {
    console.log("compat-table/es6/Proxy.handler.construct.js: OK");
  } else {
    console.log("compat-table/es6/Proxy.handler.construct.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Proxy.handler.construct.js: exception: " + e);
}
