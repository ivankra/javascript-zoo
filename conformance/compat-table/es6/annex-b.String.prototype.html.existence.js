...
try {
  if (testCode()) {
    console.log("compat-table/es6/annex-b.String.prototype.html.existence.js: OK");
  } else {
    console.log("compat-table/es6/annex-b.String.prototype.html.existence.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/annex-b.String.prototype.html.existence.js: exception: " + e);
}
