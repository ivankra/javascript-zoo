...
try {
  if (testCode()) {
    console.log("compat-table/es6/typed-arrays.prototype.join.js: OK");
  } else {
    console.log("compat-table/es6/typed-arrays.prototype.join.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/typed-arrays.prototype.join.js: exception: " + e);
}
