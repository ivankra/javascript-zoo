...
try {
  if (testCode()) {
    console.log("compat-table/es6/well-known.species.js: OK");
  } else {
    console.log("compat-table/es6/well-known.species.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/well-known.species.js: exception: " + e);
}
