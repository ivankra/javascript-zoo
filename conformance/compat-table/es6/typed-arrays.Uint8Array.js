...
try {
  if (testCode()) {
    console.log("compat-table/es6/typed-arrays.Uint8Array.js: OK");
  } else {
    console.log("compat-table/es6/typed-arrays.Uint8Array.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/typed-arrays.Uint8Array.js: exception: " + e);
}
