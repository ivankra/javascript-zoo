...
try {
  if (testCode()) {
    console.log("compat-table/es6/const.for-of.js: OK");
  } else {
    console.log("compat-table/es6/const.for-of.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/const.for-of.js: exception: " + e);
}
