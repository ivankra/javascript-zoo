...
try {
  if (testCode()) {
    console.log("compat-table/es6/spread.array-literal.js: OK");
  } else {
    console.log("compat-table/es6/spread.array-literal.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/spread.array-literal.js: exception: " + e);
}
