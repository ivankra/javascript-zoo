...
try {
  if (testCode()) {
    console.log("compat-table/es6/typed-arrays.Int16Array.js: OK");
  } else {
    console.log("compat-table/es6/typed-arrays.Int16Array.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/typed-arrays.Int16Array.js: exception: " + e);
}
