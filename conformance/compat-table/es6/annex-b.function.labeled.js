...
try {
  if (testCode()) {
    console.log("compat-table/es6/annex-b.function.labeled.js: OK");
  } else {
    console.log("compat-table/es6/annex-b.function.labeled.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/annex-b.function.labeled.js: exception: " + e);
}
