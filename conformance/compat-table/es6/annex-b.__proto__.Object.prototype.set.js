...
try {
  if (testCode()) {
    console.log("compat-table/es6/annex-b.__proto__.Object.prototype.set.js: OK");
  } else {
    console.log("compat-table/es6/annex-b.__proto__.Object.prototype.set.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/annex-b.__proto__.Object.prototype.set.js: exception: " + e);
}
