...
try {
  if (testCode()) {
    console.log("compat-table/es6/Reflect.has.js: OK");
  } else {
    console.log("compat-table/es6/Reflect.has.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Reflect.has.js: exception: " + e);
}
