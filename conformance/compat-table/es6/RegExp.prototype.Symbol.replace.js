...
try {
  if (testCode()) {
    console.log("compat-table/es6/RegExp.prototype.Symbol.replace.js: OK");
  } else {
    console.log("compat-table/es6/RegExp.prototype.Symbol.replace.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/RegExp.prototype.Symbol.replace.js: exception: " + e);
}
