...
try {
  if (testCode()) {
    console.log("compat-table/es6/annex-b.RegExp.prototype.compile.js: OK");
  } else {
    console.log("compat-table/es6/annex-b.RegExp.prototype.compile.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/annex-b.RegExp.prototype.compile.js: exception: " + e);
}
