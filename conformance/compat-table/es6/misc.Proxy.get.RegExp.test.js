...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.get.RegExp.test.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.get.RegExp.test.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.get.RegExp.test.js: exception: " + e);
}
