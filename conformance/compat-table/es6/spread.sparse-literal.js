...
try {
  if (testCode()) {
    console.log("compat-table/es6/spread.sparse-literal.js: OK");
  } else {
    console.log("compat-table/es6/spread.sparse-literal.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/spread.sparse-literal.js: exception: " + e);
}
