...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.get.RegExp.Symbol.replace.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.get.RegExp.Symbol.replace.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.get.RegExp.Symbol.replace.js: exception: " + e);
}
