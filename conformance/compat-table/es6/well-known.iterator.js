...
try {
  if (testCode()) {
    console.log("compat-table/es6/well-known.iterator.js: OK");
  } else {
    console.log("compat-table/es6/well-known.iterator.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/well-known.iterator.js: exception: " + e);
}
