...
try {
  if (testCode()) {
    console.log("compat-table/es6/subclassing.Promise.prototype-chain.js: OK");
  } else {
    console.log("compat-table/es6/subclassing.Promise.prototype-chain.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/subclassing.Promise.prototype-chain.js: exception: " + e);
}
