...
try {
  if (testCode()) {
    console.log("compat-table/es6/generators.shorthand.computed.class.js: OK");
  } else {
    console.log("compat-table/es6/generators.shorthand.computed.class.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/generators.shorthand.computed.class.js: exception: " + e);
}
