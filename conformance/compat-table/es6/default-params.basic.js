...
try {
  if (testCode()) {
    console.log("compat-table/es6/default-params.basic.js: OK");
  } else {
    console.log("compat-table/es6/default-params.basic.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/default-params.basic.js: exception: " + e);
}
