...
try {
  if (testCode()) {
    console.log("compat-table/es6/annex-b.__proto__.literals.not-computed.js: OK");
  } else {
    console.log("compat-table/es6/annex-b.__proto__.literals.not-computed.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/annex-b.__proto__.literals.not-computed.js: exception: " + e);
}
