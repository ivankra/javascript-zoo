...
try {
  if (testCode()) {
    console.log("compat-table/es6/generators.constructor.js: OK");
  } else {
    console.log("compat-table/es6/generators.constructor.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/generators.constructor.js: exception: " + e);
}
