...
try {
  if (testCode()) {
    console.log("compat-table/es6/new-target.constructor.js: OK");
  } else {
    console.log("compat-table/es6/new-target.constructor.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/new-target.constructor.js: exception: " + e);
}
