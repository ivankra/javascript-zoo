...
try {
  if (testCode()) {
    console.log("compat-table/es6/Array.from.array-like.js: OK");
  } else {
    console.log("compat-table/es6/Array.from.array-like.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Array.from.array-like.js: exception: " + e);
}
