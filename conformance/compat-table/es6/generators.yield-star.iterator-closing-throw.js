...
try {
  if (testCode()) {
    console.log("compat-table/es6/generators.yield-star.iterator-closing-throw.js: OK");
  } else {
    console.log("compat-table/es6/generators.yield-star.iterator-closing-throw.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/generators.yield-star.iterator-closing-throw.js: exception: " + e);
}
