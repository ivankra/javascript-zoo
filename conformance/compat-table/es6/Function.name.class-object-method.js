...
try {
  if (testCode()) {
    console.log("compat-table/es6/Function.name.class-object-method.js: OK");
  } else {
    console.log("compat-table/es6/Function.name.class-object-method.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Function.name.class-object-method.js: exception: " + e);
}
