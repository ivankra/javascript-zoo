...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Object.seal.primitives.js: OK");
  } else {
    console.log("compat-table/es6/misc.Object.seal.primitives.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Object.seal.primitives.js: exception: " + e);
}
