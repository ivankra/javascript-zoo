...
try {
  if (testCode()) {
    console.log("compat-table/es6/RegExp.prototype.Symbol.split.js: OK");
  } else {
    console.log("compat-table/es6/RegExp.prototype.Symbol.split.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/RegExp.prototype.Symbol.split.js: exception: " + e);
}
