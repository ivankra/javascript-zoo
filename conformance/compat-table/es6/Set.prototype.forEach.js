...
try {
  if (testCode()) {
    console.log("compat-table/es6/Set.prototype.forEach.js: OK");
  } else {
    console.log("compat-table/es6/Set.prototype.forEach.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Set.prototype.forEach.js: exception: " + e);
}
