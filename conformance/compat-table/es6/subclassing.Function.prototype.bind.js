...
try {
  if (testCode()) {
    console.log("compat-table/es6/subclassing.Function.prototype.bind.js: OK");
  } else {
    console.log("compat-table/es6/subclassing.Function.prototype.bind.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/subclassing.Function.prototype.bind.js: exception: " + e);
}
