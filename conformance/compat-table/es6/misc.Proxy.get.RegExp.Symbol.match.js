...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.get.RegExp.Symbol.match.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.get.RegExp.Symbol.match.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.get.RegExp.Symbol.match.js: exception: " + e);
}
