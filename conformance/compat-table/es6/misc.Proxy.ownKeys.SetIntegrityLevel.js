...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.ownKeys.SetIntegrityLevel.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.ownKeys.SetIntegrityLevel.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.ownKeys.SetIntegrityLevel.js: exception: " + e);
}
