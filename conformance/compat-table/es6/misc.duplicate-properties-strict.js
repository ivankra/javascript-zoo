...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.duplicate-properties-strict.js: OK");
  } else {
    console.log("compat-table/es6/misc.duplicate-properties-strict.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.duplicate-properties-strict.js: exception: " + e);
}
