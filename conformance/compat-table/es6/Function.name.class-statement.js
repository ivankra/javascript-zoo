...
try {
  if (testCode()) {
    console.log("compat-table/es6/Function.name.class-statement.js: OK");
  } else {
    console.log("compat-table/es6/Function.name.class-statement.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Function.name.class-statement.js: exception: " + e);
}
