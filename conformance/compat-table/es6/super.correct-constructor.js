...
try {
  if (testCode()) {
    console.log("compat-table/es6/super.correct-constructor.js: OK");
  } else {
    console.log("compat-table/es6/super.correct-constructor.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/super.correct-constructor.js: exception: " + e);
}
