...
try {
  if (testCode()) {
    console.log("compat-table/es6/Proxy.handler.getOwnPropertyDescriptor.invariants.js: OK");
  } else {
    console.log("compat-table/es6/Proxy.handler.getOwnPropertyDescriptor.invariants.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Proxy.handler.getOwnPropertyDescriptor.invariants.js: exception: " + e);
}
