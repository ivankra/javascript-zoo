...
try {
  if (testCode()) {
    console.log("compat-table/es6/typed-arrays.prototype.filter.js: OK");
  } else {
    console.log("compat-table/es6/typed-arrays.prototype.filter.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/typed-arrays.prototype.filter.js: exception: " + e);
}
