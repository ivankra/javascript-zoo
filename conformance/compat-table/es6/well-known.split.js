...
try {
  if (testCode()) {
    console.log("compat-table/es6/well-known.split.js: OK");
  } else {
    console.log("compat-table/es6/well-known.split.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/well-known.split.js: exception: " + e);
}
