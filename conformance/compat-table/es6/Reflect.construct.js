...
try {
  if (testCode()) {
    console.log("compat-table/es6/Reflect.construct.js: OK");
  } else {
    console.log("compat-table/es6/Reflect.construct.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Reflect.construct.js: exception: " + e);
}
