...
try {
  if (testCode()) {
    console.log("compat-table/es6/typed-arrays.Uint8ClampedArray.js: OK");
  } else {
    console.log("compat-table/es6/typed-arrays.Uint8ClampedArray.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/typed-arrays.Uint8ClampedArray.js: exception: " + e);
}
