...
try {
  if (testCode()) {
    console.log("compat-table/es6/default-params.explicit-undefined.js: OK");
  } else {
    console.log("compat-table/es6/default-params.explicit-undefined.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/default-params.explicit-undefined.js: exception: " + e);
}
