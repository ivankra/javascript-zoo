...
try {
  if (testCode()) {
    console.log("compat-table/es6/generators.yield-star.generator.js: OK");
  } else {
    console.log("compat-table/es6/generators.yield-star.generator.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/generators.yield-star.generator.js: exception: " + e);
}
