...
try {
  if (testCode()) {
    console.log("compat-table/es6/regex.flags.u.codepoint.js: OK");
  } else {
    console.log("compat-table/es6/regex.flags.u.codepoint.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/regex.flags.u.codepoint.js: exception: " + e);
}
