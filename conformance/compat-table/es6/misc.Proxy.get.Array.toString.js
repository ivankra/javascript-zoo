...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.get.Array.toString.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.get.Array.toString.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.get.Array.toString.js: exception: " + e);
}
