...
try {
  if (testCode()) {
    console.log("compat-table/es6/destructuring-decl.iterable.js: OK");
  } else {
    console.log("compat-table/es6/destructuring-decl.iterable.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/destructuring-decl.iterable.js: exception: " + e);
}
