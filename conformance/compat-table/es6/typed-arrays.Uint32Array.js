...
try {
  if (testCode()) {
    console.log("compat-table/es6/typed-arrays.Uint32Array.js: OK");
  } else {
    console.log("compat-table/es6/typed-arrays.Uint32Array.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/typed-arrays.Uint32Array.js: exception: " + e);
}
