...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.get.Array.concat.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.get.Array.concat.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.get.Array.concat.js: exception: " + e);
}
