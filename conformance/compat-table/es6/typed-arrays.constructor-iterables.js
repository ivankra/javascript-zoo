...
try {
  if (testCode()) {
    console.log("compat-table/es6/typed-arrays.constructor-iterables.js: OK");
  } else {
    console.log("compat-table/es6/typed-arrays.constructor-iterables.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/typed-arrays.constructor-iterables.js: exception: " + e);
}
