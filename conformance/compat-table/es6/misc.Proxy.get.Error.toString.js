...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.get.Error.toString.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.get.Error.toString.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.get.Error.toString.js: exception: " + e);
}
