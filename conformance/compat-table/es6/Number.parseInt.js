...
try {
  if (testCode()) {
    console.log("compat-table/es6/Number.parseInt.js: OK");
  } else {
    console.log("compat-table/es6/Number.parseInt.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Number.parseInt.js: exception: " + e);
}
