...
try {
  if (testCode()) {
    console.log("compat-table/es6/typed-arrays.prototype.sort.js: OK");
  } else {
    console.log("compat-table/es6/typed-arrays.prototype.sort.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/typed-arrays.prototype.sort.js: exception: " + e);
}
