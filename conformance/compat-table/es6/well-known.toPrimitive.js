...
try {
  if (testCode()) {
    console.log("compat-table/es6/well-known.toPrimitive.js: OK");
  } else {
    console.log("compat-table/es6/well-known.toPrimitive.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/well-known.toPrimitive.js: exception: " + e);
}
