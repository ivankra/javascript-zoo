...
try {
  if (testCode()) {
    console.log("compat-table/es6/Reflect.construct.third-argument.js: OK");
  } else {
    console.log("compat-table/es6/Reflect.construct.third-argument.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Reflect.construct.third-argument.js: exception: " + e);
}
