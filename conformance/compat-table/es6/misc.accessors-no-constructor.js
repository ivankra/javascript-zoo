...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.accessors-no-constructor.js: OK");
  } else {
    console.log("compat-table/es6/misc.accessors-no-constructor.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.accessors-no-constructor.js: exception: " + e);
}
