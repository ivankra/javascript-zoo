...
try {
  if (testCode()) {
    console.log("compat-table/es6/typed-arrays.prototype.slice.js: OK");
  } else {
    console.log("compat-table/es6/typed-arrays.prototype.slice.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/typed-arrays.prototype.slice.js: exception: " + e);
}
