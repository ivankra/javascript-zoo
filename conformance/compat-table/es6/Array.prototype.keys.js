...
try {
  if (testCode()) {
    console.log("compat-table/es6/Array.prototype.keys.js: OK");
  } else {
    console.log("compat-table/es6/Array.prototype.keys.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Array.prototype.keys.js: exception: " + e);
}
