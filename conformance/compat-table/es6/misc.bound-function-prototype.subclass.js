...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.bound-function-prototype.subclass.js: OK");
  } else {
    console.log("compat-table/es6/misc.bound-function-prototype.subclass.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.bound-function-prototype.subclass.js: exception: " + e);
}
