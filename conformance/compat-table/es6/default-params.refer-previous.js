...
try {
  if (testCode()) {
    console.log("compat-table/es6/default-params.refer-previous.js: OK");
  } else {
    console.log("compat-table/es6/default-params.refer-previous.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/default-params.refer-previous.js: exception: " + e);
}
