...
try {
  if (testCode()) {
    console.log("compat-table/es6/spread.astral-call.js: OK");
  } else {
    console.log("compat-table/es6/spread.astral-call.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/spread.astral-call.js: exception: " + e);
}
