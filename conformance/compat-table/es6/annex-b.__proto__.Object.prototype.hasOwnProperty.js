...
try {
  if (testCode()) {
    console.log("compat-table/es6/annex-b.__proto__.Object.prototype.hasOwnProperty.js: OK");
  } else {
    console.log("compat-table/es6/annex-b.__proto__.Object.prototype.hasOwnProperty.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/annex-b.__proto__.Object.prototype.hasOwnProperty.js: exception: " + e);
}
