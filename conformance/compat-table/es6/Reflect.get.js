...
try {
  if (testCode()) {
    console.log("compat-table/es6/Reflect.get.js: OK");
  } else {
    console.log("compat-table/es6/Reflect.get.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Reflect.get.js: exception: " + e);
}
