...
try {
  if (testCode()) {
    console.log("compat-table/es6/Proxy.handler.ownKeys.invariants.js: OK");
  } else {
    console.log("compat-table/es6/Proxy.handler.ownKeys.invariants.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Proxy.handler.ownKeys.invariants.js: exception: " + e);
}
