...
try {
  if (testCode()) {
    console.log("compat-table/es6/arrow.precedence.js: OK");
  } else {
    console.log("compat-table/es6/arrow.precedence.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/arrow.precedence.js: exception: " + e);
}
