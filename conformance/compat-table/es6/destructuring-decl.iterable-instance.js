...
try {
  if (testCode()) {
    console.log("compat-table/es6/destructuring-decl.iterable-instance.js: OK");
  } else {
    console.log("compat-table/es6/destructuring-decl.iterable-instance.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/destructuring-decl.iterable-instance.js: exception: " + e);
}
