...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Object.freeze.primitives.js: OK");
  } else {
    console.log("compat-table/es6/misc.Object.freeze.primitives.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Object.freeze.primitives.js: exception: " + e);
}
