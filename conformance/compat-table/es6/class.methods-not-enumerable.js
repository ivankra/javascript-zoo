...
try {
  if (testCode()) {
    console.log("compat-table/es6/class.methods-not-enumerable.js: OK");
  } else {
    console.log("compat-table/es6/class.methods-not-enumerable.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/class.methods-not-enumerable.js: exception: " + e);
}
