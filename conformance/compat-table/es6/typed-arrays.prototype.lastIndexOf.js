...
try {
  if (testCode()) {
    console.log("compat-table/es6/typed-arrays.prototype.lastIndexOf.js: OK");
  } else {
    console.log("compat-table/es6/typed-arrays.prototype.lastIndexOf.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/typed-arrays.prototype.lastIndexOf.js: exception: " + e);
}
