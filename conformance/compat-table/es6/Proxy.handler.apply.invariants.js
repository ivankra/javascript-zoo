...
try {
  if (testCode()) {
    console.log("compat-table/es6/Proxy.handler.apply.invariants.js: OK");
  } else {
    console.log("compat-table/es6/Proxy.handler.apply.invariants.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Proxy.handler.apply.invariants.js: exception: " + e);
}
