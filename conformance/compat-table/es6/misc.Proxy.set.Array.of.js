...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.set.Array.of.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.set.Array.of.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.set.Array.of.js: exception: " + e);
}
