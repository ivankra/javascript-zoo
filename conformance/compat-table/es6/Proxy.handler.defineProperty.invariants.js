...
try {
  if (testCode()) {
    console.log("compat-table/es6/Proxy.handler.defineProperty.invariants.js: OK");
  } else {
    console.log("compat-table/es6/Proxy.handler.defineProperty.invariants.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Proxy.handler.defineProperty.invariants.js: exception: " + e);
}
