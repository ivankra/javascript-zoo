...
try {
  if (testCode()) {
    console.log("compat-table/es6/Reflect.getPrototypeOf.js: OK");
  } else {
    console.log("compat-table/es6/Reflect.getPrototypeOf.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Reflect.getPrototypeOf.js: exception: " + e);
}
