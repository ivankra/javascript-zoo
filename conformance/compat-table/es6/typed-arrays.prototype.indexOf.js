...
try {
  if (testCode()) {
    console.log("compat-table/es6/typed-arrays.prototype.indexOf.js: OK");
  } else {
    console.log("compat-table/es6/typed-arrays.prototype.indexOf.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/typed-arrays.prototype.indexOf.js: exception: " + e);
}
