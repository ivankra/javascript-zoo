...
try {
  if (testCode()) {
    console.log("compat-table/es6/Reflect.preventExtensions.js: OK");
  } else {
    console.log("compat-table/es6/Reflect.preventExtensions.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Reflect.preventExtensions.js: exception: " + e);
}
