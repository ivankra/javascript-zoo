...
try {
  if (testCode()) {
    console.log("compat-table/es6/Array.from.iterable.js: OK");
  } else {
    console.log("compat-table/es6/Array.from.iterable.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Array.from.iterable.js: exception: " + e);
}
