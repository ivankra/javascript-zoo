...
try {
  if (testCode()) {
    console.log("compat-table/es6/annex-b.__proto__.Object.prototype.absent-from-null.js: OK");
  } else {
    console.log("compat-table/es6/annex-b.__proto__.Object.prototype.absent-from-null.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/annex-b.__proto__.Object.prototype.absent-from-null.js: exception: " + e);
}
