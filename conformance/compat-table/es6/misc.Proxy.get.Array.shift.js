...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.get.Array.shift.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.get.Array.shift.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.get.Array.shift.js: exception: " + e);
}
