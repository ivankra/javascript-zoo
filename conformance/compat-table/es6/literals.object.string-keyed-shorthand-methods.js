...
try {
  if (testCode()) {
    console.log("compat-table/es6/literals.object.string-keyed-shorthand-methods.js: OK");
  } else {
    console.log("compat-table/es6/literals.object.string-keyed-shorthand-methods.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/literals.object.string-keyed-shorthand-methods.js: exception: " + e);
}
