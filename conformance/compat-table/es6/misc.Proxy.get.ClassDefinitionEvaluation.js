...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.get.ClassDefinitionEvaluation.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.get.ClassDefinitionEvaluation.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.get.ClassDefinitionEvaluation.js: exception: " + e);
}
