...
try {
  if (testCode()) {
    console.log("compat-table/es6/typed-arrays.prototype.subarray.js: OK");
  } else {
    console.log("compat-table/es6/typed-arrays.prototype.subarray.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/typed-arrays.prototype.subarray.js: exception: " + e);
}
