...
try {
  if (testCode()) {
    console.log("compat-table/es6/well-known.isConcatSpreadable.non-spreadable.js: OK");
  } else {
    console.log("compat-table/es6/well-known.isConcatSpreadable.non-spreadable.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/well-known.isConcatSpreadable.non-spreadable.js: exception: " + e);
}
