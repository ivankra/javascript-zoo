...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Object.getOwnPropertyDescriptor.primitives.js: OK");
  } else {
    console.log("compat-table/es6/misc.Object.getOwnPropertyDescriptor.primitives.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Object.getOwnPropertyDescriptor.primitives.js: exception: " + e);
}
