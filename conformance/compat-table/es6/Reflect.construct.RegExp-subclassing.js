...
try {
  if (testCode()) {
    console.log("compat-table/es6/Reflect.construct.RegExp-subclassing.js: OK");
  } else {
    console.log("compat-table/es6/Reflect.construct.RegExp-subclassing.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Reflect.construct.RegExp-subclassing.js: exception: " + e);
}
