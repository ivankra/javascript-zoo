...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.get.RegExp.toString.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.get.RegExp.toString.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.get.RegExp.toString.js: exception: " + e);
}
