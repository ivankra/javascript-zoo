...
try {
  if (testCode()) {
    console.log("compat-table/es6/Reflect.getOwnPropertyDescriptor.js: OK");
  } else {
    console.log("compat-table/es6/Reflect.getOwnPropertyDescriptor.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Reflect.getOwnPropertyDescriptor.js: exception: " + e);
}
