...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.property-order.Object.keys.js: OK");
  } else {
    console.log("compat-table/es6/misc.property-order.Object.keys.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.property-order.Object.keys.js: exception: " + e);
}
