...
try {
  if (testCode()) {
    console.log("compat-table/es6/spread.iterable-literal.js: OK");
  } else {
    console.log("compat-table/es6/spread.iterable-literal.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/spread.iterable-literal.js: exception: " + e);
}
