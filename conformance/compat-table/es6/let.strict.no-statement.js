...
try {
  if (testCode()) {
    console.log("compat-table/es6/let.strict.no-statement.js: OK");
  } else {
    console.log("compat-table/es6/let.strict.no-statement.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/let.strict.no-statement.js: exception: " + e);
}
