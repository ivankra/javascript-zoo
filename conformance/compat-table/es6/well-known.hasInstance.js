...
try {
  if (testCode()) {
    console.log("compat-table/es6/well-known.hasInstance.js: OK");
  } else {
    console.log("compat-table/es6/well-known.hasInstance.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/well-known.hasInstance.js: exception: " + e);
}
