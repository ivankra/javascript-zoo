...
try {
  if (testCode()) {
    console.log("compat-table/es6/typed-arrays.Uint16Array.js: OK");
  } else {
    console.log("compat-table/es6/typed-arrays.Uint16Array.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/typed-arrays.Uint16Array.js: exception: " + e);
}
