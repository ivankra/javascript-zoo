...
try {
  if (testCode()) {
    console.log("compat-table/es6/subclassing.Function.prototype-chain.js: OK");
  } else {
    console.log("compat-table/es6/subclassing.Function.prototype-chain.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/subclassing.Function.prototype-chain.js: exception: " + e);
}
