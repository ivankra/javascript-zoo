...
try {
  if (testCode()) {
    console.log("compat-table/es6/generators.shorthand.string-keyed.js: OK");
  } else {
    console.log("compat-table/es6/generators.shorthand.string-keyed.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/generators.shorthand.string-keyed.js: exception: " + e);
}
