...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.get.CreateDynamicFunction.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.get.CreateDynamicFunction.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.get.CreateDynamicFunction.js: exception: " + e);
}
