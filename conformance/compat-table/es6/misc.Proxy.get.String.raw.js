...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.get.String.raw.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.get.String.raw.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.get.String.raw.js: exception: " + e);
}
