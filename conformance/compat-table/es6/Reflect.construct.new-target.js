...
try {
  if (testCode()) {
    console.log("compat-table/es6/Reflect.construct.new-target.js: OK");
  } else {
    console.log("compat-table/es6/Reflect.construct.new-target.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Reflect.construct.new-target.js: exception: " + e);
}
