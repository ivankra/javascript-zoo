...
try {
  if (testCode()) {
    console.log("compat-table/es6/Set.prototype.clear.js: OK");
  } else {
    console.log("compat-table/es6/Set.prototype.clear.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Set.prototype.clear.js: exception: " + e);
}
