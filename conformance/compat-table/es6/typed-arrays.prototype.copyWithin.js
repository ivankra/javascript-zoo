...
try {
  if (testCode()) {
    console.log("compat-table/es6/typed-arrays.prototype.copyWithin.js: OK");
  } else {
    console.log("compat-table/es6/typed-arrays.prototype.copyWithin.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/typed-arrays.prototype.copyWithin.js: exception: " + e);
}
