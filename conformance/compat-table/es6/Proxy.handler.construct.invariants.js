...
try {
  if (testCode()) {
    console.log("compat-table/es6/Proxy.handler.construct.invariants.js: OK");
  } else {
    console.log("compat-table/es6/Proxy.handler.construct.invariants.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Proxy.handler.construct.invariants.js: exception: " + e);
}
