...
try {
  if (testCode()) {
    console.log("compat-table/es6/String.prototype.includes.js: OK");
  } else {
    console.log("compat-table/es6/String.prototype.includes.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/String.prototype.includes.js: exception: " + e);
}
