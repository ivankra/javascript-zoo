// compat-table: ES6 > syntax > spread syntax for iterable objects (large) > with instances of iterables, in arrays
...
try {
  if (testCode()) {
    console.log("compat-table/es6/spread.iterable-instance-literal.js: OK");
  } else {
    console.log("compat-table/es6/spread.iterable-instance-literal.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/spread.iterable-instance-literal.js: exception: " + e);
}
