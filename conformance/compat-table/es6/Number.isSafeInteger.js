...
try {
  if (testCode()) {
    console.log("compat-table/es6/Number.isSafeInteger.js: OK");
  } else {
    console.log("compat-table/es6/Number.isSafeInteger.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Number.isSafeInteger.js: exception: " + e);
}
