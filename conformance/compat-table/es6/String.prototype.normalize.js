...
try {
  if (testCode()) {
    console.log("compat-table/es6/String.prototype.normalize.js: OK");
  } else {
    console.log("compat-table/es6/String.prototype.normalize.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/String.prototype.normalize.js: exception: " + e);
}
