...
try {
  if (testCode()) {
    console.log("compat-table/es6/Function.name.class-expression.js: OK");
  } else {
    console.log("compat-table/es6/Function.name.class-expression.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Function.name.class-expression.js: exception: " + e);
}
