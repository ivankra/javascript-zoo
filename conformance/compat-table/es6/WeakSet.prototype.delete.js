...
try {
  if (testCode()) {
    console.log("compat-table/es6/WeakSet.prototype.delete.js: OK");
  } else {
    console.log("compat-table/es6/WeakSet.prototype.delete.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/WeakSet.prototype.delete.js: exception: " + e);
}
