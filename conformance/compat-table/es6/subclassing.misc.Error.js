...
try {
  if (testCode()) {
    console.log("compat-table/es6/subclassing.misc.Error.js: OK");
  } else {
    console.log("compat-table/es6/subclassing.misc.Error.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/subclassing.misc.Error.js: exception: " + e);
}
