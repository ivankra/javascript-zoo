...
try {
  if (testCode()) {
    console.log("compat-table/es6/well-known.match.js: OK");
  } else {
    console.log("compat-table/es6/well-known.match.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/well-known.match.js: exception: " + e);
}
