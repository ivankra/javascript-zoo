...
try {
  if (testCode()) {
    console.log("compat-table/es6/WeakMap.accept-primitives.js: OK");
  } else {
    console.log("compat-table/es6/WeakMap.accept-primitives.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/WeakMap.accept-primitives.js: exception: " + e);
}
