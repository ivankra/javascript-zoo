...
try {
  if (testCode()) {
    console.log("compat-table/es6/destructuring-params.nested.js: OK");
  } else {
    console.log("compat-table/es6/destructuring-params.nested.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/destructuring-params.nested.js: exception: " + e);
}
