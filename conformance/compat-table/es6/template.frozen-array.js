...
try {
  if (testCode()) {
    console.log("compat-table/es6/template.frozen-array.js: OK");
  } else {
    console.log("compat-table/es6/template.frozen-array.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/template.frozen-array.js: exception: " + e);
}
