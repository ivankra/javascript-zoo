...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.get.Function.bind.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.get.Function.bind.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.get.Function.bind.js: exception: " + e);
}
