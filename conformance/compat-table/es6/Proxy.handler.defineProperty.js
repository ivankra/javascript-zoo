...
try {
  if (testCode()) {
    console.log("compat-table/es6/Proxy.handler.defineProperty.js: OK");
  } else {
    console.log("compat-table/es6/Proxy.handler.defineProperty.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Proxy.handler.defineProperty.js: exception: " + e);
}
