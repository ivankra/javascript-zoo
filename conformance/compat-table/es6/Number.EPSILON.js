...
try {
  if (testCode()) {
    console.log("compat-table/es6/Number.EPSILON.js: OK");
  } else {
    console.log("compat-table/es6/Number.EPSILON.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Number.EPSILON.js: exception: " + e);
}
