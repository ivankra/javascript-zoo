...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.deleteProperty.Array.copyWithin.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.deleteProperty.Array.copyWithin.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.deleteProperty.Array.copyWithin.js: exception: " + e);
}
