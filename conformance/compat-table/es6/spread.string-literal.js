...
try {
  if (testCode()) {
    console.log("compat-table/es6/spread.string-literal.js: OK");
  } else {
    console.log("compat-table/es6/spread.string-literal.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/spread.string-literal.js: exception: " + e);
}
