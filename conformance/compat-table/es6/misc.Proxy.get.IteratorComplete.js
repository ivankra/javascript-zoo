...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.get.IteratorComplete.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.get.IteratorComplete.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.get.IteratorComplete.js: exception: " + e);
}
