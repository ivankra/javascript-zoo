...
try {
  if (testCode()) {
    console.log("compat-table/es6/Proxy.handler.get.js: OK");
  } else {
    console.log("compat-table/es6/Proxy.handler.get.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Proxy.handler.get.js: exception: " + e);
}
