...
try {
  if (testCode()) {
    console.log("compat-table/es6/typed-arrays.DataView.Int32.js: OK");
  } else {
    console.log("compat-table/es6/typed-arrays.DataView.Int32.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/typed-arrays.DataView.Int32.js: exception: " + e);
}
