...
try {
  if (testCode()) {
    console.log("compat-table/es6/Reflect.defineProperty.js: OK");
  } else {
    console.log("compat-table/es6/Reflect.defineProperty.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Reflect.defineProperty.js: exception: " + e);
}
