...
try {
  if (testCode()) {
    console.log("compat-table/es6/well-known.species.Promise.then.js: OK");
  } else {
    console.log("compat-table/es6/well-known.species.Promise.then.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/well-known.species.Promise.then.js: exception: " + e);
}
