...
try {
  if (testCode()) {
    console.log("compat-table/es6/generators.this.js: OK");
  } else {
    console.log("compat-table/es6/generators.this.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/generators.this.js: exception: " + e);
}
