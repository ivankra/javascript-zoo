...
try {
  if (testCode()) {
    console.log("compat-table/es6/destructuring-params.object.js: OK");
  } else {
    console.log("compat-table/es6/destructuring-params.object.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/destructuring-params.object.js: exception: " + e);
}
