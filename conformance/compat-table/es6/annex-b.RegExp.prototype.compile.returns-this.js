...
try {
  if (testCode()) {
    console.log("compat-table/es6/annex-b.RegExp.prototype.compile.returns-this.js: OK");
  } else {
    console.log("compat-table/es6/annex-b.RegExp.prototype.compile.returns-this.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/annex-b.RegExp.prototype.compile.returns-this.js: exception: " + e);
}
