...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.do-while-no-semicolon.js: OK");
  } else {
    console.log("compat-table/es6/misc.do-while-no-semicolon.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.do-while-no-semicolon.js: exception: " + e);
}
