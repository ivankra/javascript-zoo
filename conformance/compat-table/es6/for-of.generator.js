...
try {
  if (testCode()) {
    console.log("compat-table/es6/for-of.generator.js: OK");
  } else {
    console.log("compat-table/es6/for-of.generator.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/for-of.generator.js: exception: " + e);
}
