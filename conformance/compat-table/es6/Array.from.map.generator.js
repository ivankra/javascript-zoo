...
try {
  if (testCode()) {
    console.log("compat-table/es6/Array.from.map.generator.js: OK");
  } else {
    console.log("compat-table/es6/Array.from.map.generator.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Array.from.map.generator.js: exception: " + e);
}
