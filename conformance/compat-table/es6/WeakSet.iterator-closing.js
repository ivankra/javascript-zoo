// compat-table: ES6 > built-ins > WeakSet (small) > iterator closing
...
try {
  if (testCode()) {
    console.log("compat-table/es6/WeakSet.iterator-closing.js: OK");
  } else {
    console.log("compat-table/es6/WeakSet.iterator-closing.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/WeakSet.iterator-closing.js: exception: " + e);
}
