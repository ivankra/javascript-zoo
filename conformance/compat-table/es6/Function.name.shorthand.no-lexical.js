...
try {
  if (testCode()) {
    console.log("compat-table/es6/Function.name.shorthand.no-lexical.js: OK");
  } else {
    console.log("compat-table/es6/Function.name.shorthand.no-lexical.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Function.name.shorthand.no-lexical.js: exception: " + e);
}
