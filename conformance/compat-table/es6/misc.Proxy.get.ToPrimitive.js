...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.get.ToPrimitive.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.get.ToPrimitive.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.get.ToPrimitive.js: exception: " + e);
}
