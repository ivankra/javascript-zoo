...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Object.getPrototypeOf.primitives.js: OK");
  } else {
    console.log("compat-table/es6/misc.Object.getPrototypeOf.primitives.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Object.getPrototypeOf.primitives.js: exception: " + e);
}
