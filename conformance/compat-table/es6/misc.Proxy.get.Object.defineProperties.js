...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.get.Object.defineProperties.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.get.Object.defineProperties.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.get.Object.defineProperties.js: exception: " + e);
}
