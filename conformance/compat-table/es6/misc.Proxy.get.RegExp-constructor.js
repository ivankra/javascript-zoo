// compat-table: ES6 > misc > Proxy, internal 'get' calls (tiny) > RegExp constructor
...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.get.RegExp-constructor.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.get.RegExp-constructor.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.get.RegExp-constructor.js: exception: " + e);
}
