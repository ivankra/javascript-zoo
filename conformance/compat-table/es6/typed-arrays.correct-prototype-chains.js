...
try {
  if (testCode()) {
    console.log("compat-table/es6/typed-arrays.correct-prototype-chains.js: OK");
  } else {
    console.log("compat-table/es6/typed-arrays.correct-prototype-chains.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/typed-arrays.correct-prototype-chains.js: exception: " + e);
}
