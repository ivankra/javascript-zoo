...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.property-order.Reflect.ownKeys.string.js: OK");
  } else {
    console.log("compat-table/es6/misc.property-order.Reflect.ownKeys.string.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.property-order.Reflect.ownKeys.string.js: exception: " + e);
}
