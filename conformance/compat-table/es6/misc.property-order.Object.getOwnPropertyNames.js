...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.property-order.Object.getOwnPropertyNames.js: OK");
  } else {
    console.log("compat-table/es6/misc.property-order.Object.getOwnPropertyNames.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.property-order.Object.getOwnPropertyNames.js: exception: " + e);
}
