...
try {
  if (testCode()) {
    console.log("compat-table/es6/typed-arrays.DataView.Uint32.js: OK");
  } else {
    console.log("compat-table/es6/typed-arrays.DataView.Uint32.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/typed-arrays.DataView.Uint32.js: exception: " + e);
}
