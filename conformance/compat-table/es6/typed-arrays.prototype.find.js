...
try {
  if (testCode()) {
    console.log("compat-table/es6/typed-arrays.prototype.find.js: OK");
  } else {
    console.log("compat-table/es6/typed-arrays.prototype.find.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/typed-arrays.prototype.find.js: exception: " + e);
}
