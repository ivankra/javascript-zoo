...
try {
  if (testCode()) {
    console.log("compat-table/es6/typed-arrays.constructor-requires-new.js: OK");
  } else {
    console.log("compat-table/es6/typed-arrays.constructor-requires-new.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/typed-arrays.constructor-requires-new.js: exception: " + e);
}
