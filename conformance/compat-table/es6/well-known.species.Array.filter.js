...
try {
  if (testCode()) {
    console.log("compat-table/es6/well-known.species.Array.filter.js: OK");
  } else {
    console.log("compat-table/es6/well-known.species.Array.filter.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/well-known.species.Array.filter.js: exception: " + e);
}
