...
try {
  if (testCode()) {
    console.log("compat-table/es6/Set.prototype.entries.js: OK");
  } else {
    console.log("compat-table/es6/Set.prototype.entries.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Set.prototype.entries.js: exception: " + e);
}
