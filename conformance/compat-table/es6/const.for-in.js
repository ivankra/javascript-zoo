...
try {
  if (testCode()) {
    console.log("compat-table/es6/const.for-in.js: OK");
  } else {
    console.log("compat-table/es6/const.for-in.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/const.for-in.js: exception: " + e);
}
