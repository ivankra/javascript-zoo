...
try {
  if (testCode()) {
    console.log("compat-table/es6/well-known.species.Array.map.js: OK");
  } else {
    console.log("compat-table/es6/well-known.species.Array.map.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/well-known.species.Array.map.js: exception: " + e);
}
