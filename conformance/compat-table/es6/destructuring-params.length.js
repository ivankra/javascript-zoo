...
try {
  if (testCode()) {
    console.log("compat-table/es6/destructuring-params.length.js: OK");
  } else {
    console.log("compat-table/es6/destructuring-params.length.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/destructuring-params.length.js: exception: " + e);
}
