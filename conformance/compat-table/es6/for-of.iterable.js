// compat-table: ES6 > syntax > for..of loops (large) > with generic iterables
...
try {
  if (testCode()) {
    console.log("compat-table/es6/for-of.iterable.js: OK");
  } else {
    console.log("compat-table/es6/for-of.iterable.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/for-of.iterable.js: exception: " + e);
}
