...
try {
  if (testCode()) {
    console.log("compat-table/es6/Promise.Symbol.species.js: OK");
  } else {
    console.log("compat-table/es6/Promise.Symbol.species.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Promise.Symbol.species.js: exception: " + e);
}
