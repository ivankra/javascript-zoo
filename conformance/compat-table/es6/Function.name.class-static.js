...
try {
  if (testCode()) {
    console.log("compat-table/es6/Function.name.class-static.js: OK");
  } else {
    console.log("compat-table/es6/Function.name.class-static.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Function.name.class-static.js: exception: " + e);
}
