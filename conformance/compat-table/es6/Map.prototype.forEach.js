...
try {
  if (testCode()) {
    console.log("compat-table/es6/Map.prototype.forEach.js: OK");
  } else {
    console.log("compat-table/es6/Map.prototype.forEach.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Map.prototype.forEach.js: exception: " + e);
}
