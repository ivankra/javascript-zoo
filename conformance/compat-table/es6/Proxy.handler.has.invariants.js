...
try {
  if (testCode()) {
    console.log("compat-table/es6/Proxy.handler.has.invariants.js: OK");
  } else {
    console.log("compat-table/es6/Proxy.handler.has.invariants.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Proxy.handler.has.invariants.js: exception: " + e);
}
