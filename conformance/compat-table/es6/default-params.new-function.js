...
try {
  if (testCode()) {
    console.log("compat-table/es6/default-params.new-function.js: OK");
  } else {
    console.log("compat-table/es6/default-params.new-function.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/default-params.new-function.js: exception: " + e);
}
