...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.get.RegExp.flags.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.get.RegExp.flags.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.get.RegExp.flags.js: exception: " + e);
}
