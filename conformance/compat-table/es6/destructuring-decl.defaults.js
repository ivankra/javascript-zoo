...
try {
  if (testCode()) {
    console.log("compat-table/es6/destructuring-decl.defaults.js: OK");
  } else {
    console.log("compat-table/es6/destructuring-decl.defaults.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/destructuring-decl.defaults.js: exception: " + e);
}
