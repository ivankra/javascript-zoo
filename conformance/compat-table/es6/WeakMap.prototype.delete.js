...
try {
  if (testCode()) {
    console.log("compat-table/es6/WeakMap.prototype.delete.js: OK");
  } else {
    console.log("compat-table/es6/WeakMap.prototype.delete.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/WeakMap.prototype.delete.js: exception: " + e);
}
