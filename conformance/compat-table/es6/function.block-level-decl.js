...
try {
  if (testCode()) {
    console.log("compat-table/es6/function.block-level-decl.js: OK");
  } else {
    console.log("compat-table/es6/function.block-level-decl.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/function.block-level-decl.js: exception: " + e);
}
