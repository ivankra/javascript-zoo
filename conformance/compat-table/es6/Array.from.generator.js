...
try {
  if (testCode()) {
    console.log("compat-table/es6/Array.from.generator.js: OK");
  } else {
    console.log("compat-table/es6/Array.from.generator.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Array.from.generator.js: exception: " + e);
}
