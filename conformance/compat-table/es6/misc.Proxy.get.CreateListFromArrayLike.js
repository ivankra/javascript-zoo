...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.get.CreateListFromArrayLike.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.get.CreateListFromArrayLike.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.get.CreateListFromArrayLike.js: exception: " + e);
}
