...
try {
  if (testCode()) {
    console.log("compat-table/es6/well-known.toStringTag.existing-builtins.js: OK");
  } else {
    console.log("compat-table/es6/well-known.toStringTag.existing-builtins.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/well-known.toStringTag.existing-builtins.js: exception: " + e);
}
