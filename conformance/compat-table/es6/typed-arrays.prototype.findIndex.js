...
try {
  if (testCode()) {
    console.log("compat-table/es6/typed-arrays.prototype.findIndex.js: OK");
  } else {
    console.log("compat-table/es6/typed-arrays.prototype.findIndex.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/typed-arrays.prototype.findIndex.js: exception: " + e);
}
