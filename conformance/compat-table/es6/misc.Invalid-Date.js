...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Invalid-Date.js: OK");
  } else {
    console.log("compat-table/es6/misc.Invalid-Date.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Invalid-Date.js: exception: " + e);
}
