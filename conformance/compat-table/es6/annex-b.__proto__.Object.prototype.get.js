...
try {
  if (testCode()) {
    console.log("compat-table/es6/annex-b.__proto__.Object.prototype.get.js: OK");
  } else {
    console.log("compat-table/es6/annex-b.__proto__.Object.prototype.get.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/annex-b.__proto__.Object.prototype.get.js: exception: " + e);
}
