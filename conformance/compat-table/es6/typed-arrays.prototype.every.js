...
try {
  if (testCode()) {
    console.log("compat-table/es6/typed-arrays.prototype.every.js: OK");
  } else {
    console.log("compat-table/es6/typed-arrays.prototype.every.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/typed-arrays.prototype.every.js: exception: " + e);
}
