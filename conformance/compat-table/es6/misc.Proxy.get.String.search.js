// compat-table: ES6 > misc > Proxy, internal 'get' calls (tiny) > String.prototype.search
...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.get.String.search.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.get.String.search.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.get.String.search.js: exception: " + e);
}
