...
try {
  if (testCode()) {
    console.log("compat-table/es6/subclassing.misc.Boolean.js: OK");
  } else {
    console.log("compat-table/es6/subclassing.misc.Boolean.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/subclassing.misc.Boolean.js: exception: " + e);
}
