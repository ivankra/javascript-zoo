...
try {
  if (testCode()) {
    console.log("compat-table/es6/for-of.astral-string.js: OK");
  } else {
    console.log("compat-table/es6/for-of.astral-string.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/for-of.astral-string.js: exception: " + e);
}
