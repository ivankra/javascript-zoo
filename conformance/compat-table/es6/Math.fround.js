...
try {
  if (testCode()) {
    console.log("compat-table/es6/Math.fround.js: OK");
  } else {
    console.log("compat-table/es6/Math.fround.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Math.fround.js: exception: " + e);
}
