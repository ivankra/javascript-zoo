...
try {
  if (testCode()) {
    console.log("compat-table/es6/typed-arrays.DataView.Uint16.js: OK");
  } else {
    console.log("compat-table/es6/typed-arrays.DataView.Uint16.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/typed-arrays.DataView.Uint16.js: exception: " + e);
}
