...
try {
  if (testCode()) {
    console.log("compat-table/es6/typed-arrays.ArrayBuffer.Symbol.species.js: OK");
  } else {
    console.log("compat-table/es6/typed-arrays.ArrayBuffer.Symbol.species.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/typed-arrays.ArrayBuffer.Symbol.species.js: exception: " + e);
}
