...
try {
  if (testCode()) {
    console.log("compat-table/es6/Proxy.handler.setPrototypeOf.invariants.js: OK");
  } else {
    console.log("compat-table/es6/Proxy.handler.setPrototypeOf.invariants.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Proxy.handler.setPrototypeOf.invariants.js: exception: " + e);
}
