...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.get.Array.iteration.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.get.Array.iteration.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.get.Array.iteration.js: exception: " + e);
}
