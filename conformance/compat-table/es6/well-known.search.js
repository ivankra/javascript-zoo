...
try {
  if (testCode()) {
    console.log("compat-table/es6/well-known.search.js: OK");
  } else {
    console.log("compat-table/es6/well-known.search.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/well-known.search.js: exception: " + e);
}
