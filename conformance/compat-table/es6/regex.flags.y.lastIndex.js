...
try {
  if (testCode()) {
    console.log("compat-table/es6/regex.flags.y.lastIndex.js: OK");
  } else {
    console.log("compat-table/es6/regex.flags.y.lastIndex.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/regex.flags.y.lastIndex.js: exception: " + e);
}
