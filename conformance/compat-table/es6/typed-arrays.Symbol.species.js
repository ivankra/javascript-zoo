...
try {
  if (testCode()) {
    console.log("compat-table/es6/typed-arrays.Symbol.species.js: OK");
  } else {
    console.log("compat-table/es6/typed-arrays.Symbol.species.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/typed-arrays.Symbol.species.js: exception: " + e);
}
