...
try {
  if (testCode()) {
    console.log("compat-table/es6/Function.name.class-prototype.js: OK");
  } else {
    console.log("compat-table/es6/Function.name.class-prototype.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Function.name.class-prototype.js: exception: " + e);
}
