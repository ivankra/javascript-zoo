...
try {
  if (testCode()) {
    console.log("compat-table/es6/for-of.array.js: OK");
  } else {
    console.log("compat-table/es6/for-of.array.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/for-of.array.js: exception: " + e);
}
