...
try {
  if (testCode()) {
    console.log("compat-table/es6/typed-arrays.DataView.Int16.js: OK");
  } else {
    console.log("compat-table/es6/typed-arrays.DataView.Int16.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/typed-arrays.DataView.Int16.js: exception: " + e);
}
