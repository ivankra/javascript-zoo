...
try {
  if (testCode()) {
    console.log("compat-table/es6/Symbol.JSON.stringify.primitive.js: OK");
  } else {
    console.log("compat-table/es6/Symbol.JSON.stringify.primitive.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Symbol.JSON.stringify.primitive.js: exception: " + e);
}
