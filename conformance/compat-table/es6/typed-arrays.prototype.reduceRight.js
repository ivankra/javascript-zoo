...
try {
  if (testCode()) {
    console.log("compat-table/es6/typed-arrays.prototype.reduceRight.js: OK");
  } else {
    console.log("compat-table/es6/typed-arrays.prototype.reduceRight.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/typed-arrays.prototype.reduceRight.js: exception: " + e);
}
