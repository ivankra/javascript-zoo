...
try {
  if (testCode()) {
    console.log("compat-table/es6/Reflect.apply.js: OK");
  } else {
    console.log("compat-table/es6/Reflect.apply.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Reflect.apply.js: exception: " + e);
}
