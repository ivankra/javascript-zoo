...
try {
  if (testCode()) {
    console.log("compat-table/es6/literals.object.computed-properties.js: OK");
  } else {
    console.log("compat-table/es6/literals.object.computed-properties.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/literals.object.computed-properties.js: exception: " + e);
}
