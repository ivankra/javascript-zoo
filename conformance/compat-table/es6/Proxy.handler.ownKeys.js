...
try {
  if (testCode()) {
    console.log("compat-table/es6/Proxy.handler.ownKeys.js: OK");
  } else {
    console.log("compat-table/es6/Proxy.handler.ownKeys.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Proxy.handler.ownKeys.js: exception: " + e);
}
