...
try {
  if (testCode()) {
    console.log("compat-table/es6/typed-arrays.prototype.map.js: OK");
  } else {
    console.log("compat-table/es6/typed-arrays.prototype.map.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/typed-arrays.prototype.map.js: exception: " + e);
}
