...
try {
  if (testCode()) {
    console.log("compat-table/es6/typed-arrays.prototype.keys.js: OK");
  } else {
    console.log("compat-table/es6/typed-arrays.prototype.keys.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/typed-arrays.prototype.keys.js: exception: " + e);
}
