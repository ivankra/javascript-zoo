// compat-table: ES6 > built-ins > Promise (large) > Promise.all, generic iterables
...
function asyncTestPassed() {
  console.log("compat-table/es6/Promise.all.iterable.js: OK");
}
...
try {
  ...
  console.log("compat-table/es6/Promise.all.iterable.js: exception: " + e);
}
