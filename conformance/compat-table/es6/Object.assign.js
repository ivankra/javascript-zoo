...
try {
  if (testCode()) {
    console.log("compat-table/es6/Object.assign.js: OK");
  } else {
    console.log("compat-table/es6/Object.assign.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Object.assign.js: exception: " + e);
}
