...
try {
  if (testCode()) {
    console.log("compat-table/es6/spread.astral-literal.js: OK");
  } else {
    console.log("compat-table/es6/spread.astral-literal.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/spread.astral-literal.js: exception: " + e);
}
