...
try {
  if (testCode()) {
    console.log("compat-table/es6/Proxy.handler.get.invariants.js: OK");
  } else {
    console.log("compat-table/es6/Proxy.handler.get.invariants.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Proxy.handler.get.invariants.js: exception: " + e);
}
