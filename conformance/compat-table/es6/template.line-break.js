...
try {
  if (testCode()) {
    console.log("compat-table/es6/template.line-break.js: OK");
  } else {
    console.log("compat-table/es6/template.line-break.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/template.line-break.js: exception: " + e);
}
