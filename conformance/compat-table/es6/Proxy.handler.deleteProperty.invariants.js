...
try {
  if (testCode()) {
    console.log("compat-table/es6/Proxy.handler.deleteProperty.invariants.js: OK");
  } else {
    console.log("compat-table/es6/Proxy.handler.deleteProperty.invariants.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Proxy.handler.deleteProperty.invariants.js: exception: " + e);
}
