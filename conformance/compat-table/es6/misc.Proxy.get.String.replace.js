...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.get.String.replace.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.get.String.replace.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.get.String.replace.js: exception: " + e);
}
