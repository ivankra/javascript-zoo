...
try {
  if (testCode()) {
    console.log("compat-table/es6/Proxy.handler.preventExtensions.js: OK");
  } else {
    console.log("compat-table/es6/Proxy.handler.preventExtensions.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Proxy.handler.preventExtensions.js: exception: " + e);
}
