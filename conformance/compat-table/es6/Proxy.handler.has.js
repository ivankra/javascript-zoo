...
try {
  if (testCode()) {
    console.log("compat-table/es6/Proxy.handler.has.js: OK");
  } else {
    console.log("compat-table/es6/Proxy.handler.has.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Proxy.handler.has.js: exception: " + e);
}
