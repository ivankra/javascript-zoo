...
try {
  if (testCode()) {
    console.log("compat-table/es6/Array.prototype.copyWithin.js: OK");
  } else {
    console.log("compat-table/es6/Array.prototype.copyWithin.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Array.prototype.copyWithin.js: exception: " + e);
}
