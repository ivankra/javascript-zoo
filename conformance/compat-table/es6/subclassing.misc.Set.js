...
try {
  if (testCode()) {
    console.log("compat-table/es6/subclassing.misc.Set.js: OK");
  } else {
    console.log("compat-table/es6/subclassing.misc.Set.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/subclassing.misc.Set.js: exception: " + e);
}
