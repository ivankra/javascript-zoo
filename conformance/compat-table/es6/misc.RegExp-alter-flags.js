...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.RegExp-alter-flags.js: OK");
  } else {
    console.log("compat-table/es6/misc.RegExp-alter-flags.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.RegExp-alter-flags.js: exception: " + e);
}
