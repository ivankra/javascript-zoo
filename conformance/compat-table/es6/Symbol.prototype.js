...
try {
  if (testCode()) {
    console.log("compat-table/es6/Symbol.prototype.js: OK");
  } else {
    console.log("compat-table/es6/Symbol.prototype.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Symbol.prototype.js: exception: " + e);
}
