...
try {
  if (testCode()) {
    console.log("compat-table/es6/RegExp.prototype.Symbol.match.js: OK");
  } else {
    console.log("compat-table/es6/RegExp.prototype.Symbol.match.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/RegExp.prototype.Symbol.match.js: exception: " + e);
}
