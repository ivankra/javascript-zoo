...
try {
  if (testCode()) {
    console.log("compat-table/es6/Proxy.handler.set.invariants.js: OK");
  } else {
    console.log("compat-table/es6/Proxy.handler.set.invariants.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Proxy.handler.set.invariants.js: exception: " + e);
}
