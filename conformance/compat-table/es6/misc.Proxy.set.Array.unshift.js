...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.set.Array.unshift.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.set.Array.unshift.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.set.Array.unshift.js: exception: " + e);
}
