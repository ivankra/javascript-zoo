...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.get.JSON.stringify.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.get.JSON.stringify.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.get.JSON.stringify.js: exception: " + e);
}
