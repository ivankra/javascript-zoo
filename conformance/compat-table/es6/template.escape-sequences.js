...
try {
  if (testCode()) {
    console.log("compat-table/es6/template.escape-sequences.js: OK");
  } else {
    console.log("compat-table/es6/template.escape-sequences.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/template.escape-sequences.js: exception: " + e);
}
