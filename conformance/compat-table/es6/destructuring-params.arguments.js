...
try {
  if (testCode()) {
    console.log("compat-table/es6/destructuring-params.arguments.js: OK");
  } else {
    console.log("compat-table/es6/destructuring-params.arguments.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/destructuring-params.arguments.js: exception: " + e);
}
