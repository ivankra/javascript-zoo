...
try {
  if (testCode()) {
    console.log("compat-table/es6/Date.prototype.Symbol.toPrimitive.js: OK");
  } else {
    console.log("compat-table/es6/Date.prototype.Symbol.toPrimitive.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Date.prototype.Symbol.toPrimitive.js: exception: " + e);
}
