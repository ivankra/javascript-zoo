...
try {
  if (testCode()) {
    console.log("compat-table/es6/for-of.iterator-closing-break.js: OK");
  } else {
    console.log("compat-table/es6/for-of.iterator-closing-break.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/for-of.iterator-closing-break.js: exception: " + e);
}
