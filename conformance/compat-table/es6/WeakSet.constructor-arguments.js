...
try {
  if (testCode()) {
    console.log("compat-table/es6/WeakSet.constructor-arguments.js: OK");
  } else {
    console.log("compat-table/es6/WeakSet.constructor-arguments.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/WeakSet.constructor-arguments.js: exception: " + e);
}
