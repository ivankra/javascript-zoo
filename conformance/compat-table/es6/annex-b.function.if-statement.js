...
try {
  if (testCode()) {
    console.log("compat-table/es6/annex-b.function.if-statement.js: OK");
  } else {
    console.log("compat-table/es6/annex-b.function.if-statement.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/annex-b.function.if-statement.js: exception: " + e);
}
