...
try {
  if (testCode()) {
    console.log("compat-table/es6/typed-arrays.prototype.reverse.js: OK");
  } else {
    console.log("compat-table/es6/typed-arrays.prototype.reverse.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/typed-arrays.prototype.reverse.js: exception: " + e);
}
