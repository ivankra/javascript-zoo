...
try {
  if (testCode()) {
    console.log("compat-table/es6/Proxy.handler.set.js: OK");
  } else {
    console.log("compat-table/es6/Proxy.handler.set.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Proxy.handler.set.js: exception: " + e);
}
