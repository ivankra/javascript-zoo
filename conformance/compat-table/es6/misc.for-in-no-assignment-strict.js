...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.for-in-no-assignment-strict.js: OK");
  } else {
    console.log("compat-table/es6/misc.for-in-no-assignment-strict.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.for-in-no-assignment-strict.js: exception: " + e);
}
