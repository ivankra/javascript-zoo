...
try {
  if (testCode()) {
    console.log("compat-table/es6/Reflect.set.js: OK");
  } else {
    console.log("compat-table/es6/Reflect.set.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Reflect.set.js: exception: " + e);
}
