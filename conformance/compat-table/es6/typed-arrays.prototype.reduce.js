...
try {
  if (testCode()) {
    console.log("compat-table/es6/typed-arrays.prototype.reduce.js: OK");
  } else {
    console.log("compat-table/es6/typed-arrays.prototype.reduce.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/typed-arrays.prototype.reduce.js: exception: " + e);
}
