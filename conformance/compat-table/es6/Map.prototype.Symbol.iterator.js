...
try {
  if (testCode()) {
    console.log("compat-table/es6/Map.prototype.Symbol.iterator.js: OK");
  } else {
    console.log("compat-table/es6/Map.prototype.Symbol.iterator.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Map.prototype.Symbol.iterator.js: exception: " + e);
}
