...
try {
  if (testCode()) {
    console.log("compat-table/es6/Proxy.handler.apply.js: OK");
  } else {
    console.log("compat-table/es6/Proxy.handler.apply.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Proxy.handler.apply.js: exception: " + e);
}
