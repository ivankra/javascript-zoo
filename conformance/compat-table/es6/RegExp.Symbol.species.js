...
try {
  if (testCode()) {
    console.log("compat-table/es6/RegExp.Symbol.species.js: OK");
  } else {
    console.log("compat-table/es6/RegExp.Symbol.species.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/RegExp.Symbol.species.js: exception: " + e);
}
