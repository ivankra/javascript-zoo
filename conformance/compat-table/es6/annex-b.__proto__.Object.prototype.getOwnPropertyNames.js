...
try {
  if (testCode()) {
    console.log("compat-table/es6/annex-b.__proto__.Object.prototype.getOwnPropertyNames.js: OK");
  } else {
    console.log("compat-table/es6/annex-b.__proto__.Object.prototype.getOwnPropertyNames.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/annex-b.__proto__.Object.prototype.getOwnPropertyNames.js: exception: " + e);
}
