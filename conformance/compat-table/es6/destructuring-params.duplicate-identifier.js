...
try {
  if (testCode()) {
    console.log("compat-table/es6/destructuring-params.duplicate-identifier.js: OK");
  } else {
    console.log("compat-table/es6/destructuring-params.duplicate-identifier.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/destructuring-params.duplicate-identifier.js: exception: " + e);
}
