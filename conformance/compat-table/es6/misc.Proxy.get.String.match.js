...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.get.String.match.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.get.String.match.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.get.String.match.js: exception: " + e);
}
