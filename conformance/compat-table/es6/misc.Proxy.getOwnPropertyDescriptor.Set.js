...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.getOwnPropertyDescriptor.Set.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.getOwnPropertyDescriptor.Set.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.getOwnPropertyDescriptor.Set.js: exception: " + e);
}
