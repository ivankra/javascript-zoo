...
try {
  if (testCode()) {
    console.log("compat-table/es6/Number.parseFloat.js: OK");
  } else {
    console.log("compat-table/es6/Number.parseFloat.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Number.parseFloat.js: exception: " + e);
}
