...
try {
  if (testCode()) {
    console.log("compat-table/es6/Function.name.symbol-keyed.js: OK");
  } else {
    console.log("compat-table/es6/Function.name.symbol-keyed.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Function.name.symbol-keyed.js: exception: " + e);
}
