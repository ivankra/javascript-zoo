...
try {
  if (testCode()) {
    console.log("compat-table/es6/generators.yield-star.iterable-instance.js: OK");
  } else {
    console.log("compat-table/es6/generators.yield-star.iterable-instance.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/generators.yield-star.iterable-instance.js: exception: " + e);
}
