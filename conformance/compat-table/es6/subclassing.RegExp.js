...
try {
  if (testCode()) {
    console.log("compat-table/es6/subclassing.RegExp.js: OK");
  } else {
    console.log("compat-table/es6/subclassing.RegExp.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/subclassing.RegExp.js: exception: " + e);
}
