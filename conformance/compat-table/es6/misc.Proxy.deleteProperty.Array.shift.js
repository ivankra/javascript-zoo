...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.deleteProperty.Array.shift.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.deleteProperty.Array.shift.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.deleteProperty.Array.shift.js: exception: " + e);
}
