...
try {
  if (testCode()) {
    console.log("compat-table/es6/Function.name.new-Function.js: OK");
  } else {
    console.log("compat-table/es6/Function.name.new-Function.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Function.name.new-Function.js: exception: " + e);
}
