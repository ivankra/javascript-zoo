...
try {
  if (testCode()) {
    console.log("compat-table/es6/new-target.assignment-error.js: OK");
  } else {
    console.log("compat-table/es6/new-target.assignment-error.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/new-target.assignment-error.js: exception: " + e);
}
