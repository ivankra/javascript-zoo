...
try {
  if (testCode()) {
    console.log("compat-table/es6/annex-b.__proto__.literals.multiple-error.js: OK");
  } else {
    console.log("compat-table/es6/annex-b.__proto__.literals.multiple-error.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/annex-b.__proto__.literals.multiple-error.js: exception: " + e);
}
