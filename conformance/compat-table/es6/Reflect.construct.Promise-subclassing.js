...
function asyncTestPassed() {
  console.log("compat-table/es6/Reflect.construct.Promise-subclassing.js: OK");
}
...
try {
  ...
  console.log("compat-table/es6/Reflect.construct.Promise-subclassing.js: exception: " + e);
}
