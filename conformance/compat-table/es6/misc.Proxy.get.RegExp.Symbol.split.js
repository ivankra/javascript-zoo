...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.get.RegExp.Symbol.split.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.get.RegExp.Symbol.split.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.get.RegExp.Symbol.split.js: exception: " + e);
}
