...
try {
  if (testCode()) {
    console.log("compat-table/es6/Function.name.shorthand.js: OK");
  } else {
    console.log("compat-table/es6/Function.name.shorthand.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Function.name.shorthand.js: exception: " + e);
}
