...
try {
  if (testCode()) {
    console.log("compat-table/es6/RegExp.prototype.flags.js: OK");
  } else {
    console.log("compat-table/es6/RegExp.prototype.flags.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/RegExp.prototype.flags.js: exception: " + e);
}
