...
try {
  if (testCode()) {
    console.log("compat-table/es6/WeakSet.prototype.add-returns-this.js: OK");
  } else {
    console.log("compat-table/es6/WeakSet.prototype.add-returns-this.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/WeakSet.prototype.add-returns-this.js: exception: " + e);
}
