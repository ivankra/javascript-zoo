...
try {
  if (testCode()) {
    console.log("compat-table/es6/spread.non-iterable-error.js: OK");
  } else {
    console.log("compat-table/es6/spread.non-iterable-error.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/spread.non-iterable-error.js: exception: " + e);
}
