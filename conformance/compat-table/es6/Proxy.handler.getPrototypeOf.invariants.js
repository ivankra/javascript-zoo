...
try {
  if (testCode()) {
    console.log("compat-table/es6/Proxy.handler.getPrototypeOf.invariants.js: OK");
  } else {
    console.log("compat-table/es6/Proxy.handler.getPrototypeOf.invariants.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Proxy.handler.getPrototypeOf.invariants.js: exception: " + e);
}
