...
try {
  if (testCode()) {
    console.log("compat-table/es6/Proxy.handler.getOwnPropertyDescriptor.js: OK");
  } else {
    console.log("compat-table/es6/Proxy.handler.getOwnPropertyDescriptor.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Proxy.handler.getOwnPropertyDescriptor.js: exception: " + e);
}
