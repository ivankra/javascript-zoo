...
try {
  if (testCode()) {
    console.log("compat-table/es6/regex.flags.u.js: OK");
  } else {
    console.log("compat-table/es6/regex.flags.u.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/regex.flags.u.js: exception: " + e);
}
