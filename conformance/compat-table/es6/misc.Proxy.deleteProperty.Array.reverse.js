...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.deleteProperty.Array.reverse.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.deleteProperty.Array.reverse.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.deleteProperty.Array.reverse.js: exception: " + e);
}
