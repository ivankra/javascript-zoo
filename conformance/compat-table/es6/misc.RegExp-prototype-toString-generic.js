...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.RegExp-prototype-toString-generic.js: OK");
  } else {
    console.log("compat-table/es6/misc.RegExp-prototype-toString-generic.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.RegExp-prototype-toString-generic.js: exception: " + e);
}
