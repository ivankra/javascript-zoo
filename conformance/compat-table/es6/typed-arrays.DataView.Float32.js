...
try {
  if (testCode()) {
    console.log("compat-table/es6/typed-arrays.DataView.Float32.js: OK");
  } else {
    console.log("compat-table/es6/typed-arrays.DataView.Float32.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/typed-arrays.DataView.Float32.js: exception: " + e);
}
