...
try {
  if (testCode()) {
    console.log("compat-table/es6/String.fromCodePoint.js: OK");
  } else {
    console.log("compat-table/es6/String.fromCodePoint.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/String.fromCodePoint.js: exception: " + e);
}
