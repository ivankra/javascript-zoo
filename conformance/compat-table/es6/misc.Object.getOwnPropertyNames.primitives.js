...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Object.getOwnPropertyNames.primitives.js: OK");
  } else {
    console.log("compat-table/es6/misc.Object.getOwnPropertyNames.primitives.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Object.getOwnPropertyNames.primitives.js: exception: " + e);
}
