...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.property-order.Reflect.ownKeys.symbol.js: OK");
  } else {
    console.log("compat-table/es6/misc.property-order.Reflect.ownKeys.symbol.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.property-order.Reflect.ownKeys.symbol.js: exception: " + e);
}
