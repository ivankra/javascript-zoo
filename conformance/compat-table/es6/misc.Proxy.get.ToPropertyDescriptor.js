...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.get.ToPropertyDescriptor.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.get.ToPropertyDescriptor.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.get.ToPropertyDescriptor.js: exception: " + e);
}
