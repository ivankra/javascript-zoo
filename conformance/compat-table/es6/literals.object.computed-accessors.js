...
try {
  if (testCode()) {
    console.log("compat-table/es6/literals.object.computed-accessors.js: OK");
  } else {
    console.log("compat-table/es6/literals.object.computed-accessors.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/literals.object.computed-accessors.js: exception: " + e);
}
