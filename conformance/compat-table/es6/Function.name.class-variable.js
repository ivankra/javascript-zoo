...
try {
  if (testCode()) {
    console.log("compat-table/es6/Function.name.class-variable.js: OK");
  } else {
    console.log("compat-table/es6/Function.name.class-variable.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Function.name.class-variable.js: exception: " + e);
}
