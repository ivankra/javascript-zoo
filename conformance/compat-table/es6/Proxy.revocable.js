...
try {
  if (testCode()) {
    console.log("compat-table/es6/Proxy.revocable.js: OK");
  } else {
    console.log("compat-table/es6/Proxy.revocable.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Proxy.revocable.js: exception: " + e);
}
