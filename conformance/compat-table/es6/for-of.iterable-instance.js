...
try {
  if (testCode()) {
    console.log("compat-table/es6/for-of.iterable-instance.js: OK");
  } else {
    console.log("compat-table/es6/for-of.iterable-instance.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/for-of.iterable-instance.js: exception: " + e);
}
