...
try {
  if (testCode()) {
    console.log("compat-table/es6/Array.from.iterator-closing.js: OK");
  } else {
    console.log("compat-table/es6/Array.from.iterator-closing.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Array.from.iterator-closing.js: exception: " + e);
}
