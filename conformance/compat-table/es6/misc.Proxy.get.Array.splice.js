...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.get.Array.splice.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.get.Array.splice.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.get.Array.splice.js: exception: " + e);
}
