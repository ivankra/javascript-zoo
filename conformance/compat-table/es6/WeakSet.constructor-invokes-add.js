...
try {
  if (testCode()) {
    console.log("compat-table/es6/WeakSet.constructor-invokes-add.js: OK");
  } else {
    console.log("compat-table/es6/WeakSet.constructor-invokes-add.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/WeakSet.constructor-invokes-add.js: exception: " + e);
}
