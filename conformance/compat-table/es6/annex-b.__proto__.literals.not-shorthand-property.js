...
try {
  if (testCode()) {
    console.log("compat-table/es6/annex-b.__proto__.literals.not-shorthand-property.js: OK");
  } else {
    console.log("compat-table/es6/annex-b.__proto__.literals.not-shorthand-property.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/annex-b.__proto__.literals.not-shorthand-property.js: exception: " + e);
}
