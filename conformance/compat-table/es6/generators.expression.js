...
try {
  if (testCode()) {
    console.log("compat-table/es6/generators.expression.js: OK");
  } else {
    console.log("compat-table/es6/generators.expression.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/generators.expression.js: exception: " + e);
}
