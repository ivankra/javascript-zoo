...
try {
  if (testCode()) {
    console.log("compat-table/es6/typed-arrays.DataView.Uint8.js: OK");
  } else {
    console.log("compat-table/es6/typed-arrays.DataView.Uint8.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/typed-arrays.DataView.Uint8.js: exception: " + e);
}
