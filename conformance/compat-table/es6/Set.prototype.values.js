...
try {
  if (testCode()) {
    console.log("compat-table/es6/Set.prototype.values.js: OK");
  } else {
    console.log("compat-table/es6/Set.prototype.values.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Set.prototype.values.js: exception: " + e);
}
