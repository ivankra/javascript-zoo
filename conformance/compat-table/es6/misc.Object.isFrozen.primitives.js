...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Object.isFrozen.primitives.js: OK");
  } else {
    console.log("compat-table/es6/misc.Object.isFrozen.primitives.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Object.isFrozen.primitives.js: exception: " + e);
}
