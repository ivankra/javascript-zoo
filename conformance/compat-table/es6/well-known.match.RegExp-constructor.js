...
try {
  if (testCode()) {
    console.log("compat-table/es6/well-known.match.RegExp-constructor.js: OK");
  } else {
    console.log("compat-table/es6/well-known.match.RegExp-constructor.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/well-known.match.RegExp-constructor.js: exception: " + e);
}
