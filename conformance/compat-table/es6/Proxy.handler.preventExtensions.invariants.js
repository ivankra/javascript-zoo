...
try {
  if (testCode()) {
    console.log("compat-table/es6/Proxy.handler.preventExtensions.invariants.js: OK");
  } else {
    console.log("compat-table/es6/Proxy.handler.preventExtensions.invariants.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Proxy.handler.preventExtensions.invariants.js: exception: " + e);
}
