...
try {
  if (testCode()) {
    console.log("compat-table/es6/default-params.arguments.js: OK");
  } else {
    console.log("compat-table/es6/default-params.arguments.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/default-params.arguments.js: exception: " + e);
}
