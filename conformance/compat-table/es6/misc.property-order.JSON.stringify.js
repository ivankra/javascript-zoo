...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.property-order.JSON.stringify.js: OK");
  } else {
    console.log("compat-table/es6/misc.property-order.JSON.stringify.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.property-order.JSON.stringify.js: exception: " + e);
}
