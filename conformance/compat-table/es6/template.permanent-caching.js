...
try {
  if (testCode()) {
    console.log("compat-table/es6/template.permanent-caching.js: OK");
  } else {
    console.log("compat-table/es6/template.permanent-caching.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/template.permanent-caching.js: exception: " + e);
}
