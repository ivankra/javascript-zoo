...
try {
  if (testCode()) {
    console.log("compat-table/es6/Proxy.handler.isExtensible.invariants.js: OK");
  } else {
    console.log("compat-table/es6/Proxy.handler.isExtensible.invariants.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Proxy.handler.isExtensible.invariants.js: exception: " + e);
}
