...
try {
  if (testCode()) {
    console.log("compat-table/es6/spread.generator-literal.js: OK");
  } else {
    console.log("compat-table/es6/spread.generator-literal.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/spread.generator-literal.js: exception: " + e);
}
