...
try {
  if (testCode()) {
    console.log("compat-table/es6/template.caching.js: OK");
  } else {
    console.log("compat-table/es6/template.caching.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/template.caching.js: exception: " + e);
}
