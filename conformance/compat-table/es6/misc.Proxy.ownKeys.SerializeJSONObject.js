// compat-table: ES6 > misc > Proxy, internal 'ownKeys' calls (tiny) > SerializeJSONObject
...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.ownKeys.SerializeJSONObject.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.ownKeys.SerializeJSONObject.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.ownKeys.SerializeJSONObject.js: exception: " + e);
}
