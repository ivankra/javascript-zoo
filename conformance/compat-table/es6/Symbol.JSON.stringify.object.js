...
try {
  if (testCode()) {
    console.log("compat-table/es6/Symbol.JSON.stringify.object.js: OK");
  } else {
    console.log("compat-table/es6/Symbol.JSON.stringify.object.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Symbol.JSON.stringify.object.js: exception: " + e);
}
