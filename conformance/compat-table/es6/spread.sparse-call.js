...
try {
  if (testCode()) {
    console.log("compat-table/es6/spread.sparse-call.js: OK");
  } else {
    console.log("compat-table/es6/spread.sparse-call.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/spread.sparse-call.js: exception: " + e);
}
