...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.ownKeys.TestIntegrityLevel.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.ownKeys.TestIntegrityLevel.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.ownKeys.TestIntegrityLevel.js: exception: " + e);
}
