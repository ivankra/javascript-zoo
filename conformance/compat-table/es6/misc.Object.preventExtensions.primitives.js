...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Object.preventExtensions.primitives.js: OK");
  } else {
    console.log("compat-table/es6/misc.Object.preventExtensions.primitives.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Object.preventExtensions.primitives.js: exception: " + e);
}
