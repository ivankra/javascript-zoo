...
try {
  if (testCode()) {
    console.log("compat-table/es6/Symbol.Object.js: OK");
  } else {
    console.log("compat-table/es6/Symbol.Object.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Symbol.Object.js: exception: " + e);
}
