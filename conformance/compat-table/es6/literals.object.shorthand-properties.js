...
try {
  if (testCode()) {
    console.log("compat-table/es6/literals.object.shorthand-properties.js: OK");
  } else {
    console.log("compat-table/es6/literals.object.shorthand-properties.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/literals.object.shorthand-properties.js: exception: " + e);
}
