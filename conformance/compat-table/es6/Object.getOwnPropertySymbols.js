...
try {
  if (testCode()) {
    console.log("compat-table/es6/Object.getOwnPropertySymbols.js: OK");
  } else {
    console.log("compat-table/es6/Object.getOwnPropertySymbols.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Object.getOwnPropertySymbols.js: exception: " + e);
}
