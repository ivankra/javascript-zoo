...
try {
  if (testCode()) {
    console.log("compat-table/es6/typed-arrays.from.js: OK");
  } else {
    console.log("compat-table/es6/typed-arrays.from.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/typed-arrays.from.js: exception: " + e);
}
