...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.getOwnPropertyDescriptor.Object.assign.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.getOwnPropertyDescriptor.Object.assign.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.getOwnPropertyDescriptor.Object.assign.js: exception: " + e);
}
