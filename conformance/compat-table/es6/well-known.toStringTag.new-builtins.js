...
try {
  if (testCode()) {
    console.log("compat-table/es6/well-known.toStringTag.new-builtins.js: OK");
  } else {
    console.log("compat-table/es6/well-known.toStringTag.new-builtins.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/well-known.toStringTag.new-builtins.js: exception: " + e);
}
