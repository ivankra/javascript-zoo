...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.prototypes-not-instances.js: OK");
  } else {
    console.log("compat-table/es6/misc.prototypes-not-instances.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.prototypes-not-instances.js: exception: " + e);
}
