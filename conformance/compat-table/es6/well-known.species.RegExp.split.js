...
try {
  if (testCode()) {
    console.log("compat-table/es6/well-known.species.RegExp.split.js: OK");
  } else {
    console.log("compat-table/es6/well-known.species.RegExp.split.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/well-known.species.RegExp.split.js: exception: " + e);
}
