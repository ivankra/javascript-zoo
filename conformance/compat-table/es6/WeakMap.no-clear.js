...
try {
  if (testCode()) {
    console.log("compat-table/es6/WeakMap.no-clear.js: OK");
  } else {
    console.log("compat-table/es6/WeakMap.no-clear.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/WeakMap.no-clear.js: exception: " + e);
}
