...
try {
  if (testCode()) {
    console.log("compat-table/es6/generators.yield-star.sparse-array.js: OK");
  } else {
    console.log("compat-table/es6/generators.yield-star.sparse-array.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/generators.yield-star.sparse-array.js: exception: " + e);
}
