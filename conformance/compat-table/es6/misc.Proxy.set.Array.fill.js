...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.set.Array.fill.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.set.Array.fill.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.set.Array.fill.js: exception: " + e);
}
