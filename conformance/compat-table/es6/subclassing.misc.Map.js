...
try {
  if (testCode()) {
    console.log("compat-table/es6/subclassing.misc.Map.js: OK");
  } else {
    console.log("compat-table/es6/subclassing.misc.Map.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/subclassing.misc.Map.js: exception: " + e);
}
