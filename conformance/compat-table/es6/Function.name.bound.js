...
try {
  if (testCode()) {
    console.log("compat-table/es6/Function.name.bound.js: OK");
  } else {
    console.log("compat-table/es6/Function.name.bound.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Function.name.bound.js: exception: " + e);
}
