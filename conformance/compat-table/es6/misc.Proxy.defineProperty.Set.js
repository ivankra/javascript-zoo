...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.defineProperty.Set.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.defineProperty.Set.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.defineProperty.Set.js: exception: " + e);
}
