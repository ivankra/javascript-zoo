...
try {
  if (testCode()) {
    console.log("compat-table/es6/Proxy.handler.setPrototypeOf.js: OK");
  } else {
    console.log("compat-table/es6/Proxy.handler.setPrototypeOf.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Proxy.handler.setPrototypeOf.js: exception: " + e);
}
