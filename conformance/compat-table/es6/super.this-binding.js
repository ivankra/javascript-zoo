...
try {
  if (testCode()) {
    console.log("compat-table/es6/super.this-binding.js: OK");
  } else {
    console.log("compat-table/es6/super.this-binding.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/super.this-binding.js: exception: " + e);
}
