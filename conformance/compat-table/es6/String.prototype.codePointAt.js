...
try {
  if (testCode()) {
    console.log("compat-table/es6/String.prototype.codePointAt.js: OK");
  } else {
    console.log("compat-table/es6/String.prototype.codePointAt.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/String.prototype.codePointAt.js: exception: " + e);
}
