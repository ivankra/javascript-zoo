...
try {
  if (testCode()) {
    console.log("compat-table/es6/regex.flags.y.js: OK");
  } else {
    console.log("compat-table/es6/regex.flags.y.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/regex.flags.y.js: exception: " + e);
}
