// compat-table: ES6 > syntax > spread syntax for iterable objects (large) > with generic iterables, in calls
...
try {
  if (testCode()) {
    console.log("compat-table/es6/spread.iterable-call.js: OK");
  } else {
    console.log("compat-table/es6/spread.iterable-call.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/spread.iterable-call.js: exception: " + e);
}
