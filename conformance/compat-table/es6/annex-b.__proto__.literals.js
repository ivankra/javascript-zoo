...
try {
  if (testCode()) {
    console.log("compat-table/es6/annex-b.__proto__.literals.js: OK");
  } else {
    console.log("compat-table/es6/annex-b.__proto__.literals.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/annex-b.__proto__.literals.js: exception: " + e);
}
