// compat-table: ES6 > misc > Proxy, internal 'set' calls (tiny) > Array.prototype.shift
...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.set.Array.shift.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.set.Array.shift.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.set.Array.shift.js: exception: " + e);
}
