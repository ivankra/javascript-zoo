...
try {
  if (testCode()) {
    console.log("compat-table/es6/well-known.unscopables.js: OK");
  } else {
    console.log("compat-table/es6/well-known.unscopables.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/well-known.unscopables.js: exception: " + e);
}
