...
try {
  if (testCode()) {
    console.log("compat-table/es6/WeakSet.prototype-not-instance.js: OK");
  } else {
    console.log("compat-table/es6/WeakSet.prototype-not-instance.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/WeakSet.prototype-not-instance.js: exception: " + e);
}
