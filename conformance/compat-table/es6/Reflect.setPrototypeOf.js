...
try {
  if (testCode()) {
    console.log("compat-table/es6/Reflect.setPrototypeOf.js: OK");
  } else {
    console.log("compat-table/es6/Reflect.setPrototypeOf.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Reflect.setPrototypeOf.js: exception: " + e);
}
