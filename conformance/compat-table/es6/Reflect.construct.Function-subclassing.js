...
try {
  if (testCode()) {
    console.log("compat-table/es6/Reflect.construct.Function-subclassing.js: OK");
  } else {
    console.log("compat-table/es6/Reflect.construct.Function-subclassing.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Reflect.construct.Function-subclassing.js: exception: " + e);
}
