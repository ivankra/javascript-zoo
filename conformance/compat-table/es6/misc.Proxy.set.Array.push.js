...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.set.Array.push.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.set.Array.push.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.set.Array.push.js: exception: " + e);
}
