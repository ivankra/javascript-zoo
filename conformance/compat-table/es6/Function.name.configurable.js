...
try {
  if (testCode()) {
    console.log("compat-table/es6/Function.name.configurable.js: OK");
  } else {
    console.log("compat-table/es6/Function.name.configurable.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Function.name.configurable.js: exception: " + e);
}
