...
try {
  if (testCode()) {
    console.log("compat-table/es6/WeakSet.accept-primitives.js: OK");
  } else {
    console.log("compat-table/es6/WeakSet.accept-primitives.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/WeakSet.accept-primitives.js: exception: " + e);
}
