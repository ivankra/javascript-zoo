...
try {
  if (testCode()) {
    console.log("compat-table/es6/Map.Symbol.species.js: OK");
  } else {
    console.log("compat-table/es6/Map.Symbol.species.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Map.Symbol.species.js: exception: " + e);
}
