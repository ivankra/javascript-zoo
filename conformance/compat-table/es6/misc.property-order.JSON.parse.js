...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.property-order.JSON.parse.js: OK");
  } else {
    console.log("compat-table/es6/misc.property-order.JSON.parse.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.property-order.JSON.parse.js: exception: " + e);
}
