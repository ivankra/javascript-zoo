...
try {
  if (testCode()) {
    console.log("compat-table/es6/Array.prototype.Symbol.unscopables.js: OK");
  } else {
    console.log("compat-table/es6/Array.prototype.Symbol.unscopables.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Array.prototype.Symbol.unscopables.js: exception: " + e);
}
