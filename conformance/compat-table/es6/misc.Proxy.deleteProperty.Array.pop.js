...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.deleteProperty.Array.pop.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.deleteProperty.Array.pop.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.deleteProperty.Array.pop.js: exception: " + e);
}
