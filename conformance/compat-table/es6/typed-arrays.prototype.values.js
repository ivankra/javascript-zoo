...
try {
  if (testCode()) {
    console.log("compat-table/es6/typed-arrays.prototype.values.js: OK");
  } else {
    console.log("compat-table/es6/typed-arrays.prototype.values.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/typed-arrays.prototype.values.js: exception: " + e);
}
