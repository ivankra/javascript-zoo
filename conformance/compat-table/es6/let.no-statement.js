...
try {
  if (testCode()) {
    console.log("compat-table/es6/let.no-statement.js: OK");
  } else {
    console.log("compat-table/es6/let.no-statement.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/let.no-statement.js: exception: " + e);
}
