...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.getOwnPropertyDescriptor.Object.hasOwnProperty.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.getOwnPropertyDescriptor.Object.hasOwnProperty.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.getOwnPropertyDescriptor.Object.hasOwnProperty.js: exception: " + e);
}
