...
try {
  if (testCode()) {
    console.log("compat-table/es6/Proxy.no-prototype.js: OK");
  } else {
    console.log("compat-table/es6/Proxy.no-prototype.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Proxy.no-prototype.js: exception: " + e);
}
