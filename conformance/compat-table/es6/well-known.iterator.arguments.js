...
try {
  if (testCode()) {
    console.log("compat-table/es6/well-known.iterator.arguments.js: OK");
  } else {
    console.log("compat-table/es6/well-known.iterator.arguments.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/well-known.iterator.arguments.js: exception: " + e);
}
