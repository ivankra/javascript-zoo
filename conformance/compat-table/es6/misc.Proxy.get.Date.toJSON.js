...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.get.Date.toJSON.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.get.Date.toJSON.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.get.Date.toJSON.js: exception: " + e);
}
