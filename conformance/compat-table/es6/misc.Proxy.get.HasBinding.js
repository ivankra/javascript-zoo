...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.get.HasBinding.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.get.HasBinding.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.get.HasBinding.js: exception: " + e);
}
