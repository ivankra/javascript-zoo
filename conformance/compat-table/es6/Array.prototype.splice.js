...
try {
  if (testCode()) {
    console.log("compat-table/es6/Array.prototype.splice.js: OK");
  } else {
    console.log("compat-table/es6/Array.prototype.splice.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Array.prototype.splice.js: exception: " + e);
}
