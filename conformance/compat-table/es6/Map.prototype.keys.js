...
try {
  if (testCode()) {
    console.log("compat-table/es6/Map.prototype.keys.js: OK");
  } else {
    console.log("compat-table/es6/Map.prototype.keys.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Map.prototype.keys.js: exception: " + e);
}
