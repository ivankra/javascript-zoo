...
try {
  if (testCode()) {
    console.log("compat-table/es6/Map.prototype.size.js: OK");
  } else {
    console.log("compat-table/es6/Map.prototype.size.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Map.prototype.size.js: exception: " + e);
}
