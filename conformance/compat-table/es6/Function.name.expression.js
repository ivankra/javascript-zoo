...
try {
  if (testCode()) {
    console.log("compat-table/es6/Function.name.expression.js: OK");
  } else {
    console.log("compat-table/es6/Function.name.expression.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Function.name.expression.js: exception: " + e);
}
