...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.get.String.split.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.get.String.split.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.get.String.split.js: exception: " + e);
}
