...
try {
  if (testCode()) {
    console.log("compat-table/es6/Reflect.construct.Array-subclassing.js: OK");
  } else {
    console.log("compat-table/es6/Reflect.construct.Array-subclassing.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Reflect.construct.Array-subclassing.js: exception: " + e);
}
