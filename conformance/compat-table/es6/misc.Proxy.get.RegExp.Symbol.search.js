...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.get.RegExp.Symbol.search.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.get.RegExp.Symbol.search.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.get.RegExp.Symbol.search.js: exception: " + e);
}
