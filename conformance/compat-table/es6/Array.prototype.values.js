...
try {
  if (testCode()) {
    console.log("compat-table/es6/Array.prototype.values.js: OK");
  } else {
    console.log("compat-table/es6/Array.prototype.values.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Array.prototype.values.js: exception: " + e);
}
