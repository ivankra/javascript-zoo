...
try {
  if (testCode()) {
    console.log("compat-table/es6/typed-arrays.Float64Array.js: OK");
  } else {
    console.log("compat-table/es6/typed-arrays.Float64Array.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/typed-arrays.Float64Array.js: exception: " + e);
}
