...
try {
  if (testCode()) {
    console.log("compat-table/es6/destructuring-decl.generator.js: OK");
  } else {
    console.log("compat-table/es6/destructuring-decl.generator.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/destructuring-decl.generator.js: exception: " + e);
}
