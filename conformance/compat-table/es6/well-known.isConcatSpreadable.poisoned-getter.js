...
try {
  if (testCode()) {
    console.log("compat-table/es6/well-known.isConcatSpreadable.poisoned-getter.js: OK");
  } else {
    console.log("compat-table/es6/well-known.isConcatSpreadable.poisoned-getter.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/well-known.isConcatSpreadable.poisoned-getter.js: exception: " + e);
}
