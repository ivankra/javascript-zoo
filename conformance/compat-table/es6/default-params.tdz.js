...
try {
  if (testCode()) {
    console.log("compat-table/es6/default-params.tdz.js: OK");
  } else {
    console.log("compat-table/es6/default-params.tdz.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/default-params.tdz.js: exception: " + e);
}
