...
try {
  if (testCode()) {
    console.log("compat-table/es6/Number.isFinite.js: OK");
  } else {
    console.log("compat-table/es6/Number.isFinite.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Number.isFinite.js: exception: " + e);
}
