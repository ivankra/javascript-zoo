...
try {
  if (testCode()) {
    console.log("compat-table/es6/Number.MAX_SAFE_INTEGER.js: OK");
  } else {
    console.log("compat-table/es6/Number.MAX_SAFE_INTEGER.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Number.MAX_SAFE_INTEGER.js: exception: " + e);
}
