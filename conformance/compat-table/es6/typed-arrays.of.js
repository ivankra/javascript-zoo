...
try {
  if (testCode()) {
    console.log("compat-table/es6/typed-arrays.of.js: OK");
  } else {
    console.log("compat-table/es6/typed-arrays.of.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/typed-arrays.of.js: exception: " + e);
}
