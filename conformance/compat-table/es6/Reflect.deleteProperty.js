...
try {
  if (testCode()) {
    console.log("compat-table/es6/Reflect.deleteProperty.js: OK");
  } else {
    console.log("compat-table/es6/Reflect.deleteProperty.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Reflect.deleteProperty.js: exception: " + e);
}
