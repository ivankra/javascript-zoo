...
try {
  if (testCode()) {
    console.log("compat-table/es6/arrow.lexical-super.constructor.js: OK");
  } else {
    console.log("compat-table/es6/arrow.lexical-super.constructor.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/arrow.lexical-super.constructor.js: exception: " + e);
}
