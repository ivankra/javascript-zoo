...
try {
  if (testCode()) {
    console.log("compat-table/es6/annex-b.__proto__.literals.not-shorthand-method.js: OK");
  } else {
    console.log("compat-table/es6/annex-b.__proto__.literals.not-shorthand-method.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/annex-b.__proto__.literals.not-shorthand-method.js: exception: " + e);
}
