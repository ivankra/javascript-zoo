...
try {
  if (testCode()) {
    console.log("compat-table/es6/WeakSet.constructor-accepts-null.js: OK");
  } else {
    console.log("compat-table/es6/WeakSet.constructor-accepts-null.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/WeakSet.constructor-accepts-null.js: exception: " + e);
}
