...
try {
  if (testCode()) {
    console.log("compat-table/es6/Proxy.handler.isExtensible.js: OK");
  } else {
    console.log("compat-table/es6/Proxy.handler.isExtensible.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Proxy.handler.isExtensible.js: exception: " + e);
}
