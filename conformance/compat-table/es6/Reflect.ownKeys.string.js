...
try {
  if (testCode()) {
    console.log("compat-table/es6/Reflect.ownKeys.string.js: OK");
  } else {
    console.log("compat-table/es6/Reflect.ownKeys.string.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/Reflect.ownKeys.string.js: exception: " + e);
}
