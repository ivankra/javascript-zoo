...
try {
  if (testCode()) {
    console.log("compat-table/es6/misc.Proxy.defineProperty.SetIntegrityLevel.js: OK");
  } else {
    console.log("compat-table/es6/misc.Proxy.defineProperty.SetIntegrityLevel.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/misc.Proxy.defineProperty.SetIntegrityLevel.js: exception: " + e);
}
