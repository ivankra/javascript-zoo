...
try {
  if (testCode()) {
    console.log("compat-table/es6/typed-arrays.prototype.some.js: OK");
  } else {
    console.log("compat-table/es6/typed-arrays.prototype.some.js: failed");
  }
} catch (e) {
  console.log("compat-table/es6/typed-arrays.prototype.some.js: exception: " + e);
}
