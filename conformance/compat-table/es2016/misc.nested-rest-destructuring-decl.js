...
try {
  if (testCode()) {
    console.log("compat-table/es2016/misc.nested-rest-destructuring-decl.js: OK");
  } else {
    console.log("compat-table/es2016/misc.nested-rest-destructuring-decl.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2016/misc.nested-rest-destructuring-decl.js: exception: " + e);
}
