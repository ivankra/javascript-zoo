...
try {
  if (testCode()) {
    console.log("compat-table/es2016/misc.generator-no-new.js: OK");
  } else {
    console.log("compat-table/es2016/misc.generator-no-new.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2016/misc.generator-no-new.js: exception: " + e);
}
