...
try {
  if (testCode()) {
    console.log("compat-table/es2016/exponentiation.unary-negation-error.js: OK");
  } else {
    console.log("compat-table/es2016/exponentiation.unary-negation-error.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2016/exponentiation.unary-negation-error.js: exception: " + e);
}
