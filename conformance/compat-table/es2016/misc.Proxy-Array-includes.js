...
try {
  if (testCode()) {
    console.log("compat-table/es2016/misc.Proxy-Array-includes.js: OK");
  } else {
    console.log("compat-table/es2016/misc.Proxy-Array-includes.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2016/misc.Proxy-Array-includes.js: exception: " + e);
}
