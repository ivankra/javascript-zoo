...
try {
  if (testCode()) {
    console.log("compat-table/es2016/Array.prototype.includes.typed-array.js: OK");
  } else {
    console.log("compat-table/es2016/Array.prototype.includes.typed-array.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2016/Array.prototype.includes.typed-array.js: exception: " + e);
}
