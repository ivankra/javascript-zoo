...
try {
  if (testCode()) {
    console.log("compat-table/es2016/misc.Proxy-enumerate-removed.js: OK");
  } else {
    console.log("compat-table/es2016/misc.Proxy-enumerate-removed.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2016/misc.Proxy-enumerate-removed.js: exception: " + e);
}
