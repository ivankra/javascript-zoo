...
try {
  if (testCode()) {
    console.log("compat-table/es2016/misc.generator-throw-inner.js: OK");
  } else {
    console.log("compat-table/es2016/misc.generator-throw-inner.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2016/misc.generator-throw-inner.js: exception: " + e);
}
