...
try {
  if (testCode()) {
    console.log("compat-table/es2016/exponentiation.basic.js: OK");
  } else {
    console.log("compat-table/es2016/exponentiation.basic.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2016/exponentiation.basic.js: exception: " + e);
}
