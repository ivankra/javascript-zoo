...
try {
  if (testCode()) {
    console.log("compat-table/es2016/Array.prototype.includes.js: OK");
  } else {
    console.log("compat-table/es2016/Array.prototype.includes.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2016/Array.prototype.includes.js: exception: " + e);
}
