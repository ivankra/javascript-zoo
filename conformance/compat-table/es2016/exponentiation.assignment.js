...
try {
  if (testCode()) {
    console.log("compat-table/es2016/exponentiation.assignment.js: OK");
  } else {
    console.log("compat-table/es2016/exponentiation.assignment.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2016/exponentiation.assignment.js: exception: " + e);
}
