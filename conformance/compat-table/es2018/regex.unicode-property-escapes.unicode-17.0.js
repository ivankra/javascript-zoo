...
try {
  if (testCode()) {
    console.log("compat-table/es2018/regex.unicode-property-escapes.unicode-17.0.js: OK");
  } else {
    console.log("compat-table/es2018/regex.unicode-property-escapes.unicode-17.0.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2018/regex.unicode-property-escapes.unicode-17.0.js: exception: " + e);
}
