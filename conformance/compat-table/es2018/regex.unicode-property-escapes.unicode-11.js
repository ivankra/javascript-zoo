...
try {
  if (testCode()) {
    console.log("compat-table/es2018/regex.unicode-property-escapes.unicode-11.js: OK");
  } else {
    console.log("compat-table/es2018/regex.unicode-property-escapes.unicode-11.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2018/regex.unicode-property-escapes.unicode-11.js: exception: " + e);
}
