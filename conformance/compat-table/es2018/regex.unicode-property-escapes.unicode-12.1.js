...
try {
  if (testCode()) {
    console.log("compat-table/es2018/regex.unicode-property-escapes.unicode-12.1.js: OK");
  } else {
    console.log("compat-table/es2018/regex.unicode-property-escapes.unicode-12.1.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2018/regex.unicode-property-escapes.unicode-12.1.js: exception: " + e);
}
