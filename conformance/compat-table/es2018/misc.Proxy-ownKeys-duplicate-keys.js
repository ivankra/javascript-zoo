...
try {
  if (testCode()) {
    console.log("compat-table/es2018/misc.Proxy-ownKeys-duplicate-keys.js: OK");
  } else {
    console.log("compat-table/es2018/misc.Proxy-ownKeys-duplicate-keys.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2018/misc.Proxy-ownKeys-duplicate-keys.js: exception: " + e);
}
