...
try {
  if (testCode()) {
    console.log("compat-table/es2018/regex.unicode-property-escapes.unicode-13.js: OK");
  } else {
    console.log("compat-table/es2018/regex.unicode-property-escapes.unicode-13.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2018/regex.unicode-property-escapes.unicode-13.js: exception: " + e);
}
