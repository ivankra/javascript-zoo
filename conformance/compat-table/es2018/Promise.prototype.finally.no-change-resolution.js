...
function asyncTestPassed() {
  console.log("compat-table/es2018/Promise.prototype.finally.no-change-resolution.js: OK");
}
...
try {
  ...
  console.log("compat-table/es2018/Promise.prototype.finally.no-change-resolution.js: exception: " + e);
}
