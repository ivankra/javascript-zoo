...
try {
  if (testCode()) {
    console.log("compat-table/es2018/misc.template-literal-revision.js: OK");
  } else {
    console.log("compat-table/es2018/misc.template-literal-revision.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2018/misc.template-literal-revision.js: exception: " + e);
}
