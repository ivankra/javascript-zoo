...
try {
  if (testCode()) {
    console.log("compat-table/es2018/regex.named-capture-groups.js: OK");
  } else {
    console.log("compat-table/es2018/regex.named-capture-groups.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2018/regex.named-capture-groups.js: exception: " + e);
}
