...
try {
  if (testCode()) {
    console.log("compat-table/es2018/object-spread.js: OK");
  } else {
    console.log("compat-table/es2018/object-spread.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2018/object-spread.js: exception: " + e);
}
