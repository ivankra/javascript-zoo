...
try {
  if (testCode()) {
    console.log("compat-table/es2018/object-rest.js: OK");
  } else {
    console.log("compat-table/es2018/object-rest.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2018/object-rest.js: exception: " + e);
}
