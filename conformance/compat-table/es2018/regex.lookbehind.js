...
try {
  if (testCode()) {
    console.log("compat-table/es2018/regex.lookbehind.js: OK");
  } else {
    console.log("compat-table/es2018/regex.lookbehind.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2018/regex.lookbehind.js: exception: " + e);
}
