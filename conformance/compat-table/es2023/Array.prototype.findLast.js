...
try {
  if (testCode()) {
    console.log("compat-table/es2023/Array.prototype.findLast.js: OK");
  } else {
    console.log("compat-table/es2023/Array.prototype.findLast.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2023/Array.prototype.findLast.js: exception: " + e);
}
