...
try {
  if (testCode()) {
    console.log("compat-table/es2023/Array.prototype.findLastIndex.js: OK");
  } else {
    console.log("compat-table/es2023/Array.prototype.findLastIndex.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2023/Array.prototype.findLastIndex.js: exception: " + e);
}
