...
try {
  if (testCode()) {
    console.log("compat-table/es2023/TypedArray.prototype.toSorted.js: OK");
  } else {
    console.log("compat-table/es2023/TypedArray.prototype.toSorted.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2023/TypedArray.prototype.toSorted.js: exception: " + e);
}
