...
try {
  if (testCode()) {
    console.log("compat-table/es2023/Array.prototype.toReversed.js: OK");
  } else {
    console.log("compat-table/es2023/Array.prototype.toReversed.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2023/Array.prototype.toReversed.js: exception: " + e);
}
