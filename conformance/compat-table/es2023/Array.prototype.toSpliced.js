...
try {
  if (testCode()) {
    console.log("compat-table/es2023/Array.prototype.toSpliced.js: OK");
  } else {
    console.log("compat-table/es2023/Array.prototype.toSpliced.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2023/Array.prototype.toSpliced.js: exception: " + e);
}
