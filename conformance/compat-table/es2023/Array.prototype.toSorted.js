...
try {
  if (testCode()) {
    console.log("compat-table/es2023/Array.prototype.toSorted.js: OK");
  } else {
    console.log("compat-table/es2023/Array.prototype.toSorted.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2023/Array.prototype.toSorted.js: exception: " + e);
}
