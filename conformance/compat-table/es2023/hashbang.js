...
try {
  if (testCode()) {
    console.log("compat-table/es2023/hashbang.js: OK");
  } else {
    console.log("compat-table/es2023/hashbang.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2023/hashbang.js: exception: " + e);
}
