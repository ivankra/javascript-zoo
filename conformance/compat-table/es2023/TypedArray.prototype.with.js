...
try {
  if (testCode()) {
    console.log("compat-table/es2023/TypedArray.prototype.with.js: OK");
  } else {
    console.log("compat-table/es2023/TypedArray.prototype.with.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2023/TypedArray.prototype.with.js: exception: " + e);
}
