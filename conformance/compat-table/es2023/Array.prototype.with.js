...
try {
  if (testCode()) {
    console.log("compat-table/es2023/Array.prototype.with.js: OK");
  } else {
    console.log("compat-table/es2023/Array.prototype.with.js: failed");
  }
} catch (e) {
  console.log("compat-table/es2023/Array.prototype.with.js: exception: " + e);
}
