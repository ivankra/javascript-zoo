...
try {
  if (testCode()) {
    console.log("kangax-es6/spread.iterable-instance-literal.js: OK");
  } else {
    console.log("kangax-es6/spread.iterable-instance-literal.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/spread.iterable-instance-literal.js: exception: " + e);
}
