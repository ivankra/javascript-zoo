...
try {
  if (testCode()) {
    console.log("kangax-es6/misc.Proxy.get.RegExp.Symbol.search.js: OK");
  } else {
    console.log("kangax-es6/misc.Proxy.get.RegExp.Symbol.search.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/misc.Proxy.get.RegExp.Symbol.search.js: exception: " + e);
}
