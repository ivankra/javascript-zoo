...
try {
  if (testCode()) {
    console.log("kangax-es6/Proxy.handler.get.js: OK");
  } else {
    console.log("kangax-es6/Proxy.handler.get.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/Proxy.handler.get.js: exception: " + e);
}
