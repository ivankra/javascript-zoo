...
try {
  if (testCode()) {
    console.log("kangax-es6/generators.yield-star.generator.js: OK");
  } else {
    console.log("kangax-es6/generators.yield-star.generator.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/generators.yield-star.generator.js: exception: " + e);
}
