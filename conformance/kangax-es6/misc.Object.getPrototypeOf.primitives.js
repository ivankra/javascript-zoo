...
try {
  if (testCode()) {
    console.log("kangax-es6/misc.Object.getPrototypeOf.primitives.js: OK");
  } else {
    console.log("kangax-es6/misc.Object.getPrototypeOf.primitives.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/misc.Object.getPrototypeOf.primitives.js: exception: " + e);
}
