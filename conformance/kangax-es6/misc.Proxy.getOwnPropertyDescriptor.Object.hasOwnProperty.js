...
try {
  if (testCode()) {
    console.log("kangax-es6/misc.Proxy.getOwnPropertyDescriptor.Object.hasOwnProperty.js: OK");
  } else {
    console.log("kangax-es6/misc.Proxy.getOwnPropertyDescriptor.Object.hasOwnProperty.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/misc.Proxy.getOwnPropertyDescriptor.Object.hasOwnProperty.js: exception: " + e);
}
