...
try {
  if (testCode()) {
    console.log("kangax-es6/misc.Proxy.set.Array.shift.js: OK");
  } else {
    console.log("kangax-es6/misc.Proxy.set.Array.shift.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/misc.Proxy.set.Array.shift.js: exception: " + e);
}
