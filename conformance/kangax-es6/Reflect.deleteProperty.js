...
try {
  if (testCode()) {
    console.log("kangax-es6/Reflect.deleteProperty.js: OK");
  } else {
    console.log("kangax-es6/Reflect.deleteProperty.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/Reflect.deleteProperty.js: exception: " + e);
}
