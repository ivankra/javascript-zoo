...
try {
  if (testCode()) {
    console.log("kangax-es6/Array.from.array-like.js: OK");
  } else {
    console.log("kangax-es6/Array.from.array-like.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/Array.from.array-like.js: exception: " + e);
}
