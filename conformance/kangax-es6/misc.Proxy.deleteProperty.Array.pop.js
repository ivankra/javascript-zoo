...
try {
  if (testCode()) {
    console.log("kangax-es6/misc.Proxy.deleteProperty.Array.pop.js: OK");
  } else {
    console.log("kangax-es6/misc.Proxy.deleteProperty.Array.pop.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/misc.Proxy.deleteProperty.Array.pop.js: exception: " + e);
}
