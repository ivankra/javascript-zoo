...
try {
  if (testCode()) {
    console.log("kangax-es6/misc.Proxy.get.String.replace.js: OK");
  } else {
    console.log("kangax-es6/misc.Proxy.get.String.replace.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/misc.Proxy.get.String.replace.js: exception: " + e);
}
