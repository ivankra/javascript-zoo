...
try {
  if (testCode()) {
    console.log("kangax-es6/misc.Proxy.get.String.match.js: OK");
  } else {
    console.log("kangax-es6/misc.Proxy.get.String.match.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/misc.Proxy.get.String.match.js: exception: " + e);
}
