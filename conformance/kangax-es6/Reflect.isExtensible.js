...
try {
  if (testCode()) {
    console.log("kangax-es6/Reflect.isExtensible.js: OK");
  } else {
    console.log("kangax-es6/Reflect.isExtensible.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/Reflect.isExtensible.js: exception: " + e);
}
