...
try {
  if (testCode()) {
    console.log("kangax-es6/misc.Proxy.get.RegExp.Symbol.match.js: OK");
  } else {
    console.log("kangax-es6/misc.Proxy.get.RegExp.Symbol.match.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/misc.Proxy.get.RegExp.Symbol.match.js: exception: " + e);
}
