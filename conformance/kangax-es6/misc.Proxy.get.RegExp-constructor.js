...
try {
  if (testCode()) {
    console.log("kangax-es6/misc.Proxy.get.RegExp-constructor.js: OK");
  } else {
    console.log("kangax-es6/misc.Proxy.get.RegExp-constructor.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/misc.Proxy.get.RegExp-constructor.js: exception: " + e);
}
