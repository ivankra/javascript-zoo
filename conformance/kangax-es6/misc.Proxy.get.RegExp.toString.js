...
try {
  if (testCode()) {
    console.log("kangax-es6/misc.Proxy.get.RegExp.toString.js: OK");
  } else {
    console.log("kangax-es6/misc.Proxy.get.RegExp.toString.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/misc.Proxy.get.RegExp.toString.js: exception: " + e);
}
