...
try {
  if (testCode()) {
    console.log("kangax-es6/typed-arrays.prototype.copyWithin.js: OK");
  } else {
    console.log("kangax-es6/typed-arrays.prototype.copyWithin.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/typed-arrays.prototype.copyWithin.js: exception: " + e);
}
