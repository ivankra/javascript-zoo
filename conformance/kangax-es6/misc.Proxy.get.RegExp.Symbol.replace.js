...
try {
  if (testCode()) {
    console.log("kangax-es6/misc.Proxy.get.RegExp.Symbol.replace.js: OK");
  } else {
    console.log("kangax-es6/misc.Proxy.get.RegExp.Symbol.replace.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/misc.Proxy.get.RegExp.Symbol.replace.js: exception: " + e);
}
