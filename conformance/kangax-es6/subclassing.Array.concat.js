...
try {
  if (testCode()) {
    console.log("kangax-es6/subclassing.Array.concat.js: OK");
  } else {
    console.log("kangax-es6/subclassing.Array.concat.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/subclassing.Array.concat.js: exception: " + e);
}
