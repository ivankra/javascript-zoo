...
try {
  if (testCode()) {
    console.log("kangax-es6/misc.Proxy.get.Date.toJSON.js: OK");
  } else {
    console.log("kangax-es6/misc.Proxy.get.Date.toJSON.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/misc.Proxy.get.Date.toJSON.js: exception: " + e);
}
