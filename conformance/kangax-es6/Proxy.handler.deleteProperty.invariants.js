...
try {
  if (testCode()) {
    console.log("kangax-es6/Proxy.handler.deleteProperty.invariants.js: OK");
  } else {
    console.log("kangax-es6/Proxy.handler.deleteProperty.invariants.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/Proxy.handler.deleteProperty.invariants.js: exception: " + e);
}
