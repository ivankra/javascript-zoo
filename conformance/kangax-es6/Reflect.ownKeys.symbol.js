...
try {
  if (testCode()) {
    console.log("kangax-es6/Reflect.ownKeys.symbol.js: OK");
  } else {
    console.log("kangax-es6/Reflect.ownKeys.symbol.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/Reflect.ownKeys.symbol.js: exception: " + e);
}
