...
try {
  if (testCode()) {
    console.log("kangax-es6/Proxy.handler.ownKeys.js: OK");
  } else {
    console.log("kangax-es6/Proxy.handler.ownKeys.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/Proxy.handler.ownKeys.js: exception: " + e);
}
