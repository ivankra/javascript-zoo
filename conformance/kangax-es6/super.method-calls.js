...
try {
  if (testCode()) {
    console.log("kangax-es6/super.method-calls.js: OK");
  } else {
    console.log("kangax-es6/super.method-calls.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/super.method-calls.js: exception: " + e);
}
