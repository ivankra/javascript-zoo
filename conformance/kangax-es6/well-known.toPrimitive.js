...
try {
  if (testCode()) {
    console.log("kangax-es6/well-known.toPrimitive.js: OK");
  } else {
    console.log("kangax-es6/well-known.toPrimitive.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/well-known.toPrimitive.js: exception: " + e);
}
