...
try {
  if (testCode()) {
    console.log("kangax-es6/misc.Object.freeze.primitives.js: OK");
  } else {
    console.log("kangax-es6/misc.Object.freeze.primitives.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/misc.Object.freeze.primitives.js: exception: " + e);
}
