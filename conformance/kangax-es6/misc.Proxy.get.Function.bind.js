...
try {
  if (testCode()) {
    console.log("kangax-es6/misc.Proxy.get.Function.bind.js: OK");
  } else {
    console.log("kangax-es6/misc.Proxy.get.Function.bind.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/misc.Proxy.get.Function.bind.js: exception: " + e);
}
