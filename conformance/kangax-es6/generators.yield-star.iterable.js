...
try {
  if (testCode()) {
    console.log("kangax-es6/generators.yield-star.iterable.js: OK");
  } else {
    console.log("kangax-es6/generators.yield-star.iterable.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/generators.yield-star.iterable.js: exception: " + e);
}
