...
try {
  if (testCode()) {
    console.log("kangax-es6/let.for-in-shadow.js: OK");
  } else {
    console.log("kangax-es6/let.for-in-shadow.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/let.for-in-shadow.js: exception: " + e);
}
