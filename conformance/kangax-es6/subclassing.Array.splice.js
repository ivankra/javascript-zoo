...
try {
  if (testCode()) {
    console.log("kangax-es6/subclassing.Array.splice.js: OK");
  } else {
    console.log("kangax-es6/subclassing.Array.splice.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/subclassing.Array.splice.js: exception: " + e);
}
