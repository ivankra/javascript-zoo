...
try {
  if (testCode()) {
    console.log("kangax-es6/Array.from.iterator-closing.js: OK");
  } else {
    console.log("kangax-es6/Array.from.iterator-closing.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/Array.from.iterator-closing.js: exception: " + e);
}
