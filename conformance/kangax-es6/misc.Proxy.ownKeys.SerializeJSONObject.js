...
try {
  if (testCode()) {
    console.log("kangax-es6/misc.Proxy.ownKeys.SerializeJSONObject.js: OK");
  } else {
    console.log("kangax-es6/misc.Proxy.ownKeys.SerializeJSONObject.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/misc.Proxy.ownKeys.SerializeJSONObject.js: exception: " + e);
}
