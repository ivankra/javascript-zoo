...
try {
  if (testCode()) {
    console.log("kangax-es6/misc.Proxy.get.instanceof.js: OK");
  } else {
    console.log("kangax-es6/misc.Proxy.get.instanceof.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/misc.Proxy.get.instanceof.js: exception: " + e);
}
