...
try {
  if (testCode()) {
    console.log("kangax-es6/typed-arrays.DataView.Float32.js: OK");
  } else {
    console.log("kangax-es6/typed-arrays.DataView.Float32.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/typed-arrays.DataView.Float32.js: exception: " + e);
}
