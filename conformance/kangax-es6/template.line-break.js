...
try {
  if (testCode()) {
    console.log("kangax-es6/template.line-break.js: OK");
  } else {
    console.log("kangax-es6/template.line-break.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/template.line-break.js: exception: " + e);
}
