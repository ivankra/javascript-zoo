...
try {
  if (testCode()) {
    console.log("kangax-es6/spread.sparse-call.js: OK");
  } else {
    console.log("kangax-es6/spread.sparse-call.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/spread.sparse-call.js: exception: " + e);
}
