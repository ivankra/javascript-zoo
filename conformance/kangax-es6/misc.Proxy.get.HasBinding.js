...
try {
  if (testCode()) {
    console.log("kangax-es6/misc.Proxy.get.HasBinding.js: OK");
  } else {
    console.log("kangax-es6/misc.Proxy.get.HasBinding.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/misc.Proxy.get.HasBinding.js: exception: " + e);
}
