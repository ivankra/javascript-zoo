...
try {
  if (testCode()) {
    console.log("kangax-es6/destructuring-decl.generator.js: OK");
  } else {
    console.log("kangax-es6/destructuring-decl.generator.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/destructuring-decl.generator.js: exception: " + e);
}
