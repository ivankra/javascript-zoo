...
try {
  if (testCode()) {
    console.log("kangax-es6/Function.name.class-statement.js: OK");
  } else {
    console.log("kangax-es6/Function.name.class-statement.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/Function.name.class-statement.js: exception: " + e);
}
