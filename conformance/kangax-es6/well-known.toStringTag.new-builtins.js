...
try {
  if (testCode()) {
    console.log("kangax-es6/well-known.toStringTag.new-builtins.js: OK");
  } else {
    console.log("kangax-es6/well-known.toStringTag.new-builtins.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/well-known.toStringTag.new-builtins.js: exception: " + e);
}
