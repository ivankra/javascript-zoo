...
try {
  if (testCode()) {
    console.log("kangax-es6/Proxy.handler.set.invariants.js: OK");
  } else {
    console.log("kangax-es6/Proxy.handler.set.invariants.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/Proxy.handler.set.invariants.js: exception: " + e);
}
