...
try {
  if (testCode()) {
    console.log("kangax-es6/RegExp.prototype.Symbol.split.js: OK");
  } else {
    console.log("kangax-es6/RegExp.prototype.Symbol.split.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/RegExp.prototype.Symbol.split.js: exception: " + e);
}
