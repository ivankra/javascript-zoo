...
try {
  if (testCode()) {
    console.log("kangax-es6/WeakSet.iterator-closing.js: OK");
  } else {
    console.log("kangax-es6/WeakSet.iterator-closing.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/WeakSet.iterator-closing.js: exception: " + e);
}
