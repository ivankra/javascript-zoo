...
try {
  if (testCode()) {
    console.log("kangax-es6/spread.iterable-call.js: OK");
  } else {
    console.log("kangax-es6/spread.iterable-call.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/spread.iterable-call.js: exception: " + e);
}
