...
try {
  if (testCode()) {
    console.log("kangax-es6/well-known.species.Promise.then.js: OK");
  } else {
    console.log("kangax-es6/well-known.species.Promise.then.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/well-known.species.Promise.then.js: exception: " + e);
}
