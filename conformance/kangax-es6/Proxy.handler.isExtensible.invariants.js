...
try {
  if (testCode()) {
    console.log("kangax-es6/Proxy.handler.isExtensible.invariants.js: OK");
  } else {
    console.log("kangax-es6/Proxy.handler.isExtensible.invariants.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/Proxy.handler.isExtensible.invariants.js: exception: " + e);
}
