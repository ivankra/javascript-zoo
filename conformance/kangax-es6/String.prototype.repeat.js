...
try {
  if (testCode()) {
    console.log("kangax-es6/String.prototype.repeat.js: OK");
  } else {
    console.log("kangax-es6/String.prototype.repeat.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/String.prototype.repeat.js: exception: " + e);
}
