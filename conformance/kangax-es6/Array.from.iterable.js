...
try {
  if (testCode()) {
    console.log("kangax-es6/Array.from.iterable.js: OK");
  } else {
    console.log("kangax-es6/Array.from.iterable.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/Array.from.iterable.js: exception: " + e);
}
