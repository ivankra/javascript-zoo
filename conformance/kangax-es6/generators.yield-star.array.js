...
try {
  if (testCode()) {
    console.log("kangax-es6/generators.yield-star.array.js: OK");
  } else {
    console.log("kangax-es6/generators.yield-star.array.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/generators.yield-star.array.js: exception: " + e);
}
