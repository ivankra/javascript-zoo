...
try {
  if (testCode()) {
    console.log("kangax-es6/typed-arrays.prototype.map.js: OK");
  } else {
    console.log("kangax-es6/typed-arrays.prototype.map.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/typed-arrays.prototype.map.js: exception: " + e);
}
