...
try {
  if (testCode()) {
    console.log("kangax-es6/typed-arrays.Uint8Array.js: OK");
  } else {
    console.log("kangax-es6/typed-arrays.Uint8Array.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/typed-arrays.Uint8Array.js: exception: " + e);
}
