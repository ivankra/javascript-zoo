...
try {
  if (testCode()) {
    console.log("kangax-es6/misc.Proxy.get.String.split.js: OK");
  } else {
    console.log("kangax-es6/misc.Proxy.get.String.split.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/misc.Proxy.get.String.split.js: exception: " + e);
}
