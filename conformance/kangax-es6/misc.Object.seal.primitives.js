...
try {
  if (testCode()) {
    console.log("kangax-es6/misc.Object.seal.primitives.js: OK");
  } else {
    console.log("kangax-es6/misc.Object.seal.primitives.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/misc.Object.seal.primitives.js: exception: " + e);
}
