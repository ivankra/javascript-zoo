...
try {
  if (testCode()) {
    console.log("kangax-es6/Set.Symbol.species.js: OK");
  } else {
    console.log("kangax-es6/Set.Symbol.species.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/Set.Symbol.species.js: exception: " + e);
}
