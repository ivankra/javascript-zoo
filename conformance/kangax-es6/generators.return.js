...
try {
  if (testCode()) {
    console.log("kangax-es6/generators.return.js: OK");
  } else {
    console.log("kangax-es6/generators.return.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/generators.return.js: exception: " + e);
}
