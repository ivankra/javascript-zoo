...
try {
  if (testCode()) {
    console.log("kangax-es6/Map.prototype.entries.js: OK");
  } else {
    console.log("kangax-es6/Map.prototype.entries.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/Map.prototype.entries.js: exception: " + e);
}
