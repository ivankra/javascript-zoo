...
try {
  if (testCode()) {
    console.log("kangax-es6/typed-arrays.prototype.reduceRight.js: OK");
  } else {
    console.log("kangax-es6/typed-arrays.prototype.reduceRight.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/typed-arrays.prototype.reduceRight.js: exception: " + e);
}
