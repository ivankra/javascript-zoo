...
try {
  if (testCode()) {
    console.log("kangax-es6/Function.name.new-Function.js: OK");
  } else {
    console.log("kangax-es6/Function.name.new-Function.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/Function.name.new-Function.js: exception: " + e);
}
