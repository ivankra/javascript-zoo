...
try {
  if (testCode()) {
    console.log("kangax-es6/generators.expression.js: OK");
  } else {
    console.log("kangax-es6/generators.expression.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/generators.expression.js: exception: " + e);
}
