...
try {
  if (testCode()) {
    console.log("kangax-es6/regex.flags.u.codepoint.js: OK");
  } else {
    console.log("kangax-es6/regex.flags.u.codepoint.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/regex.flags.u.codepoint.js: exception: " + e);
}
