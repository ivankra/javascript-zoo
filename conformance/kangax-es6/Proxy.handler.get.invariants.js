...
try {
  if (testCode()) {
    console.log("kangax-es6/Proxy.handler.get.invariants.js: OK");
  } else {
    console.log("kangax-es6/Proxy.handler.get.invariants.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/Proxy.handler.get.invariants.js: exception: " + e);
}
