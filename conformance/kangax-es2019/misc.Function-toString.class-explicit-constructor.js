...
try {
  if (testCode()) {
    console.log("kangax-es2019/misc.Function-toString.class-explicit-constructor.js: OK");
  } else {
    console.log("kangax-es2019/misc.Function-toString.class-explicit-constructor.js: failed");
  }
} catch (e) {
  console.log("kangax-es2019/misc.Function-toString.class-explicit-constructor.js: exception: " + e);
}
