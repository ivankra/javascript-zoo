...
try {
  if (testCode()) {
    console.log("kangax-es5/Object.getOwnPropertyDescriptor.js: OK");
  } else {
    console.log("kangax-es5/Object.getOwnPropertyDescriptor.js: failed");
  }
} catch (e) {
  console.log("kangax-es5/Object.getOwnPropertyDescriptor.js: exception: " + e);
}
