...
try {
  if (testCode()) {
    console.log("kangax-es5/Date.prototype.toJSON.js: OK");
  } else {
    console.log("kangax-es5/Date.prototype.toJSON.js: failed");
  }
} catch (e) {
  console.log("kangax-es5/Date.prototype.toJSON.js: exception: " + e);
}
