...
try {
  if (testCode()) {
    console.log("kangax-es2022/at-method.String.js: OK");
  } else {
    console.log("kangax-es2022/at-method.String.js: failed");
  }
} catch (e) {
  console.log("kangax-es2022/at-method.String.js: exception: " + e);
}
