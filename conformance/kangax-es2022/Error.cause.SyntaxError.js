...
try {
  if (testCode()) {
    console.log("kangax-es2022/Error.cause.SyntaxError.js: OK");
  } else {
    console.log("kangax-es2022/Error.cause.SyntaxError.js: failed");
  }
} catch (e) {
  console.log("kangax-es2022/Error.cause.SyntaxError.js: exception: " + e);
}
