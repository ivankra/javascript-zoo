...
try {
  if (testCode()) {
    console.log("kangax-es2022/Error.cause.EvalError.js: OK");
  } else {
    console.log("kangax-es2022/Error.cause.EvalError.js: failed");
  }
} catch (e) {
  console.log("kangax-es2022/Error.cause.EvalError.js: exception: " + e);
}
