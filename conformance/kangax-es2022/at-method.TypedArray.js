...
try {
  if (testCode()) {
    console.log("kangax-es2022/at-method.TypedArray.js: OK");
  } else {
    console.log("kangax-es2022/at-method.TypedArray.js: failed");
  }
} catch (e) {
  console.log("kangax-es2022/at-method.TypedArray.js: exception: " + e);
}
