...
try {
  if (testCode()) {
    console.log("kangax-es2025/Iterator.prototype.forEach.js: OK");
  } else {
    console.log("kangax-es2025/Iterator.prototype.forEach.js: failed");
  }
} catch (e) {
  console.log("kangax-es2025/Iterator.prototype.forEach.js: exception: " + e);
}
