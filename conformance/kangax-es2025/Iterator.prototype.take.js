...
try {
  if (testCode()) {
    console.log("kangax-es2025/Iterator.prototype.take.js: OK");
  } else {
    console.log("kangax-es2025/Iterator.prototype.take.js: failed");
  }
} catch (e) {
  console.log("kangax-es2025/Iterator.prototype.take.js: exception: " + e);
}
