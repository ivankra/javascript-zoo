...
try {
  if (testCode()) {
    console.log("kangax-es2025/Set.prototype.intersection.js: OK");
  } else {
    console.log("kangax-es2025/Set.prototype.intersection.js: failed");
  }
} catch (e) {
  console.log("kangax-es2025/Set.prototype.intersection.js: exception: " + e);
}
