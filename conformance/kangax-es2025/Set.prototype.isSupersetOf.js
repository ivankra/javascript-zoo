...
try {
  if (testCode()) {
    console.log("kangax-es2025/Set.prototype.isSupersetOf.js: OK");
  } else {
    console.log("kangax-es2025/Set.prototype.isSupersetOf.js: failed");
  }
} catch (e) {
  console.log("kangax-es2025/Set.prototype.isSupersetOf.js: exception: " + e);
}
