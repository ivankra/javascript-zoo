...
try {
  if (testCode()) {
    console.log("kangax-es2017/annex-b.Proxy.__lookupSetter__.js: OK");
  } else {
    console.log("kangax-es2017/annex-b.Proxy.__lookupSetter__.js: failed");
  }
} catch (e) {
  console.log("kangax-es2017/annex-b.Proxy.__lookupSetter__.js: exception: " + e);
}
