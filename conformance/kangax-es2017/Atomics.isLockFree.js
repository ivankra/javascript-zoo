...
try {
  if (testCode()) {
    console.log("kangax-es2017/Atomics.isLockFree.js: OK");
  } else {
    console.log("kangax-es2017/Atomics.isLockFree.js: failed");
  }
} catch (e) {
  console.log("kangax-es2017/Atomics.isLockFree.js: exception: " + e);
}
