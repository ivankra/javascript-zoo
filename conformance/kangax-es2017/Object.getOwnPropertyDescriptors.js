...
try {
  if (testCode()) {
    console.log("kangax-es2017/Object.getOwnPropertyDescriptors.js: OK");
  } else {
    console.log("kangax-es2017/Object.getOwnPropertyDescriptors.js: failed");
  }
} catch (e) {
  console.log("kangax-es2017/Object.getOwnPropertyDescriptors.js: exception: " + e);
}
