...
try {
  if (testCode()) {
    console.log("kangax-es2020/String.prototype.matchAll.js: OK");
  } else {
    console.log("kangax-es2020/String.prototype.matchAll.js: failed");
  }
} catch (e) {
  console.log("kangax-es2020/String.prototype.matchAll.js: exception: " + e);
}
