...
try {
  if (testCode()) {
    console.log("kangax-es2020/optional-chaining.spread-params.js: OK");
  } else {
    console.log("kangax-es2020/optional-chaining.spread-params.js: failed");
  }
} catch (e) {
  console.log("kangax-es2020/optional-chaining.spread-params.js: exception: " + e);
}
