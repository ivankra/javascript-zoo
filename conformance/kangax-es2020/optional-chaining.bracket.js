...
try {
  if (testCode()) {
    console.log("kangax-es2020/optional-chaining.bracket.js: OK");
  } else {
    console.log("kangax-es2020/optional-chaining.bracket.js: failed");
  }
} catch (e) {
  console.log("kangax-es2020/optional-chaining.bracket.js: exception: " + e);
}
