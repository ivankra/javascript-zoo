...
if (res == null) {
  ...
  console.log("es1/asi.js: failed: return<LF>");
}
...
if (res == 106) {
  ...
  console.log("es1/asi.js: failed: a<LF> ++<LF> b");
}
...
if (h3.arg == 7) {
  ...
  console.log("es1/asi.js: failed: a = b + c<LF> (d + e).print()");
}
...
if (res == null) {
  ...
  console.log("es1/asi.js: failed: a<LF> [idx]");
}
