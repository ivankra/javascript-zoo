...
// ESnext: https://262.ecma-international.org/#sec-literals-string-literals
//
...
if ("\101" == "A" && "\141" == "a") {
  console.log("es1/annex-b.literals.string.octal.js: OK");
} else {
  console.log("es1/annex-b.literals.string.octal.js: failed");
}
