...
try {
  if (testCode()) {
    console.log("kangax-intl/Intl.DateTimeFormat.rejects-invalid-tags.js: OK");
  } else {
    console.log("kangax-intl/Intl.DateTimeFormat.rejects-invalid-tags.js: failed");
  }
} catch (e) {
  console.log("kangax-intl/Intl.DateTimeFormat.rejects-invalid-tags.js: exception: " + e);
}
