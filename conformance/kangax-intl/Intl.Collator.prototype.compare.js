...
try {
  if (testCode()) {
    console.log("kangax-intl/Intl.Collator.prototype.compare.js: OK");
  } else {
    console.log("kangax-intl/Intl.Collator.prototype.compare.js: failed");
  }
} catch (e) {
  console.log("kangax-intl/Intl.Collator.prototype.compare.js: exception: " + e);
}
