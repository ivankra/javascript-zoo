...
try {
  if (testCode()) {
    console.log("kangax-intl/Array.prototype.toLocaleString.js: OK");
  } else {
    console.log("kangax-intl/Array.prototype.toLocaleString.js: failed");
  }
} catch (e) {
  console.log("kangax-intl/Array.prototype.toLocaleString.js: exception: " + e);
}
