...
try {
  if (testCode()) {
    console.log("kangax-es2021/logical-assignment.or.js: OK");
  } else {
    console.log("kangax-es2021/logical-assignment.or.js: failed");
  }
} catch (e) {
  console.log("kangax-es2021/logical-assignment.or.js: exception: " + e);
}
