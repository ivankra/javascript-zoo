...
class EngineConfig:
    ...
    def load(path_or_cmd: str, *, config_name: str | None = None) -> EngineConfig:
        """Resolve binary, load sidecar build_metadata, merge with configs JSON.
        ...
        #  * configs.jsonnet[default] (lowest-priority defaults)
        #  * configs.jsonnet[engine]
        #  * configs.jsonnet[engine_variant]
