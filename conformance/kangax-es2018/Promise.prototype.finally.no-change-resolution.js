...
function asyncTestPassed() {
  console.log("kangax-es2018/Promise.prototype.finally.no-change-resolution.js: OK");
}
...
try {
  ...
  console.log("kangax-es2018/Promise.prototype.finally.no-change-resolution.js: exception: " + e);
}
