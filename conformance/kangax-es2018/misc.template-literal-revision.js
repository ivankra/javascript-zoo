...
try {
  if (testCode()) {
    console.log("kangax-es2018/misc.template-literal-revision.js: OK");
  } else {
    console.log("kangax-es2018/misc.template-literal-revision.js: failed");
  }
} catch (e) {
  console.log("kangax-es2018/misc.template-literal-revision.js: exception: " + e);
}
