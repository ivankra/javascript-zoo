...
[Esprima](../esprima/README.md)-compatible parser from ESLint.
Currently just a thin layer on top of [Acorn](../acorn/README.md) parser.
...
* Standard:   ESnext
* Years:      2014-
* Ancestor:   [Esprima](../esprima/README.md), [Acorn](../acorn/README.md)
* Features:   ESTree, JSX
...
With Espree 2.0.0 release, it's now built on top of [Acorn](../acorn/README.md)
