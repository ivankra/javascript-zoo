...
to [Acorn](../acorn/README.md) and its derivatives. [Espree](../espree/README.md) is a modern
...
* [ESLint](https://eslint.org/): static code analysis tool.
  Originally used Esprima, later switched to its own [Espree](../espree/README.md) parser.
* [Continuum](../../engines/continuum/README.md) engine (2012-2014)
