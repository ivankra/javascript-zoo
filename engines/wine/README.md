...
<li>ES1: 94%<pre>
<a href="../../conformance/es1/Array.js">Array.js</a>: timeout: &gt;10s
<a href="../../conformance/es1/Array.prototype.constructor.js">Array.prototype.constructor.js</a>: timeout: &gt;10s
...
<a href="../../conformance/es1/conversions.ToString.js">conversions.ToString.js</a>: 1e21 failed; 1e-7 failed
<a href="../../conformance/es1/numbers.double.js">numbers.double.js</a>: converting max safe integer + 1 to string
</pre></li>
<li>ES3: 84%<pre>
...
<a href="../../conformance/es3/Number.prototype.toExponential.rounding.js">Number.prototype.toExponential.rounding.js</a>: (25).toExponential(0) != '3e+1' (got: '2.5e+1'); (1.255).toExponential(2) != '1.25e+0', got '1.26e+0'
...
<a href="../../conformance/es3/String.prototype.localeCompare.js">String.prototype.localeCompare.js</a>: &lt;unknown&gt;
<a href="../../conformance/es3/String.prototype.replace.capture.js">String.prototype.replace.capture.js</a>: timeout: &gt;10s
...
<a href="../../conformance/es3/String.prototype.split.regex.js">String.prototype.split.regex.js</a>: split with regex failed; split with capturing group failed
<a href="../../conformance/es3/annex-b.String.prototype.substr.js">annex-b.String.prototype.substr.js</a>: negative start failed; negative start with length failed
<a href="../../conformance/es3/global.ReferenceError.thrown.js">global.ReferenceError.thrown.js</a>: wrong exception for undeclared variable; wrong exception for undeclared function; no exception for undeclared in expression; wrong exception for property access on undeclared
<a href="../../conformance/es3/global.URIError.thrown.js">global.URIError.thrown.js</a>: wrong exception for decodeURIComponent incomplete escape; wrong exception for decodeURIComponent invalid hex
