// Prelude for test262 for node

var node_vm = require('vm');
var node_workerThreads = require('worker_threads');
...
var $262 = {
  ...
  createRealm() {
    var ctx = node_vm.createContext({ console, require, print });
    node_vm.runInContext($SOURCE, ctx);
    return ctx.$262;
  },

  evalScript(code) {
    return node_vm.runInThisContext(code);
  },
