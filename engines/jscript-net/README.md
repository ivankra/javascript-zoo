...
Microsoft's JavaScript engine for .NET Framework 1.0-4.x from the early 2000s / ES4 era.
...
Completely different product from [JScript](../jscript/README.md) and [JScript9](../jscript9/README.md)/Chakra,
but using the same name. .NET suffix was dropped at some point.

Version numbers follow Microsoft's finest traditions:

  * JScript 5.x -> IE3-8's [JScript](../jscript/README.md) engine (unrelated)
  ...
  * JScript 9, 11 -> IE9-11's [JScript9](../jscript9/README.md) aka Chakra, Chakra Edge, [ChakraCore](../chakracore/README.md) engines (unrelated)
...
Implements a very distinct JavaScript dialect for the .NET platform, featuring types
