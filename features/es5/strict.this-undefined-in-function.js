...
var result = (function() {
  ...
  if (this !== undefined) {
    console.log("es5/strict.this-undefined-in-function.js: failed: outer 'this' is not undefined");
    return false;
  }

  var inner = (function() { return this === undefined; }).call();
  if (!inner) {
    console.log("es5/strict.this-undefined-in-function.js: failed: inner 'this' is not undefined");
    return false;
  }
