...
try {
  if (testCode()) {
    console.log("kangax-es2020/BigUint64Array.js: OK");
  } else {
    console.log("kangax-es2020/BigUint64Array.js: failed");
  }
} catch (e) {
  console.log("kangax-es2020/BigUint64Array.js: exception: " + e);
}
