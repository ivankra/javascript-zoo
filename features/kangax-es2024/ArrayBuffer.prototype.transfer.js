...
try {
  if (testCode()) {
    console.log("kangax-es2024/ArrayBuffer.prototype.transfer.js: OK");
  } else {
    console.log("kangax-es2024/ArrayBuffer.prototype.transfer.js: failed");
  }
} catch (e) {
  console.log("kangax-es2024/ArrayBuffer.prototype.transfer.js: exception: " + e);
}
