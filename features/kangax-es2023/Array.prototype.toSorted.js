...
try {
  if (testCode()) {
    console.log("kangax-es2023/Array.prototype.toSorted.js: OK");
  } else {
    console.log("kangax-es2023/Array.prototype.toSorted.js: failed");
  }
} catch (e) {
  console.log("kangax-es2023/Array.prototype.toSorted.js: exception: " + e);
}
