...
try {
  if (testCode()) {
    console.log("kangax-es2022/regex.flags.d.shows-in-flags.js: OK");
  } else {
    console.log("kangax-es2022/regex.flags.d.shows-in-flags.js: failed");
  }
} catch (e) {
  console.log("kangax-es2022/regex.flags.d.shows-in-flags.js: exception: " + e);
}
