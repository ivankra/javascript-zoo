...
try {
  if (testCode()) {
    console.log("kangax-es2022/at-method.Array.js: OK");
  } else {
    console.log("kangax-es2022/at-method.Array.js: failed");
  }
} catch (e) {
  console.log("kangax-es2022/at-method.Array.js: exception: " + e);
}
