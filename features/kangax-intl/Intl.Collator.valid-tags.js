...
try {
  if (testCode()) {
    console.log("kangax-intl/Intl.Collator.valid-tags.js: OK");
  } else {
    console.log("kangax-intl/Intl.Collator.valid-tags.js: failed");
  }
} catch (e) {
  console.log("kangax-intl/Intl.Collator.valid-tags.js: exception: " + e);
}
