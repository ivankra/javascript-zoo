...
try {
  if (testCode()) {
    console.log("kangax-es2017/annex-b.Object.prototype.__lookupGetter__.js: OK");
  } else {
    console.log("kangax-es2017/annex-b.Object.prototype.__lookupGetter__.js: failed");
  }
} catch (e) {
  console.log("kangax-es2017/annex-b.Object.prototype.__lookupGetter__.js: exception: " + e);
}
