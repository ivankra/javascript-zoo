...
try {
  if (testCode()) {
    console.log("kangax-es2016/Array.prototype.includes.typed-array.js: OK");
  } else {
    console.log("kangax-es2016/Array.prototype.includes.typed-array.js: failed");
  }
} catch (e) {
  console.log("kangax-es2016/Array.prototype.includes.typed-array.js: exception: " + e);
}
