...
try {
  if (testCode()) {
    console.log("kangax-es5/strict.assignment-non-writable-error.js: OK");
  } else {
    console.log("kangax-es5/strict.assignment-non-writable-error.js: failed");
  }
} catch (e) {
  console.log("kangax-es5/strict.assignment-non-writable-error.js: exception: " + e);
}
