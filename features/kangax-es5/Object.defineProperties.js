...
try {
  if (testCode()) {
    console.log("kangax-es5/Object.defineProperties.js: OK");
  } else {
    console.log("kangax-es5/Object.defineProperties.js: failed");
  }
} catch (e) {
  console.log("kangax-es5/Object.defineProperties.js: exception: " + e);
}
