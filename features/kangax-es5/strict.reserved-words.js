...
try {
  if (testCode()) {
    console.log("kangax-es5/strict.reserved-words.js: OK");
  } else {
    console.log("kangax-es5/strict.reserved-words.js: failed");
  }
} catch (e) {
  console.log("kangax-es5/strict.reserved-words.js: exception: " + e);
}
