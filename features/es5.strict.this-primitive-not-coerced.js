...
var result = (function() {
  ...
  if (!stringThis) {
    console.log("es5.strict.this-primitive-not-coerced.js: FAIL - string 'this' was coerced to object");
    return false;
  }

  var numberThis = (function() { return typeof this === 'number'; }).call(1);
  if (!numberThis) {
    console.log("es5.strict.this-primitive-not-coerced.js: FAIL - number 'this' was coerced to object");
    return false;
  }

  var booleanThis = (function() { return typeof this === 'boolean'; }).call(true);
  if (!booleanThis) {
    console.log("es5.strict.this-primitive-not-coerced.js: FAIL - boolean 'this' was coerced to object");
    return false;
  }
