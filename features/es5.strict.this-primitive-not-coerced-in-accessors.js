...
var result = (function() {
  ...
  if (!test(String, '')) {
    console.log("es5.strict.this-primitive-not-coerced-in-accessors.js: FAIL - string 'this' was coerced in accessor");
    return false;
  }

  if (!test(Number, 1)) {
    console.log("es5.strict.this-primitive-not-coerced-in-accessors.js: FAIL - number 'this' was coerced in accessor");
    return false;
  }

  if (!test(Boolean, true)) {
    console.log("es5.strict.this-primitive-not-coerced-in-accessors.js: FAIL - boolean 'this' was coerced in accessor");
    return false;
  }
