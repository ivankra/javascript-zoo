...
try {
  if (testCode()) {
    console.log("kangax-es6/misc.Proxy.get.Array.reverse.js: OK");
  } else {
    console.log("kangax-es6/misc.Proxy.get.Array.reverse.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/misc.Proxy.get.Array.reverse.js: exception: " + e);
}
