...
try {
  if (testCode()) {
    console.log("kangax-es6/annex-b.function.if-statement.js: OK");
  } else {
    console.log("kangax-es6/annex-b.function.if-statement.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/annex-b.function.if-statement.js: exception: " + e);
}
