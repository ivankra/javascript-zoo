...
try {
  if (testCode()) {
    console.log("kangax-es6/misc.Proxy.get.RegExp.flags.js: OK");
  } else {
    console.log("kangax-es6/misc.Proxy.get.RegExp.flags.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/misc.Proxy.get.RegExp.flags.js: exception: " + e);
}
