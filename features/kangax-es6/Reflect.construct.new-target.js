...
try {
  if (testCode()) {
    console.log("kangax-es6/Reflect.construct.new-target.js: OK");
  } else {
    console.log("kangax-es6/Reflect.construct.new-target.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/Reflect.construct.new-target.js: exception: " + e);
}
