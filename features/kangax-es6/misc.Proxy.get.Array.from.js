...
try {
  if (testCode()) {
    console.log("kangax-es6/misc.Proxy.get.Array.from.js: OK");
  } else {
    console.log("kangax-es6/misc.Proxy.get.Array.from.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/misc.Proxy.get.Array.from.js: exception: " + e);
}
