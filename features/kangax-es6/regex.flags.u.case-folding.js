...
try {
  if (testCode()) {
    console.log("kangax-es6/regex.flags.u.case-folding.js: OK");
  } else {
    console.log("kangax-es6/regex.flags.u.case-folding.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/regex.flags.u.case-folding.js: exception: " + e);
}
