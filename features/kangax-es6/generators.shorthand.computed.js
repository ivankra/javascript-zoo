...
try {
  if (testCode()) {
    console.log("kangax-es6/generators.shorthand.computed.js: OK");
  } else {
    console.log("kangax-es6/generators.shorthand.computed.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/generators.shorthand.computed.js: exception: " + e);
}
