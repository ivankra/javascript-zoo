...
try {
  if (testCode()) {
    console.log("kangax-es6/typed-arrays.DataView.Uint16.js: OK");
  } else {
    console.log("kangax-es6/typed-arrays.DataView.Uint16.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/typed-arrays.DataView.Uint16.js: exception: " + e);
}
