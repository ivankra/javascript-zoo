...
try {
  if (testCode()) {
    console.log("kangax-es6/misc.Proxy.get.Object.defineProperties.js: OK");
  } else {
    console.log("kangax-es6/misc.Proxy.get.Object.defineProperties.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/misc.Proxy.get.Object.defineProperties.js: exception: " + e);
}
