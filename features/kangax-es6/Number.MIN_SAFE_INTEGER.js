...
try {
  if (testCode()) {
    console.log("kangax-es6/Number.MIN_SAFE_INTEGER.js: OK");
  } else {
    console.log("kangax-es6/Number.MIN_SAFE_INTEGER.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/Number.MIN_SAFE_INTEGER.js: exception: " + e);
}
