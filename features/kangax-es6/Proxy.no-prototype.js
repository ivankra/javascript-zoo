...
try {
  if (testCode()) {
    console.log("kangax-es6/Proxy.no-prototype.js: OK");
  } else {
    console.log("kangax-es6/Proxy.no-prototype.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/Proxy.no-prototype.js: exception: " + e);
}
