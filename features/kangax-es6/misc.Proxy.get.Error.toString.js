...
try {
  if (testCode()) {
    console.log("kangax-es6/misc.Proxy.get.Error.toString.js: OK");
  } else {
    console.log("kangax-es6/misc.Proxy.get.Error.toString.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/misc.Proxy.get.Error.toString.js: exception: " + e);
}
