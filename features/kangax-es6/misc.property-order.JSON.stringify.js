...
try {
  if (testCode()) {
    console.log("kangax-es6/misc.property-order.JSON.stringify.js: OK");
  } else {
    console.log("kangax-es6/misc.property-order.JSON.stringify.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/misc.property-order.JSON.stringify.js: exception: " + e);
}
