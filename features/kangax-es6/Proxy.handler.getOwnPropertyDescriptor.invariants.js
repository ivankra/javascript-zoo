...
try {
  if (testCode()) {
    console.log("kangax-es6/Proxy.handler.getOwnPropertyDescriptor.invariants.js: OK");
  } else {
    console.log("kangax-es6/Proxy.handler.getOwnPropertyDescriptor.invariants.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/Proxy.handler.getOwnPropertyDescriptor.invariants.js: exception: " + e);
}
