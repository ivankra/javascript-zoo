...
try {
  if (testCode()) {
    console.log("kangax-es6/well-known.species.Array.filter.js: OK");
  } else {
    console.log("kangax-es6/well-known.species.Array.filter.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/well-known.species.Array.filter.js: exception: " + e);
}
