...
try {
  if (testCode()) {
    console.log("kangax-es6/typed-arrays.prototype.some.js: OK");
  } else {
    console.log("kangax-es6/typed-arrays.prototype.some.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/typed-arrays.prototype.some.js: exception: " + e);
}
