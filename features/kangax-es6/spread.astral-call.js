...
try {
  if (testCode()) {
    console.log("kangax-es6/spread.astral-call.js: OK");
  } else {
    console.log("kangax-es6/spread.astral-call.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/spread.astral-call.js: exception: " + e);
}
