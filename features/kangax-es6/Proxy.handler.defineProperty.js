...
try {
  if (testCode()) {
    console.log("kangax-es6/Proxy.handler.defineProperty.js: OK");
  } else {
    console.log("kangax-es6/Proxy.handler.defineProperty.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/Proxy.handler.defineProperty.js: exception: " + e);
}
