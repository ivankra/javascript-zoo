...
try {
  if (testCode()) {
    console.log("kangax-es6/generators.yield-star.iterator-closing-throw.js: OK");
  } else {
    console.log("kangax-es6/generators.yield-star.iterator-closing-throw.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/generators.yield-star.iterator-closing-throw.js: exception: " + e);
}
