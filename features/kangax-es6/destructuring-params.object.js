...
try {
  if (testCode()) {
    console.log("kangax-es6/destructuring-params.object.js: OK");
  } else {
    console.log("kangax-es6/destructuring-params.object.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/destructuring-params.object.js: exception: " + e);
}
