...
try {
  if (testCode()) {
    console.log("kangax-es6/spread.iterable-instance-call.js: OK");
  } else {
    console.log("kangax-es6/spread.iterable-instance-call.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/spread.iterable-instance-call.js: exception: " + e);
}
