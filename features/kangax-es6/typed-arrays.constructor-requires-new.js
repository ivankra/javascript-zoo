...
try {
  if (testCode()) {
    console.log("kangax-es6/typed-arrays.constructor-requires-new.js: OK");
  } else {
    console.log("kangax-es6/typed-arrays.constructor-requires-new.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/typed-arrays.constructor-requires-new.js: exception: " + e);
}
