...
try {
  if (testCode()) {
    console.log("kangax-es6/misc.Proxy.get.ToPrimitive.js: OK");
  } else {
    console.log("kangax-es6/misc.Proxy.get.ToPrimitive.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/misc.Proxy.get.ToPrimitive.js: exception: " + e);
}
