...
try {
  if (testCode()) {
    console.log("kangax-es6/annex-b.String.prototype.html.quotes-escaped.js: OK");
  } else {
    console.log("kangax-es6/annex-b.String.prototype.html.quotes-escaped.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/annex-b.String.prototype.html.quotes-escaped.js: exception: " + e);
}
