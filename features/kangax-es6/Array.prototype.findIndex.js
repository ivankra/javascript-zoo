...
try {
  if (testCode()) {
    console.log("kangax-es6/Array.prototype.findIndex.js: OK");
  } else {
    console.log("kangax-es6/Array.prototype.findIndex.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/Array.prototype.findIndex.js: exception: " + e);
}
