...
try {
  if (testCode()) {
    console.log("kangax-es6/misc.Proxy.get.JSON.stringify.js: OK");
  } else {
    console.log("kangax-es6/misc.Proxy.get.JSON.stringify.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/misc.Proxy.get.JSON.stringify.js: exception: " + e);
}
