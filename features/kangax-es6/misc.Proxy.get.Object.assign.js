...
try {
  if (testCode()) {
    console.log("kangax-es6/misc.Proxy.get.Object.assign.js: OK");
  } else {
    console.log("kangax-es6/misc.Proxy.get.Object.assign.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/misc.Proxy.get.Object.assign.js: exception: " + e);
}
