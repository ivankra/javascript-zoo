...
try {
  if (testCode()) {
    console.log("kangax-es6/Array.iterator-prototype-chain.js: OK");
  } else {
    console.log("kangax-es6/Array.iterator-prototype-chain.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/Array.iterator-prototype-chain.js: exception: " + e);
}
