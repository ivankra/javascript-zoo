...
try {
  if (testCode()) {
    console.log("kangax-es6/misc.Object.getOwnPropertyNames.primitives.js: OK");
  } else {
    console.log("kangax-es6/misc.Object.getOwnPropertyNames.primitives.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/misc.Object.getOwnPropertyNames.primitives.js: exception: " + e);
}
