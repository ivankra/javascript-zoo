...
try {
  if (testCode()) {
    console.log("kangax-es6/Array.prototype.Symbol.unscopables.js: OK");
  } else {
    console.log("kangax-es6/Array.prototype.Symbol.unscopables.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/Array.prototype.Symbol.unscopables.js: exception: " + e);
}
