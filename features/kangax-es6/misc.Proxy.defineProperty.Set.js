...
try {
  if (testCode()) {
    console.log("kangax-es6/misc.Proxy.defineProperty.Set.js: OK");
  } else {
    console.log("kangax-es6/misc.Proxy.defineProperty.Set.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/misc.Proxy.defineProperty.Set.js: exception: " + e);
}
