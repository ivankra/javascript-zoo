...
try {
  if (testCode()) {
    console.log("kangax-es6/template.escape-sequences.js: OK");
  } else {
    console.log("kangax-es6/template.escape-sequences.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/template.escape-sequences.js: exception: " + e);
}
