...
try {
  if (testCode()) {
    console.log("kangax-es6/subclassing.Array.from.js: OK");
  } else {
    console.log("kangax-es6/subclassing.Array.from.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/subclassing.Array.from.js: exception: " + e);
}
