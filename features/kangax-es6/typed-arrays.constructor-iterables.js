...
try {
  if (testCode()) {
    console.log("kangax-es6/typed-arrays.constructor-iterables.js: OK");
  } else {
    console.log("kangax-es6/typed-arrays.constructor-iterables.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/typed-arrays.constructor-iterables.js: exception: " + e);
}
