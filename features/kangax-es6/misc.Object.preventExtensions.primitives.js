...
try {
  if (testCode()) {
    console.log("kangax-es6/misc.Object.preventExtensions.primitives.js: OK");
  } else {
    console.log("kangax-es6/misc.Object.preventExtensions.primitives.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/misc.Object.preventExtensions.primitives.js: exception: " + e);
}
