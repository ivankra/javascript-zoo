...
try {
  if (testCode()) {
    console.log("kangax-es6/default-params.basic.js: OK");
  } else {
    console.log("kangax-es6/default-params.basic.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/default-params.basic.js: exception: " + e);
}
