...
try {
  if (testCode()) {
    console.log("kangax-es6/typed-arrays.prototype.fill.js: OK");
  } else {
    console.log("kangax-es6/typed-arrays.prototype.fill.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/typed-arrays.prototype.fill.js: exception: " + e);
}
