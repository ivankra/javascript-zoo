...
try {
  if (testCode()) {
    console.log("kangax-es6/misc.Proxy.get.ToPropertyDescriptor.js: OK");
  } else {
    console.log("kangax-es6/misc.Proxy.get.ToPropertyDescriptor.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/misc.Proxy.get.ToPropertyDescriptor.js: exception: " + e);
}
