...
try {
  if (testCode()) {
    console.log("kangax-es6/destructuring-assign.defaults.js: OK");
  } else {
    console.log("kangax-es6/destructuring-assign.defaults.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/destructuring-assign.defaults.js: exception: " + e);
}
