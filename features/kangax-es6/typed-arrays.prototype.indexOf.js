...
try {
  if (testCode()) {
    console.log("kangax-es6/typed-arrays.prototype.indexOf.js: OK");
  } else {
    console.log("kangax-es6/typed-arrays.prototype.indexOf.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/typed-arrays.prototype.indexOf.js: exception: " + e);
}
