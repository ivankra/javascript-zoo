...
try {
  if (testCode()) {
    console.log("kangax-es6/const.no-statement.js: OK");
  } else {
    console.log("kangax-es6/const.no-statement.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/const.no-statement.js: exception: " + e);
}
