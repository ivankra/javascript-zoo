...
try {
  if (testCode()) {
    console.log("kangax-es6/misc.property-order.JSON.parse.js: OK");
  } else {
    console.log("kangax-es6/misc.property-order.JSON.parse.js: failed");
  }
} catch (e) {
  console.log("kangax-es6/misc.property-order.JSON.parse.js: exception: " + e);
}
