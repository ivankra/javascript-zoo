...
try {
  if (testCode()) {
    console.log("kangax-es2018/misc.Proxy-ownKeys-duplicate-keys.js: OK");
  } else {
    console.log("kangax-es2018/misc.Proxy-ownKeys-duplicate-keys.js: failed");
  }
} catch (e) {
  console.log("kangax-es2018/misc.Proxy-ownKeys-duplicate-keys.js: exception: " + e);
}
