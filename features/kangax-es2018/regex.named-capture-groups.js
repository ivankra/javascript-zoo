...
try {
  if (testCode()) {
    console.log("kangax-es2018/regex.named-capture-groups.js: OK");
  } else {
    console.log("kangax-es2018/regex.named-capture-groups.js: failed");
  }
} catch (e) {
  console.log("kangax-es2018/regex.named-capture-groups.js: exception: " + e);
}
