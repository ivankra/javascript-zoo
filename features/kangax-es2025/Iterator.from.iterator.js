...
try {
  if (testCode()) {
    console.log("kangax-es2025/Iterator.from.iterator.js: OK");
  } else {
    console.log("kangax-es2025/Iterator.from.iterator.js: failed");
  }
} catch (e) {
  console.log("kangax-es2025/Iterator.from.iterator.js: exception: " + e);
}
