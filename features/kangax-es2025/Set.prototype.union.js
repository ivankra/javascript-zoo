...
try {
  if (testCode()) {
    console.log("kangax-es2025/Set.prototype.union.js: OK");
  } else {
    console.log("kangax-es2025/Set.prototype.union.js: failed");
  }
} catch (e) {
  console.log("kangax-es2025/Set.prototype.union.js: exception: " + e);
}
