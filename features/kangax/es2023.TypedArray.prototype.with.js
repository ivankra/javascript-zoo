...
try {
  if (testCode()) {
    console.log("es2023.TypedArray.prototype.with.js: OK");
  } else {
    console.log("es2023.TypedArray.prototype.with.js: FAIL");
  }
} catch (e) {
  console.log("es2023.TypedArray.prototype.with.js: FAIL: " + e);
}