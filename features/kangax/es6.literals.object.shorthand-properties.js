...
try {
  if (testCode()) {
    console.log("es6.literals.object.shorthand-properties.js: OK");
  } else {
    console.log("es6.literals.object.shorthand-properties.js: FAIL");
  }
} catch (e) {
  console.log("es6.literals.object.shorthand-properties.js: FAIL: " + e);
}