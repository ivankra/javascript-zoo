...
try {
  if (testCode()) {
    console.log("es6.spread.iterable-instance-literal.js: OK");
  } else {
    console.log("es6.spread.iterable-instance-literal.js: FAIL");
  }
} catch (e) {
  console.log("es6.spread.iterable-instance-literal.js: FAIL: " + e);
}