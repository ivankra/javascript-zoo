...
try {
  if (testCode()) {
    console.log("es2019.String.prototype.trimLeft.js: OK");
  } else {
    console.log("es2019.String.prototype.trimLeft.js: FAIL");
  }
} catch (e) {
  console.log("es2019.String.prototype.trimLeft.js: FAIL: " + e);
}