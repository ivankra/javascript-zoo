...
try {
  if (testCode()) {
    console.log("es6.misc.Proxy.get.String.search.js: OK");
  } else {
    console.log("es6.misc.Proxy.get.String.search.js: FAIL");
  }
} catch (e) {
  console.log("es6.misc.Proxy.get.String.search.js: FAIL: " + e);
}