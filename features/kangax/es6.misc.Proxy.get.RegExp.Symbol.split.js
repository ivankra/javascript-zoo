...
try {
  if (testCode()) {
    console.log("es6.misc.Proxy.get.RegExp.Symbol.split.js: OK");
  } else {
    console.log("es6.misc.Proxy.get.RegExp.Symbol.split.js: FAIL");
  }
} catch (e) {
  console.log("es6.misc.Proxy.get.RegExp.Symbol.split.js: FAIL: " + e);
}