...
try {
  if (testCode()) {
    console.log("annexb.es6.__proto__.literals.not-shorthand-method.js: OK");
  } else {
    console.log("annexb.es6.__proto__.literals.not-shorthand-method.js: FAIL");
  }
} catch (e) {
  console.log("annexb.es6.__proto__.literals.not-shorthand-method.js: FAIL: " + e);
}