...
try {
  if (testCode()) {
    console.log("es6.default-params.explicit-undefined.js: OK");
  } else {
    console.log("es6.default-params.explicit-undefined.js: FAIL");
  }
} catch (e) {
  console.log("es6.default-params.explicit-undefined.js: FAIL: " + e);
}