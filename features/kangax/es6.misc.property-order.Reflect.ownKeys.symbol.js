...
try {
  if (testCode()) {
    console.log("es6.misc.property-order.Reflect.ownKeys.symbol.js: OK");
  } else {
    console.log("es6.misc.property-order.Reflect.ownKeys.symbol.js: FAIL");
  }
} catch (e) {
  console.log("es6.misc.property-order.Reflect.ownKeys.symbol.js: FAIL: " + e);
}