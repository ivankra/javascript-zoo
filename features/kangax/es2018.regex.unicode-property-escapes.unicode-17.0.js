...
try {
  if (testCode()) {
    console.log("es2018.regex.unicode-property-escapes.unicode-17.0.js: OK");
  } else {
    console.log("es2018.regex.unicode-property-escapes.unicode-17.0.js: FAIL");
  }
} catch (e) {
  console.log("es2018.regex.unicode-property-escapes.unicode-17.0.js: FAIL: " + e);
}