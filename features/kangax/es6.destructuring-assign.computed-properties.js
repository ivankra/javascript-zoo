...
try {
  if (testCode()) {
    console.log("es6.destructuring-assign.computed-properties.js: OK");
  } else {
    console.log("es6.destructuring-assign.computed-properties.js: FAIL");
  }
} catch (e) {
  console.log("es6.destructuring-assign.computed-properties.js: FAIL: " + e);
}