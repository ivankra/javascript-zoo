...
try {
  if (testCode()) {
    console.log("es6.default-params.separate-scope.js: OK");
  } else {
    console.log("es6.default-params.separate-scope.js: FAIL");
  }
} catch (e) {
  console.log("es6.default-params.separate-scope.js: FAIL: " + e);
}