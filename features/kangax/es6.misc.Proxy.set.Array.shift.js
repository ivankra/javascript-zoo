...
try {
  if (testCode()) {
    console.log("es6.misc.Proxy.set.Array.shift.js: OK");
  } else {
    console.log("es6.misc.Proxy.set.Array.shift.js: FAIL");
  }
} catch (e) {
  console.log("es6.misc.Proxy.set.Array.shift.js: FAIL: " + e);
}