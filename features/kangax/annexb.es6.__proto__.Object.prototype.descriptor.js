...
try {
  if (testCode()) {
    console.log("annexb.es6.__proto__.Object.prototype.descriptor.js: OK");
  } else {
    console.log("annexb.es6.__proto__.Object.prototype.descriptor.js: FAIL");
  }
} catch (e) {
  console.log("annexb.es6.__proto__.Object.prototype.descriptor.js: FAIL: " + e);
}