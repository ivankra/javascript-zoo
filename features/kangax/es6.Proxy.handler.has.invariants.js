...
try {
  if (testCode()) {
    console.log("es6.Proxy.handler.has.invariants.js: OK");
  } else {
    console.log("es6.Proxy.handler.has.invariants.js: FAIL");
  }
} catch (e) {
  console.log("es6.Proxy.handler.has.invariants.js: FAIL: " + e);
}