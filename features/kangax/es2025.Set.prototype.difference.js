...
try {
  if (testCode()) {
    console.log("es2025.Set.prototype.difference.js: OK");
  } else {
    console.log("es2025.Set.prototype.difference.js: FAIL");
  }
} catch (e) {
  console.log("es2025.Set.prototype.difference.js: FAIL: " + e);
}