// ES6: https://tc39.github.io/ecma262/#sec-atomics.load
...
try {
  if (testCode()) {
    console.log("es2017.Atomics.load.js: OK");
  } else {
    console.log("es2017.Atomics.load.js: FAIL");
  }
} catch (e) {
  console.log("es2017.Atomics.load.js: FAIL: " + e);
}