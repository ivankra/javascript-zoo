...
try {
  if (testCode()) {
    console.log("es6.Symbol.JSON.stringify.object.js: OK");
  } else {
    console.log("es6.Symbol.JSON.stringify.object.js: FAIL");
  }
} catch (e) {
  console.log("es6.Symbol.JSON.stringify.object.js: FAIL: " + e);
}