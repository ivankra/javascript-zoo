...
try {
  if (testCode()) {
    console.log("es6.Proxy.handler.preventExtensions.js: OK");
  } else {
    console.log("es6.Proxy.handler.preventExtensions.js: FAIL");
  }
} catch (e) {
  console.log("es6.Proxy.handler.preventExtensions.js: FAIL: " + e);
}