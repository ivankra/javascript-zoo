...
try {
  if (testCode()) {
    console.log("es2019.misc.Function-toString.native-code.js: OK");
  } else {
    console.log("es2019.misc.Function-toString.native-code.js: FAIL");
  }
} catch (e) {
  console.log("es2019.misc.Function-toString.native-code.js: FAIL: " + e);
}