...
try {
  if (testCode()) {
    console.log("es6.Proxy.handler.setPrototypeOf.invariants.js: OK");
  } else {
    console.log("es6.Proxy.handler.setPrototypeOf.invariants.js: FAIL");
  }
} catch (e) {
  console.log("es6.Proxy.handler.setPrototypeOf.invariants.js: FAIL: " + e);
}