...
try {
  if (testCode()) {
    console.log("es6.subclassing.Array.length-set.js: OK");
  } else {
    console.log("es6.subclassing.Array.length-set.js: FAIL");
  }
} catch (e) {
  console.log("es6.subclassing.Array.length-set.js: FAIL: " + e);
}