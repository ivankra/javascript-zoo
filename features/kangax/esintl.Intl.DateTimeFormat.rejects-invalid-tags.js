// ES6: https://github.com/tc39/ecma402/pull/289
// MDN: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/DateTimeFormat
// compat-table: ES Intl > DateTimeFormat > rejects invalid language tags
//
...
try {
  if (testCode()) {
    console.log("esintl.Intl.DateTimeFormat.rejects-invalid-tags.js: OK");
  } else {
    console.log("esintl.Intl.DateTimeFormat.rejects-invalid-tags.js: FAIL");
  }
} catch (e) {
  console.log("esintl.Intl.DateTimeFormat.rejects-invalid-tags.js: FAIL: " + e);
}