...
try {
  if (testCode()) {
    console.log("es6.destructuring-params.duplicate-identifier.js: OK");
  } else {
    console.log("es6.destructuring-params.duplicate-identifier.js: FAIL");
  }
} catch (e) {
  console.log("es6.destructuring-params.duplicate-identifier.js: FAIL: " + e);
}