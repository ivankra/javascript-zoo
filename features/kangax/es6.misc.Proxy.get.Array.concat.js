...
try {
  if (testCode()) {
    console.log("es6.misc.Proxy.get.Array.concat.js: OK");
  } else {
    console.log("es6.misc.Proxy.get.Array.concat.js: FAIL");
  }
} catch (e) {
  console.log("es6.misc.Proxy.get.Array.concat.js: FAIL: " + e);
}