...
try {
  if (testCode()) {
    console.log("es2019.misc.Function-toString.class-implicit-constructor.js: OK");
  } else {
    console.log("es2019.misc.Function-toString.class-implicit-constructor.js: FAIL");
  }
} catch (e) {
  console.log("es2019.misc.Function-toString.class-implicit-constructor.js: FAIL: " + e);
}