...
try {
  if (testCode()) {
    console.log("es2019.Symbol.prototype.description.empty.js: OK");
  } else {
    console.log("es2019.Symbol.prototype.description.empty.js: FAIL");
  }
} catch (e) {
  console.log("es2019.Symbol.prototype.description.empty.js: FAIL: " + e);
}