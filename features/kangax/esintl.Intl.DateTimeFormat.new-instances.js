...
try {
  if (testCode()) {
    console.log("esintl.Intl.DateTimeFormat.new-instances.js: OK");
  } else {
    console.log("esintl.Intl.DateTimeFormat.new-instances.js: FAIL");
  }
} catch (e) {
  console.log("esintl.Intl.DateTimeFormat.new-instances.js: FAIL: " + e);
}