...
try {
  if (testCode()) {
    console.log("annexb.es6.regex.backreferences-octal.js: OK");
  } else {
    console.log("annexb.es6.regex.backreferences-octal.js: FAIL");
  }
} catch (e) {
  console.log("annexb.es6.regex.backreferences-octal.js: FAIL: " + e);
}