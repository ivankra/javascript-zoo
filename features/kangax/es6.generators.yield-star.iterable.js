...
try {
  if (testCode()) {
    console.log("es6.generators.yield-star.iterable.js: OK");
  } else {
    console.log("es6.generators.yield-star.iterable.js: FAIL");
  }
} catch (e) {
  console.log("es6.generators.yield-star.iterable.js: FAIL: " + e);
}