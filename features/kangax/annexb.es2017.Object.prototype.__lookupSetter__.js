...
try {
  if (testCode()) {
    console.log("annexb.es2017.Object.prototype.__lookupSetter__.js: OK");
  } else {
    console.log("annexb.es2017.Object.prototype.__lookupSetter__.js: FAIL");
  }
} catch (e) {
  console.log("annexb.es2017.Object.prototype.__lookupSetter__.js: FAIL: " + e);
}