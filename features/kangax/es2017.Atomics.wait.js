// ES6: https://tc39.github.io/ecma262/#sec-atomics.wait
...
try {
  if (testCode()) {
    console.log("es2017.Atomics.wait.js: OK");
  } else {
    console.log("es2017.Atomics.wait.js: FAIL");
  }
} catch (e) {
  console.log("es2017.Atomics.wait.js: FAIL: " + e);
}