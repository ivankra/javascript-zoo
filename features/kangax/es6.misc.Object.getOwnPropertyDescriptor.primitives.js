...
try {
  if (testCode()) {
    console.log("es6.misc.Object.getOwnPropertyDescriptor.primitives.js: OK");
  } else {
    console.log("es6.misc.Object.getOwnPropertyDescriptor.primitives.js: FAIL");
  }
} catch (e) {
  console.log("es6.misc.Object.getOwnPropertyDescriptor.primitives.js: FAIL: " + e);
}