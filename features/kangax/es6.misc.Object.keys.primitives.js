...
try {
  if (testCode()) {
    console.log("es6.misc.Object.keys.primitives.js: OK");
  } else {
    console.log("es6.misc.Object.keys.primitives.js: FAIL");
  }
} catch (e) {
  console.log("es6.misc.Object.keys.primitives.js: FAIL: " + e);
}