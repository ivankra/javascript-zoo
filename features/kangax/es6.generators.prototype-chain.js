...
try {
  if (testCode()) {
    console.log("es6.generators.prototype-chain.js: OK");
  } else {
    console.log("es6.generators.prototype-chain.js: FAIL");
  }
} catch (e) {
  console.log("es6.generators.prototype-chain.js: FAIL: " + e);
}