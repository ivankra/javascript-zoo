...
try {
  if (testCode()) {
    console.log("es6.typed-arrays.DataView.Int8.js: OK");
  } else {
    console.log("es6.typed-arrays.DataView.Int8.js: FAIL");
  }
} catch (e) {
  console.log("es6.typed-arrays.DataView.Int8.js: FAIL: " + e);
}