...
try {
  if (testCode()) {
    console.log("es2025.Set.prototype.symmetricDifference.js: OK");
  } else {
    console.log("es2025.Set.prototype.symmetricDifference.js: FAIL");
  }
} catch (e) {
  console.log("es2025.Set.prototype.symmetricDifference.js: FAIL: " + e);
}