...
try {
  if (testCode()) {
    console.log("es6.well-known.toStringTag.misc-builtins.js: OK");
  } else {
    console.log("es6.well-known.toStringTag.misc-builtins.js: FAIL");
  }
} catch (e) {
  console.log("es6.well-known.toStringTag.misc-builtins.js: FAIL: " + e);
}