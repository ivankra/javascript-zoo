...
try {
  if (testCode()) {
    console.log("es6.misc.Proxy.getOwnPropertyDescriptor.Set.js: OK");
  } else {
    console.log("es6.misc.Proxy.getOwnPropertyDescriptor.Set.js: FAIL");
  }
} catch (e) {
  console.log("es6.misc.Proxy.getOwnPropertyDescriptor.Set.js: FAIL: " + e);
}