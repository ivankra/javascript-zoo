...
try {
  if (testCode()) {
    console.log("es6.typed-arrays.prototype.every.js: OK");
  } else {
    console.log("es6.typed-arrays.prototype.every.js: FAIL");
  }
} catch (e) {
  console.log("es6.typed-arrays.prototype.every.js: FAIL: " + e);
}