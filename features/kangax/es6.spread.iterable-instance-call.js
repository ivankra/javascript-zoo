...
try {
  if (testCode()) {
    console.log("es6.spread.iterable-instance-call.js: OK");
  } else {
    console.log("es6.spread.iterable-instance-call.js: FAIL");
  }
} catch (e) {
  console.log("es6.spread.iterable-instance-call.js: FAIL: " + e);
}