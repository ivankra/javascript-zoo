...
try {
  if (testCode()) {
    console.log("esintl.Intl.DateTimeFormat.valid-tags.js: OK");
  } else {
    console.log("esintl.Intl.DateTimeFormat.valid-tags.js: FAIL");
  }
} catch (e) {
  console.log("esintl.Intl.DateTimeFormat.valid-tags.js: FAIL: " + e);
}