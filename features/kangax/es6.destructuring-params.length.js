...
try {
  if (testCode()) {
    console.log("es6.destructuring-params.length.js: OK");
  } else {
    console.log("es6.destructuring-params.length.js: FAIL");
  }
} catch (e) {
  console.log("es6.destructuring-params.length.js: FAIL: " + e);
}