...
try {
  if (testCode()) {
    console.log("es6.misc.bound-function-prototype.class.js: OK");
  } else {
    console.log("es6.misc.bound-function-prototype.class.js: FAIL");
  }
} catch (e) {
  console.log("es6.misc.bound-function-prototype.class.js: FAIL: " + e);
}