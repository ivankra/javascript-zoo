...
try {
  if (testCode()) {
    console.log("es6.typed-arrays.prototype.sort.js: OK");
  } else {
    console.log("es6.typed-arrays.prototype.sort.js: FAIL");
  }
} catch (e) {
  console.log("es6.typed-arrays.prototype.sort.js: FAIL: " + e);
}