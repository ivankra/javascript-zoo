...
try {
  if (testCode()) {
    console.log("es6.String.prototype.codePointAt.js: OK");
  } else {
    console.log("es6.String.prototype.codePointAt.js: FAIL");
  }
} catch (e) {
  console.log("es6.String.prototype.codePointAt.js: FAIL: " + e);
}