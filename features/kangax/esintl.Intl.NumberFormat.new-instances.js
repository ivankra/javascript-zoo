...
try {
  if (testCode()) {
    console.log("esintl.Intl.NumberFormat.new-instances.js: OK");
  } else {
    console.log("esintl.Intl.NumberFormat.new-instances.js: FAIL");
  }
} catch (e) {
  console.log("esintl.Intl.NumberFormat.new-instances.js: FAIL: " + e);
}