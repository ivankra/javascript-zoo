...
try {
  if (testCode()) {
    console.log("es2024.ArrayBuffer.prototype.transferToFixedLength.js: OK");
  } else {
    console.log("es2024.ArrayBuffer.prototype.transferToFixedLength.js: FAIL");
  }
} catch (e) {
  console.log("es2024.ArrayBuffer.prototype.transferToFixedLength.js: FAIL: " + e);
}