...
try {
  if (testCode()) {
    console.log("es6.misc.RegExp-prototype-toString-generic.js: OK");
  } else {
    console.log("es6.misc.RegExp-prototype-toString-generic.js: FAIL");
  }
} catch (e) {
  console.log("es6.misc.RegExp-prototype-toString-generic.js: FAIL: " + e);
}