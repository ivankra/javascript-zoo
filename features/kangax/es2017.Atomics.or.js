// ES6: https://tc39.github.io/ecma262/#sec-atomics.or
...
try {
  if (testCode()) {
    console.log("es2017.Atomics.or.js: OK");
  } else {
    console.log("es2017.Atomics.or.js: FAIL");
  }
} catch (e) {
  console.log("es2017.Atomics.or.js: FAIL: " + e);
}