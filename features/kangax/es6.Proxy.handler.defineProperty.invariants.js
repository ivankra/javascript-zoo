...
try {
  if (testCode()) {
    console.log("es6.Proxy.handler.defineProperty.invariants.js: OK");
  } else {
    console.log("es6.Proxy.handler.defineProperty.invariants.js: FAIL");
  }
} catch (e) {
  console.log("es6.Proxy.handler.defineProperty.invariants.js: FAIL: " + e);
}