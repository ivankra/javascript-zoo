...
try {
  if (testCode()) {
    console.log("es6.destructuring-assign.chained-iterable.js: OK");
  } else {
    console.log("es6.destructuring-assign.chained-iterable.js: FAIL");
  }
} catch (e) {
  console.log("es6.destructuring-assign.chained-iterable.js: FAIL: " + e);
}