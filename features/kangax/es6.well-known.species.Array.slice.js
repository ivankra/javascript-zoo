...
try {
  if (testCode()) {
    console.log("es6.well-known.species.Array.slice.js: OK");
  } else {
    console.log("es6.well-known.species.Array.slice.js: FAIL");
  }
} catch (e) {
  console.log("es6.well-known.species.Array.slice.js: FAIL: " + e);
}