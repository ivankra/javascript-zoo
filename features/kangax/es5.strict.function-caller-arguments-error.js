...
try {
  if (testCode()) {
    console.log("es5.strict.function-caller-arguments-error.js: OK");
  } else {
    console.log("es5.strict.function-caller-arguments-error.js: FAIL");
  }
} catch (e) {
  console.log("es5.strict.function-caller-arguments-error.js: FAIL: " + e);
}