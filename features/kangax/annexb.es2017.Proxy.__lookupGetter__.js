...
try {
  if (testCode()) {
    console.log("annexb.es2017.Proxy.__lookupGetter__.js: OK");
  } else {
    console.log("annexb.es2017.Proxy.__lookupGetter__.js: FAIL");
  }
} catch (e) {
  console.log("annexb.es2017.Proxy.__lookupGetter__.js: FAIL: " + e);
}