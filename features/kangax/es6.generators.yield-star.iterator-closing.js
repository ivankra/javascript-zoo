...
try {
  if (testCode()) {
    console.log("es6.generators.yield-star.iterator-closing.js: OK");
  } else {
    console.log("es6.generators.yield-star.iterator-closing.js: FAIL");
  }
} catch (e) {
  console.log("es6.generators.yield-star.iterator-closing.js: FAIL: " + e);
}