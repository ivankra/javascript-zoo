...
try {
  if (testCode()) {
    console.log("es6.generators.yield-star.sparse-array.js: OK");
  } else {
    console.log("es6.generators.yield-star.sparse-array.js: FAIL");
  }
} catch (e) {
  console.log("es6.generators.yield-star.sparse-array.js: FAIL: " + e);
}