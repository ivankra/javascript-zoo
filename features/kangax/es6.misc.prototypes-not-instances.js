...
try {
  if (testCode()) {
    console.log("es6.misc.prototypes-not-instances.js: OK");
  } else {
    console.log("es6.misc.prototypes-not-instances.js: FAIL");
  }
} catch (e) {
  console.log("es6.misc.prototypes-not-instances.js: FAIL: " + e);
}