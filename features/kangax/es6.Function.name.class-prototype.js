...
try {
  if (testCode()) {
    console.log("es6.Function.name.class-prototype.js: OK");
  } else {
    console.log("es6.Function.name.class-prototype.js: FAIL");
  }
} catch (e) {
  console.log("es6.Function.name.class-prototype.js: FAIL: " + e);
}