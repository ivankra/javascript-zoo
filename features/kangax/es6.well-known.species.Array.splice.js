...
try {
  if (testCode()) {
    console.log("es6.well-known.species.Array.splice.js: OK");
  } else {
    console.log("es6.well-known.species.Array.splice.js: FAIL");
  }
} catch (e) {
  console.log("es6.well-known.species.Array.splice.js: FAIL: " + e);
}