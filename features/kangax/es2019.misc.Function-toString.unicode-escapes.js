...
try {
  if (testCode()) {
    console.log("es2019.misc.Function-toString.unicode-escapes.js: OK");
  } else {
    console.log("es2019.misc.Function-toString.unicode-escapes.js: FAIL");
  }
} catch (e) {
  console.log("es2019.misc.Function-toString.unicode-escapes.js: FAIL: " + e);
}