...
try {
  if (testCode()) {
    console.log("es6.misc.Proxy.get.Promise.resolve.js: OK");
  } else {
    console.log("es6.misc.Proxy.get.Promise.resolve.js: FAIL");
  }
} catch (e) {
  console.log("es6.misc.Proxy.get.Promise.resolve.js: FAIL: " + e);
}