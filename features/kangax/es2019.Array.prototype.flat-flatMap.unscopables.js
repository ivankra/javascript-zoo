...
try {
  if (testCode()) {
    console.log("es2019.Array.prototype.flat-flatMap.unscopables.js: OK");
  } else {
    console.log("es2019.Array.prototype.flat-flatMap.unscopables.js: FAIL");
  }
} catch (e) {
  console.log("es2019.Array.prototype.flat-flatMap.unscopables.js: FAIL: " + e);
}