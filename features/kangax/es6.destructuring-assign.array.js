...
try {
  if (testCode()) {
    console.log("es6.destructuring-assign.array.js: OK");
  } else {
    console.log("es6.destructuring-assign.array.js: FAIL");
  }
} catch (e) {
  console.log("es6.destructuring-assign.array.js: FAIL: " + e);
}