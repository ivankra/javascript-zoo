// ES6: https://tc39.github.io/ecma262/#sec-atomics.add
...
try {
  if (testCode()) {
    console.log("es2017.Atomics.add.js: OK");
  } else {
    console.log("es2017.Atomics.add.js: FAIL");
  }
} catch (e) {
  console.log("es2017.Atomics.add.js: FAIL: " + e);
}