...
try {
  if (testCode()) {
    console.log("es6.Function.name.class-object-method.js: OK");
  } else {
    console.log("es6.Function.name.class-object-method.js: FAIL");
  }
} catch (e) {
  console.log("es6.Function.name.class-object-method.js: FAIL: " + e);
}