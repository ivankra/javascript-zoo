...
try {
  if (testCode()) {
    console.log("es6.destructuring-assign.nested.js: OK");
  } else {
    console.log("es6.destructuring-assign.nested.js: FAIL");
  }
} catch (e) {
  console.log("es6.destructuring-assign.nested.js: FAIL: " + e);
}