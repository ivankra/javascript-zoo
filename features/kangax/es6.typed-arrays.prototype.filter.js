...
try {
  if (testCode()) {
    console.log("es6.typed-arrays.prototype.filter.js: OK");
  } else {
    console.log("es6.typed-arrays.prototype.filter.js: FAIL");
  }
} catch (e) {
  console.log("es6.typed-arrays.prototype.filter.js: FAIL: " + e);
}