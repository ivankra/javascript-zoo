...
try {
  if (testCode()) {
    console.log("es6.well-known.toStringTag.existing-builtins.js: OK");
  } else {
    console.log("es6.well-known.toStringTag.existing-builtins.js: FAIL");
  }
} catch (e) {
  console.log("es6.well-known.toStringTag.existing-builtins.js: FAIL: " + e);
}