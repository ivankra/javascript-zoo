...
try {
  if (testCode()) {
    console.log("es6.misc.property-order.Object.keys.js: OK");
  } else {
    console.log("es6.misc.property-order.Object.keys.js: FAIL");
  }
} catch (e) {
  console.log("es6.misc.property-order.Object.keys.js: FAIL: " + e);
}