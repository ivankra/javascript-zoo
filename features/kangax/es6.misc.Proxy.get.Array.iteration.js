...
try {
  if (testCode()) {
    console.log("es6.misc.Proxy.get.Array.iteration.js: OK");
  } else {
    console.log("es6.misc.Proxy.get.Array.iteration.js: FAIL");
  }
} catch (e) {
  console.log("es6.misc.Proxy.get.Array.iteration.js: FAIL: " + e);
}