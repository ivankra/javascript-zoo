...
try {
  if (testCode()) {
    console.log("es2022.class-fields.instance.parent-scope.js: OK");
  } else {
    console.log("es2022.class-fields.instance.parent-scope.js: FAIL");
  }
} catch (e) {
  console.log("es2022.class-fields.instance.parent-scope.js: FAIL: " + e);
}