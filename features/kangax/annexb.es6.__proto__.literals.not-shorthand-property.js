...
try {
  if (testCode()) {
    console.log("annexb.es6.__proto__.literals.not-shorthand-property.js: OK");
  } else {
    console.log("annexb.es6.__proto__.literals.not-shorthand-property.js: FAIL");
  }
} catch (e) {
  console.log("annexb.es6.__proto__.literals.not-shorthand-property.js: FAIL: " + e);
}