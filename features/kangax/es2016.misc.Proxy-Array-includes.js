...
try {
  if (testCode()) {
    console.log("es2016.misc.Proxy-Array-includes.js: OK");
  } else {
    console.log("es2016.misc.Proxy-Array-includes.js: FAIL");
  }
} catch (e) {
  console.log("es2016.misc.Proxy-Array-includes.js: FAIL: " + e);
}