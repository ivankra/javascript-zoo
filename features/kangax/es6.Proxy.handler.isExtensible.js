...
try {
  if (testCode()) {
    console.log("es6.Proxy.handler.isExtensible.js: OK");
  } else {
    console.log("es6.Proxy.handler.isExtensible.js: FAIL");
  }
} catch (e) {
  console.log("es6.Proxy.handler.isExtensible.js: FAIL: " + e);
}