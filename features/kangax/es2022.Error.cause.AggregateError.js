...
try {
  if (testCode()) {
    console.log("es2022.Error.cause.AggregateError.js: OK");
  } else {
    console.log("es2022.Error.cause.AggregateError.js: FAIL");
  }
} catch (e) {
  console.log("es2022.Error.cause.AggregateError.js: FAIL: " + e);
}