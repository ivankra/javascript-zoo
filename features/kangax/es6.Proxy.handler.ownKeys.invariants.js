...
try {
  if (testCode()) {
    console.log("es6.Proxy.handler.ownKeys.invariants.js: OK");
  } else {
    console.log("es6.Proxy.handler.ownKeys.invariants.js: FAIL");
  }
} catch (e) {
  console.log("es6.Proxy.handler.ownKeys.invariants.js: FAIL: " + e);
}