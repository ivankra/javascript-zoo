// ES6: https://github.com/tc39/proposal-promise-any
// MDN: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise/any
// compat-table: ES2016+ > 2021 features > Promise.any (small) > fulfillment
//
...
function asyncTestPassed() {
  console.log("es2021.Promise.any.fulfillment.js: OK");
}
...
try {
  ...
  console.log("es2021.Promise.any.fulfillment.js: FAIL: " + e);
}