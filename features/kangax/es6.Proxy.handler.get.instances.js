...
try {
  if (testCode()) {
    console.log("es6.Proxy.handler.get.instances.js: OK");
  } else {
    console.log("es6.Proxy.handler.get.instances.js: FAIL");
  }
} catch (e) {
  console.log("es6.Proxy.handler.get.instances.js: FAIL: " + e);
}