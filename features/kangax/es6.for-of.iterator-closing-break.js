...
try {
  if (testCode()) {
    console.log("es6.for-of.iterator-closing-break.js: OK");
  } else {
    console.log("es6.for-of.iterator-closing-break.js: FAIL");
  }
} catch (e) {
  console.log("es6.for-of.iterator-closing-break.js: FAIL: " + e);
}