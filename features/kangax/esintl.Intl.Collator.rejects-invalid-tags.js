...
try {
  if (testCode()) {
    console.log("esintl.Intl.Collator.rejects-invalid-tags.js: OK");
  } else {
    console.log("esintl.Intl.Collator.rejects-invalid-tags.js: FAIL");
  }
} catch (e) {
  console.log("esintl.Intl.Collator.rejects-invalid-tags.js: FAIL: " + e);
}