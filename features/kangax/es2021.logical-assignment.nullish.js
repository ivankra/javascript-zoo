...
try {
  if (testCode()) {
    console.log("es2021.logical-assignment.nullish.js: OK");
  } else {
    console.log("es2021.logical-assignment.nullish.js: FAIL");
  }
} catch (e) {
  console.log("es2021.logical-assignment.nullish.js: FAIL: " + e);
}