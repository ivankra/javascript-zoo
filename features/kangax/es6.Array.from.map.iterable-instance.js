...
try {
  if (testCode()) {
    console.log("es6.Array.from.map.iterable-instance.js: OK");
  } else {
    console.log("es6.Array.from.map.iterable-instance.js: FAIL");
  }
} catch (e) {
  console.log("es6.Array.from.map.iterable-instance.js: FAIL: " + e);
}