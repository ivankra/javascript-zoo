...
try {
  if (testCode()) {
    console.log("es6.destructuring-assign.iterable.js: OK");
  } else {
    console.log("es6.destructuring-assign.iterable.js: FAIL");
  }
} catch (e) {
  console.log("es6.destructuring-assign.iterable.js: FAIL: " + e);
}