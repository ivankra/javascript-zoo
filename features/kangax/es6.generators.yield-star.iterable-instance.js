...
try {
  if (testCode()) {
    console.log("es6.generators.yield-star.iterable-instance.js: OK");
  } else {
    console.log("es6.generators.yield-star.iterable-instance.js: FAIL");
  }
} catch (e) {
  console.log("es6.generators.yield-star.iterable-instance.js: FAIL: " + e);
}