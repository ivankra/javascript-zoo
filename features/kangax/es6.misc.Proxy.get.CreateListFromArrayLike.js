...
try {
  if (testCode()) {
    console.log("es6.misc.Proxy.get.CreateListFromArrayLike.js: OK");
  } else {
    console.log("es6.misc.Proxy.get.CreateListFromArrayLike.js: FAIL");
  }
} catch (e) {
  console.log("es6.misc.Proxy.get.CreateListFromArrayLike.js: FAIL: " + e);
}