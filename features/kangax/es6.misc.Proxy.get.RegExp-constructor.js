...
try {
  if (testCode()) {
    console.log("es6.misc.Proxy.get.RegExp-constructor.js: OK");
  } else {
    console.log("es6.misc.Proxy.get.RegExp-constructor.js: FAIL");
  }
} catch (e) {
  console.log("es6.misc.Proxy.get.RegExp-constructor.js: FAIL: " + e);
}