...
try {
  if (testCode()) {
    console.log("es6.typed-arrays.DataView.Uint32.js: OK");
  } else {
    console.log("es6.typed-arrays.DataView.Uint32.js: FAIL");
  }
} catch (e) {
  console.log("es6.typed-arrays.DataView.Uint32.js: FAIL: " + e);
}