...
try {
  if (testCode()) {
    console.log("es6.String.prototype.startsWith.js: OK");
  } else {
    console.log("es6.String.prototype.startsWith.js: FAIL");
  }
} catch (e) {
  console.log("es6.String.prototype.startsWith.js: FAIL: " + e);
}