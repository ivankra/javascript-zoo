...
try {
  if (testCode()) {
    console.log("es6.subclassing.Function.prototype.bind.js: OK");
  } else {
    console.log("es6.subclassing.Function.prototype.bind.js: FAIL");
  }
} catch (e) {
  console.log("es6.subclassing.Function.prototype.bind.js: FAIL: " + e);
}