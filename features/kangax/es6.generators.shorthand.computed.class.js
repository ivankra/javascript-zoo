...
try {
  if (testCode()) {
    console.log("es6.generators.shorthand.computed.class.js: OK");
  } else {
    console.log("es6.generators.shorthand.computed.class.js: FAIL");
  }
} catch (e) {
  console.log("es6.generators.shorthand.computed.class.js: FAIL: " + e);
}