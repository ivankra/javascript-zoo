...
try {
  if (testCode()) {
    console.log("es6.misc.property-order.Object.assign.js: OK");
  } else {
    console.log("es6.misc.property-order.Object.assign.js: FAIL");
  }
} catch (e) {
  console.log("es6.misc.property-order.Object.assign.js: FAIL: " + e);
}