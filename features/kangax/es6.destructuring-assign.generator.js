...
try {
  if (testCode()) {
    console.log("es6.destructuring-assign.generator.js: OK");
  } else {
    console.log("es6.destructuring-assign.generator.js: FAIL");
  }
} catch (e) {
  console.log("es6.destructuring-assign.generator.js: FAIL: " + e);
}