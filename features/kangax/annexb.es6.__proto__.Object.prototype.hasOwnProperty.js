...
try {
  if (testCode()) {
    console.log("annexb.es6.__proto__.Object.prototype.hasOwnProperty.js: OK");
  } else {
    console.log("annexb.es6.__proto__.Object.prototype.hasOwnProperty.js: FAIL");
  }
} catch (e) {
  console.log("annexb.es6.__proto__.Object.prototype.hasOwnProperty.js: FAIL: " + e);
}