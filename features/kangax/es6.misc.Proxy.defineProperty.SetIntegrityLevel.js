...
try {
  if (testCode()) {
    console.log("es6.misc.Proxy.defineProperty.SetIntegrityLevel.js: OK");
  } else {
    console.log("es6.misc.Proxy.defineProperty.SetIntegrityLevel.js: FAIL");
  }
} catch (e) {
  console.log("es6.misc.Proxy.defineProperty.SetIntegrityLevel.js: FAIL: " + e);
}