...
try {
  if (testCode()) {
    console.log("es6.misc.Proxy.get.Array.toString.js: OK");
  } else {
    console.log("es6.misc.Proxy.get.Array.toString.js: FAIL");
  }
} catch (e) {
  console.log("es6.misc.Proxy.get.Array.toString.js: FAIL: " + e);
}