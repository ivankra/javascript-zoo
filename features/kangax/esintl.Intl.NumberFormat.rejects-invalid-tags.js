...
// compat-table: ES Intl > NumberFormat > rejects invalid language tags
//
...
try {
  if (testCode()) {
    console.log("esintl.Intl.NumberFormat.rejects-invalid-tags.js: OK");
  } else {
    console.log("esintl.Intl.NumberFormat.rejects-invalid-tags.js: FAIL");
  }
} catch (e) {
  console.log("esintl.Intl.NumberFormat.rejects-invalid-tags.js: FAIL: " + e);
}