...
try {
  if (testCode()) {
    console.log("es6.Function.name.class-variable.js: OK");
  } else {
    console.log("es6.Function.name.class-variable.js: FAIL");
  }
} catch (e) {
  console.log("es6.Function.name.class-variable.js: FAIL: " + e);
}