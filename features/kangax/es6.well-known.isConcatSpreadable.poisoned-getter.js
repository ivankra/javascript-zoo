...
try {
  if (testCode()) {
    console.log("es6.well-known.isConcatSpreadable.poisoned-getter.js: OK");
  } else {
    console.log("es6.well-known.isConcatSpreadable.poisoned-getter.js: FAIL");
  }
} catch (e) {
  console.log("es6.well-known.isConcatSpreadable.poisoned-getter.js: FAIL: " + e);
}