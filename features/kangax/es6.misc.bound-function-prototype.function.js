...
try {
  if (testCode()) {
    console.log("es6.misc.bound-function-prototype.function.js: OK");
  } else {
    console.log("es6.misc.bound-function-prototype.function.js: FAIL");
  }
} catch (e) {
  console.log("es6.misc.bound-function-prototype.function.js: FAIL: " + e);
}