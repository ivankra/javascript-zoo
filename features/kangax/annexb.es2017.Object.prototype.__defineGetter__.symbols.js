...
try {
  if (testCode()) {
    console.log("annexb.es2017.Object.prototype.__defineGetter__.symbols.js: OK");
  } else {
    console.log("annexb.es2017.Object.prototype.__defineGetter__.symbols.js: FAIL");
  }
} catch (e) {
  console.log("annexb.es2017.Object.prototype.__defineGetter__.symbols.js: FAIL: " + e);
}