...
try {
  if (testCode()) {
    console.log("es6.Map.iterator-prototype-chain.js: OK");
  } else {
    console.log("es6.Map.iterator-prototype-chain.js: FAIL");
  }
} catch (e) {
  console.log("es6.Map.iterator-prototype-chain.js: FAIL: " + e);
}