...
try {
  if (testCode()) {
    console.log("es6.Proxy.handler.getOwnPropertyDescriptor.js: OK");
  } else {
    console.log("es6.Proxy.handler.getOwnPropertyDescriptor.js: FAIL");
  }
} catch (e) {
  console.log("es6.Proxy.handler.getOwnPropertyDescriptor.js: FAIL: " + e);
}