...
try {
  if (testCode()) {
    console.log("es6.misc.property-order.Object.getOwnPropertyNames.js: OK");
  } else {
    console.log("es6.misc.property-order.Object.getOwnPropertyNames.js: FAIL");
  }
} catch (e) {
  console.log("es6.misc.property-order.Object.getOwnPropertyNames.js: FAIL: " + e);
}