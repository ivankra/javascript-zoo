...
try {
  if (testCode()) {
    console.log("es6.destructuring-decl.defaults.js: OK");
  } else {
    console.log("es6.destructuring-decl.defaults.js: FAIL");
  }
} catch (e) {
  console.log("es6.destructuring-decl.defaults.js: FAIL: " + e);
}