...
try {
  if (testCode()) {
    console.log("es6.destructuring-params.arguments.js: OK");
  } else {
    console.log("es6.destructuring-params.arguments.js: FAIL");
  }
} catch (e) {
  console.log("es6.destructuring-params.arguments.js: FAIL: " + e);
}