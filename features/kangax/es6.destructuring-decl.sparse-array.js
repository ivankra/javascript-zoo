...
try {
  if (testCode()) {
    console.log("es6.destructuring-decl.sparse-array.js: OK");
  } else {
    console.log("es6.destructuring-decl.sparse-array.js: FAIL");
  }
} catch (e) {
  console.log("es6.destructuring-decl.sparse-array.js: FAIL: " + e);
}