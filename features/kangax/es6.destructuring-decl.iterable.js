...
try {
  if (testCode()) {
    console.log("es6.destructuring-decl.iterable.js: OK");
  } else {
    console.log("es6.destructuring-decl.iterable.js: FAIL");
  }
} catch (e) {
  console.log("es6.destructuring-decl.iterable.js: FAIL: " + e);
}