...
if (x == "cde") {
  ...
  console.log("annexb.es3.String.prototype.substr.js: positive start failed");
}
...
if (s2.substr(-1) === "b") {
  ...
  console.log("annexb.es3.String.prototype.substr.js: negative start failed");
}
...
if (s3.substr(-3, 2) === "ll") {
  ...
  console.log("annexb.es3.String.prototype.substr.js: negative start with length failed");
}
